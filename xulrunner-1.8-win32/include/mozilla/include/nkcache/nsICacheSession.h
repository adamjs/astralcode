/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/netwerk/cache/public/nsICacheSession.idl
 */
...
class NS_NO_VTABLE nsICacheSession : public nsISupports {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_ICACHESESSION_IID)
...
/* nsICacheEntryDescriptor openCacheEntry (in ACString key, in nsCacheAccessMode accessRequested, in boolean blockingMode); */
NS_IMETHODIMP nsCacheSession::OpenCacheEntry(const nsACString & key, nsCacheAccessMode accessRequested, PRBool blockingMode, nsICacheEntryDescriptor **_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* PRBool isStorageEnabled (); */
NS_IMETHODIMP nsCacheSession::IsStorageEnabled(PRBool *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
