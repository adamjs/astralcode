/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/netwerk/base/public/nsISecurityEventSink.idl
 */
...
class NS_NO_VTABLE nsISecurityEventSink : public nsISupports {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_ISECURITYEVENTSINK_IID)
  ...
  NS_IMETHOD OnSecurityChange(nsISupports *i_Context, PRUint32 state) = 0;

};

/* Use this macro when declaring classes that implement this interface. */
#define NS_DECL_NSISECURITYEVENTSINK \
  NS_IMETHOD OnSecurityChange(nsISupports *i_Context, PRUint32 state); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSISECURITYEVENTSINK(_to) \
  NS_IMETHOD OnSecurityChange(nsISupports *i_Context, PRUint32 state) { return _to OnSecurityChange(i_Context, state); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSISECURITYEVENTSINK(_to) \
  NS_IMETHOD OnSecurityChange(nsISupports *i_Context, PRUint32 state) { return !_to ? NS_ERROR_NULL_POINTER : _to->OnSecurityChange(i_Context, state); } 
