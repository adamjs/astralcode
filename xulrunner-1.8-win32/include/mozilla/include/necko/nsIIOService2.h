/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/netwerk/base/public/nsIIOService2.idl
 */
...
class NS_NO_VTABLE nsIIOService2 : public nsIIOService {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IIOSERVICE2_IID)
  ...
  NS_IMETHOD GetManageOfflineStatus(PRBool *aManageOfflineStatus) = 0;
  NS_IMETHOD SetManageOfflineStatus(PRBool aManageOfflineStatus) = 0;

};

/* Use this macro when declaring classes that implement this interface. */
#define NS_DECL_NSIIOSERVICE2 \
  NS_IMETHOD GetManageOfflineStatus(PRBool *aManageOfflineStatus); \
  NS_IMETHOD SetManageOfflineStatus(PRBool aManageOfflineStatus); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIIOSERVICE2(_to) \
  NS_IMETHOD GetManageOfflineStatus(PRBool *aManageOfflineStatus) { return _to GetManageOfflineStatus(aManageOfflineStatus); } \
  NS_IMETHOD SetManageOfflineStatus(PRBool aManageOfflineStatus) { return _to SetManageOfflineStatus(aManageOfflineStatus); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIIOSERVICE2(_to) \
  NS_IMETHOD GetManageOfflineStatus(PRBool *aManageOfflineStatus) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetManageOfflineStatus(aManageOfflineStatus); } \
  NS_IMETHOD SetManageOfflineStatus(PRBool aManageOfflineStatus) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetManageOfflineStatus(aManageOfflineStatus); } 
