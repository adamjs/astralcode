/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/netwerk/base/public/nsIResumableChannel.idl
 */
...
class NS_NO_VTABLE nsIResumableChannel : public nsISupports {
 public: 
  ...
  NS_IMETHOD ResumeAt(PRUint64 startPos, const nsACString & entityID) = 0;
...
#define NS_FORWARD_NSIRESUMABLECHANNEL(_to) \
  NS_IMETHOD ResumeAt(PRUint64 startPos, const nsACString & entityID) { return _to ResumeAt(startPos, entityID); } \
...
#define NS_FORWARD_SAFE_NSIRESUMABLECHANNEL(_to) \
  NS_IMETHOD ResumeAt(PRUint64 startPos, const nsACString & entityID) { return !_to ? NS_ERROR_NULL_POINTER : _to->ResumeAt(startPos, entityID); } \
