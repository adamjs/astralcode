/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/netwerk/streamconv/public/nsIDirIndex.idl
 */
...
class NS_NO_VTABLE nsIDirIndex : public nsISupports {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IDIRINDEX_IID)
  ...
  NS_IMETHOD SetSize(PRInt64 aSize) = 0;
...
#define NS_DECL_NSIDIRINDEX \
  ...
  NS_IMETHOD SetSize(PRInt64 aSize); \
...
#define NS_FORWARD_NSIDIRINDEX(_to) \
  ...
  NS_IMETHOD SetSize(PRInt64 aSize) { return _to SetSize(aSize); } \
...
#define NS_FORWARD_SAFE_NSIDIRINDEX(_to) \
  ...
  NS_IMETHOD SetSize(PRInt64 aSize) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetSize(aSize); } \
