/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/netwerk/socket/base/nsISocketProviderService.idl
 */
...
class NS_NO_VTABLE nsISocketProviderService : public nsISupports {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_ISOCKETPROVIDERSERVICE_IID)

  /* nsISocketProvider getSocketProvider (in string socketType); */
  NS_IMETHOD GetSocketProvider(const char *socketType, nsISocketProvider **_retval) = 0;

};

/* Use this macro when declaring classes that implement this interface. */
#define NS_DECL_NSISOCKETPROVIDERSERVICE \
  NS_IMETHOD GetSocketProvider(const char *socketType, nsISocketProvider **_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSISOCKETPROVIDERSERVICE(_to) \
  NS_IMETHOD GetSocketProvider(const char *socketType, nsISocketProvider **_retval) { return _to GetSocketProvider(socketType, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSISOCKETPROVIDERSERVICE(_to) \
  NS_IMETHOD GetSocketProvider(const char *socketType, nsISocketProvider **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetSocketProvider(socketType, _retval); } 
...
/* nsISocketProvider getSocketProvider (in string socketType); */
NS_IMETHODIMP nsSocketProviderService::GetSocketProvider(const char *socketType, nsISocketProvider **_retval)
{
