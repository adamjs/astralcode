/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/netwerk/protocol/res/public/nsIResProtocolHandler.idl
 */
...
class NS_NO_VTABLE nsIResProtocolHandler : public nsIProtocolHandler {
 public: 
  ...
  NS_IMETHOD HasSubstitution(const nsACString & root, PRBool *_retval) = 0;
...
#define NS_DECL_NSIRESPROTOCOLHANDLER \
  ...
  NS_IMETHOD HasSubstitution(const nsACString & root, PRBool *_retval); \
...
#define NS_FORWARD_NSIRESPROTOCOLHANDLER(_to) \
  ...
  NS_IMETHOD HasSubstitution(const nsACString & root, PRBool *_retval) { return _to HasSubstitution(root, _retval); } \
...
#define NS_FORWARD_SAFE_NSIRESPROTOCOLHANDLER(_to) \
  ...
  NS_IMETHOD HasSubstitution(const nsACString & root, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->HasSubstitution(root, _retval); } \
...
/* boolean hasSubstitution (in ACString root); */
NS_IMETHODIMP nsResProtocolHandler::HasSubstitution(const nsACString & root, PRBool *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
