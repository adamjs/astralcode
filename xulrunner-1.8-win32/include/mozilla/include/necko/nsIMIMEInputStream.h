/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/netwerk/base/public/nsIMIMEInputStream.idl
 */
...
class NS_NO_VTABLE nsIMIMEInputStream : public nsIInputStream {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IMIMEINPUTSTREAM_IID)
  ...
  NS_IMETHOD GetAddContentLength(PRBool *aAddContentLength) = 0;
  NS_IMETHOD SetAddContentLength(PRBool aAddContentLength) = 0;
...
#define NS_DECL_NSIMIMEINPUTSTREAM \
  NS_IMETHOD GetAddContentLength(PRBool *aAddContentLength); \
  NS_IMETHOD SetAddContentLength(PRBool aAddContentLength); \
...
#define NS_FORWARD_NSIMIMEINPUTSTREAM(_to) \
  NS_IMETHOD GetAddContentLength(PRBool *aAddContentLength) { return _to GetAddContentLength(aAddContentLength); } \
  NS_IMETHOD SetAddContentLength(PRBool aAddContentLength) { return _to SetAddContentLength(aAddContentLength); } \
...
#define NS_FORWARD_SAFE_NSIMIMEINPUTSTREAM(_to) \
  NS_IMETHOD GetAddContentLength(PRBool *aAddContentLength) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetAddContentLength(aAddContentLength); } \
  NS_IMETHOD SetAddContentLength(PRBool aAddContentLength) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetAddContentLength(aAddContentLength); } \
