/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/widget/public/nsIClipboardOwner.idl
 */
...
#define NS_DECL_NSICLIPBOARDOWNER \
  NS_IMETHOD LosingOwnership(nsITransferable *aTransferable); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSICLIPBOARDOWNER(_to) \
  NS_IMETHOD LosingOwnership(nsITransferable *aTransferable) { return _to LosingOwnership(aTransferable); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSICLIPBOARDOWNER(_to) \
  NS_IMETHOD LosingOwnership(nsITransferable *aTransferable) { return !_to ? NS_ERROR_NULL_POINTER : _to->LosingOwnership(aTransferable); } 
