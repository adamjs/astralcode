/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/content/xtf/public/nsIXTFElementFactory.idl
 */
...
class NS_NO_VTABLE nsIXTFElementFactory : public nsISupports {
 public: 

  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IXTFELEMENTFACTORY_IID)

  /* nsIXTFElement createElement (in AString tagName); */
  NS_IMETHOD CreateElement(const nsAString & tagName, nsIXTFElement **_retval) = 0;

};

/* Use this macro when declaring classes that implement this interface. */
#define NS_DECL_NSIXTFELEMENTFACTORY \
  NS_IMETHOD CreateElement(const nsAString & tagName, nsIXTFElement **_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIXTFELEMENTFACTORY(_to) \
  NS_IMETHOD CreateElement(const nsAString & tagName, nsIXTFElement **_retval) { return _to CreateElement(tagName, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIXTFELEMENTFACTORY(_to) \
  NS_IMETHOD CreateElement(const nsAString & tagName, nsIXTFElement **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->CreateElement(tagName, _retval); } 
...
/* nsIXTFElement createElement (in AString tagName); */
NS_IMETHODIMP nsXTFElementFactory::CreateElement(const nsAString & tagName, nsIXTFElement **_retval)
{
