/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/content/xsl/public/nsIXSLTProcessorObsolete.idl
 */
 ...
 */
class NS_NO_VTABLE nsIXSLTProcessorObsolete : public nsISupports {
 public: 

  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IXSLTPROCESSOROBSOLETE_IID)
  ...
  NS_IMETHOD TransformDocument(nsIDOMNode *aSourceDOM, nsIDOMNode *aStyleDOM, nsIDOMDocument *aOutputDOC, nsISupports *aObserver) = 0;

};

/* Use this macro when declaring classes that implement this interface. */
#define NS_DECL_NSIXSLTPROCESSOROBSOLETE \
  NS_IMETHOD TransformDocument(nsIDOMNode *aSourceDOM, nsIDOMNode *aStyleDOM, nsIDOMDocument *aOutputDOC, nsISupports *aObserver); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIXSLTPROCESSOROBSOLETE(_to) \
  NS_IMETHOD TransformDocument(nsIDOMNode *aSourceDOM, nsIDOMNode *aStyleDOM, nsIDOMDocument *aOutputDOC, nsISupports *aObserver) { return _to TransformDocument(aSourceDOM, aStyleDOM, aOutputDOC, aObserver); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIXSLTPROCESSOROBSOLETE(_to) \
  NS_IMETHOD TransformDocument(nsIDOMNode *aSourceDOM, nsIDOMNode *aStyleDOM, nsIDOMDocument *aOutputDOC, nsISupports *aObserver) { return !_to ? NS_ERROR_NULL_POINTER : _to->TransformDocument(aSourceDOM, aStyleDOM, aOutputDOC, aObserver); } 
