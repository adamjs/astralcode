/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/content/xtf/public/nsIXTFPrivate.idl
 */
...
class NS_NO_VTABLE nsIXTFPrivate : public nsISupports {
 public: 

  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IXTFPRIVATE_IID)

  /* readonly attribute nsISupports inner; */
  NS_IMETHOD GetInner(nsISupports * *aInner) = 0;

};

/* Use this macro when declaring classes that implement this interface. */
#define NS_DECL_NSIXTFPRIVATE \
  NS_IMETHOD GetInner(nsISupports * *aInner); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIXTFPRIVATE(_to) \
  NS_IMETHOD GetInner(nsISupports * *aInner) { return _to GetInner(aInner); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIXTFPRIVATE(_to) \
  NS_IMETHOD GetInner(nsISupports * *aInner) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetInner(aInner); } 
