/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/content/html/document/public/nsIImageDocument.idl
 */
...
class NS_NO_VTABLE nsIImageDocument : public nsISupports {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IIMAGEDOCUMENT_IID)

  /* readonly attribute boolean imageResizingEnabled; */
  NS_IMETHOD GetImageResizingEnabled(PRBool *aImageResizingEnabled) = 0;

  /* readonly attribute boolean imageIsOverflowing; */
  NS_IMETHOD GetImageIsOverflowing(PRBool *aImageIsOverflowing) = 0;

  /* readonly attribute boolean imageIsResized; */
  NS_IMETHOD GetImageIsResized(PRBool *aImageIsResized) = 0;
  ...
  NS_IMETHOD RestoreImageTo(PRInt32 x, PRInt32 y) = 0;
...
#define NS_DECL_NSIIMAGEDOCUMENT \
  NS_IMETHOD GetImageResizingEnabled(PRBool *aImageResizingEnabled); \
  NS_IMETHOD GetImageIsOverflowing(PRBool *aImageIsOverflowing); \
  NS_IMETHOD GetImageIsResized(PRBool *aImageIsResized); \
  NS_IMETHOD GetImageRequest(imgIRequest * *aImageRequest); \
  NS_IMETHOD ShrinkToFit(void); \
  NS_IMETHOD RestoreImage(void); \
  NS_IMETHOD RestoreImageTo(PRInt32 x, PRInt32 y); \
  NS_IMETHOD ToggleImageSize(void); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIIMAGEDOCUMENT(_to) \
  NS_IMETHOD GetImageResizingEnabled(PRBool *aImageResizingEnabled) { return _to GetImageResizingEnabled(aImageResizingEnabled); } \
  NS_IMETHOD GetImageIsOverflowing(PRBool *aImageIsOverflowing) { return _to GetImageIsOverflowing(aImageIsOverflowing); } \
  NS_IMETHOD GetImageIsResized(PRBool *aImageIsResized) { return _to GetImageIsResized(aImageIsResized); } \
  ...
  NS_IMETHOD RestoreImageTo(PRInt32 x, PRInt32 y) { return _to RestoreImageTo(x, y); } \
...
#define NS_FORWARD_SAFE_NSIIMAGEDOCUMENT(_to) \
  NS_IMETHOD GetImageResizingEnabled(PRBool *aImageResizingEnabled) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetImageResizingEnabled(aImageResizingEnabled); } \
  NS_IMETHOD GetImageIsOverflowing(PRBool *aImageIsOverflowing) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetImageIsOverflowing(aImageIsOverflowing); } \
  NS_IMETHOD GetImageIsResized(PRBool *aImageIsResized) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetImageIsResized(aImageIsResized); } \
  ...
  NS_IMETHOD RestoreImageTo(PRInt32 x, PRInt32 y) { return !_to ? NS_ERROR_NULL_POINTER : _to->RestoreImageTo(x, y); } \
