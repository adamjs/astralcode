/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/intl/locale/idl/nsILocale.idl
 */
...
class NS_NO_VTABLE nsILocale : public nsISupports {
 public: 

  NS_DEFINE_STATIC_IID_ACCESSOR(NS_ILOCALE_IID)

  /* AString getCategory (in AString category); */
  NS_IMETHOD GetCategory(const nsAString & category, nsAString & _retval) = 0;

};

/* Use this macro when declaring classes that implement this interface. */
#define NS_DECL_NSILOCALE \
  NS_IMETHOD GetCategory(const nsAString & category, nsAString & _retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSILOCALE(_to) \
  NS_IMETHOD GetCategory(const nsAString & category, nsAString & _retval) { return _to GetCategory(category, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSILOCALE(_to) \
  NS_IMETHOD GetCategory(const nsAString & category, nsAString & _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetCategory(category, _retval); } 
...
/* AString getCategory (in AString category); */
NS_IMETHODIMP nsLocale::GetCategory(const nsAString & category, nsAString & _retval)
{
