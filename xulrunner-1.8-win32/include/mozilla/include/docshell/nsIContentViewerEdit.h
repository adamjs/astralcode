/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/docshell/base/nsIContentViewerEdit.idl
 */
...
class NS_NO_VTABLE nsIContentViewerEdit : public nsISupports {
 public: 
  ...
  NS_IMETHOD CopyImage(PRInt32 aCopyFlags) = 0;
  ...
  NS_IMETHOD GetContents(const char *aMimeType, PRBool aSelectionOnly, nsAString & _retval) = 0;

  /* readonly attribute boolean canGetContents; */
  NS_IMETHOD GetCanGetContents(PRBool *aCanGetContents) = 0;
...
#define NS_DECL_NSICONTENTVIEWEREDIT \
  ...
  NS_IMETHOD CopyImage(PRInt32 aCopyFlags); \
  ...
  NS_IMETHOD GetContents(const char *aMimeType, PRBool aSelectionOnly, nsAString & _retval); \
  NS_IMETHOD GetCanGetContents(PRBool *aCanGetContents); 
...
#define NS_FORWARD_NSICONTENTVIEWEREDIT(_to) \
  ...
  NS_IMETHOD CopyImage(PRInt32 aCopyFlags) { return _to CopyImage(aCopyFlags); } \
  ...
  NS_IMETHOD GetContents(const char *aMimeType, PRBool aSelectionOnly, nsAString & _retval) { return _to GetContents(aMimeType, aSelectionOnly, _retval); } \
  NS_IMETHOD GetCanGetContents(PRBool *aCanGetContents) { return _to GetCanGetContents(aCanGetContents); } 
...
#define NS_FORWARD_SAFE_NSICONTENTVIEWEREDIT(_to) \
  ...
  NS_IMETHOD CopyImage(PRInt32 aCopyFlags) { return !_to ? NS_ERROR_NULL_POINTER : _to->CopyImage(aCopyFlags); } \
  ...
  NS_IMETHOD GetContents(const char *aMimeType, PRBool aSelectionOnly, nsAString & _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetContents(aMimeType, aSelectionOnly, _retval); } \
  NS_IMETHOD GetCanGetContents(PRBool *aCanGetContents) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetCanGetContents(aCanGetContents); } 
...
/* AString getContents (in string aMimeType, in boolean aSelectionOnly); */
NS_IMETHODIMP nsContentViewerEdit::GetContents(const char *aMimeType, PRBool aSelectionOnly, nsAString & _retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
