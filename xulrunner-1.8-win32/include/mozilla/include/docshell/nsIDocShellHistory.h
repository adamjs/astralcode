/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/docshell/base/nsIDocShellHistory.idl
 */
...
class NS_NO_VTABLE nsIDocShellHistory : public nsISupports {
 public: 
  ...
  NS_IMETHOD GetUseGlobalHistory(PRBool *aUseGlobalHistory) = 0;
  NS_IMETHOD SetUseGlobalHistory(PRBool aUseGlobalHistory) = 0;
...
#define NS_DECL_NSIDOCSHELLHISTORY \
  ...
  NS_IMETHOD GetUseGlobalHistory(PRBool *aUseGlobalHistory); \
  NS_IMETHOD SetUseGlobalHistory(PRBool aUseGlobalHistory); 
...
#define NS_FORWARD_NSIDOCSHELLHISTORY(_to) \
  ...
  NS_IMETHOD GetUseGlobalHistory(PRBool *aUseGlobalHistory) { return _to GetUseGlobalHistory(aUseGlobalHistory); } \
  NS_IMETHOD SetUseGlobalHistory(PRBool aUseGlobalHistory) { return _to SetUseGlobalHistory(aUseGlobalHistory); } 
...
#define NS_FORWARD_SAFE_NSIDOCSHELLHISTORY(_to) \
  ...
  NS_IMETHOD GetUseGlobalHistory(PRBool *aUseGlobalHistory) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetUseGlobalHistory(aUseGlobalHistory); } \
  NS_IMETHOD SetUseGlobalHistory(PRBool aUseGlobalHistory) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetUseGlobalHistory(aUseGlobalHistory); } 
