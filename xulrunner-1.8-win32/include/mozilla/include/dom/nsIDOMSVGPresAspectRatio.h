/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/dom/public/idl/svg/nsIDOMSVGPresAspectRatio.idl
 */
...
class NS_NO_VTABLE nsIDOMSVGPreserveAspectRatio : public nsISupports {
 public: 

  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IDOMSVGPRESERVEASPECTRATIO_IID)
  ...
  NS_IMETHOD GetAlign(PRUint16 *aAlign) = 0;
  NS_IMETHOD SetAlign(PRUint16 aAlign) = 0;

  /* attribute unsigned short meetOrSlice; */
  NS_IMETHOD GetMeetOrSlice(PRUint16 *aMeetOrSlice) = 0;
  NS_IMETHOD SetMeetOrSlice(PRUint16 aMeetOrSlice) = 0;
...
#define NS_FORWARD_NSIDOMSVGPRESERVEASPECTRATIO(_to) \
  NS_IMETHOD GetAlign(PRUint16 *aAlign) { return _to GetAlign(aAlign); } \
  NS_IMETHOD SetAlign(PRUint16 aAlign) { return _to SetAlign(aAlign); } \
  NS_IMETHOD GetMeetOrSlice(PRUint16 *aMeetOrSlice) { return _to GetMeetOrSlice(aMeetOrSlice); } \
  NS_IMETHOD SetMeetOrSlice(PRUint16 aMeetOrSlice) { return _to SetMeetOrSlice(aMeetOrSlice); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDOMSVGPRESERVEASPECTRATIO(_to) \
  NS_IMETHOD GetAlign(PRUint16 *aAlign) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetAlign(aAlign); } \
  NS_IMETHOD SetAlign(PRUint16 aAlign) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetAlign(aAlign); } \
  NS_IMETHOD GetMeetOrSlice(PRUint16 *aMeetOrSlice) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetMeetOrSlice(aMeetOrSlice); } \
  NS_IMETHOD SetMeetOrSlice(PRUint16 aMeetOrSlice) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetMeetOrSlice(aMeetOrSlice); } 
