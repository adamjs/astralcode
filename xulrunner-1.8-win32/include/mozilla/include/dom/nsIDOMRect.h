/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/dom/public/idl/css/nsIDOMRect.idl
 */
...
#define NS_FORWARD_SAFE_NSIDOMRECT(_to) \
  NS_IMETHOD GetTop(nsIDOMCSSPrimitiveValue * *aTop) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetTop(aTop); } \
  NS_IMETHOD GetRight(nsIDOMCSSPrimitiveValue * *aRight) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetRight(aRight); } \
  NS_IMETHOD GetBottom(nsIDOMCSSPrimitiveValue * *aBottom) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetBottom(aBottom); } \
  NS_IMETHOD GetLeft(nsIDOMCSSPrimitiveValue * *aLeft) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetLeft(aLeft); } 
