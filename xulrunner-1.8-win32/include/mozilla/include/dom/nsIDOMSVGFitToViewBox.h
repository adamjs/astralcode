/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/dom/public/idl/svg/nsIDOMSVGFitToViewBox.idl
 */
...
class NS_NO_VTABLE nsIDOMSVGFitToViewBox : public nsISupports {
 public: 

  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IDOMSVGFITTOVIEWBOX_IID)

  /* readonly attribute nsIDOMSVGAnimatedRect viewBox; */
  NS_IMETHOD GetViewBox(nsIDOMSVGAnimatedRect * *aViewBox) = 0;

  /* readonly attribute nsIDOMSVGAnimatedPreserveAspectRatio preserveAspectRatio; */
  NS_IMETHOD GetPreserveAspectRatio(nsIDOMSVGAnimatedPreserveAspectRatio * *aPreserveAspectRatio) = 0;

};

/* Use this macro when declaring classes that implement this interface. */
#define NS_DECL_NSIDOMSVGFITTOVIEWBOX \
  NS_IMETHOD GetViewBox(nsIDOMSVGAnimatedRect * *aViewBox); \
...
#define NS_FORWARD_NSIDOMSVGFITTOVIEWBOX(_to) \
  NS_IMETHOD GetViewBox(nsIDOMSVGAnimatedRect * *aViewBox) { return _to GetViewBox(aViewBox); } \
  NS_IMETHOD GetPreserveAspectRatio(nsIDOMSVGAnimatedPreserveAspectRatio * *aPreserveAspectRatio) { return _to GetPreserveAspectRatio(aPreserveAspectRatio); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDOMSVGFITTOVIEWBOX(_to) \
  NS_IMETHOD GetViewBox(nsIDOMSVGAnimatedRect * *aViewBox) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetViewBox(aViewBox); } \
  NS_IMETHOD GetPreserveAspectRatio(nsIDOMSVGAnimatedPreserveAspectRatio * *aPreserveAspectRatio) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetPreserveAspectRatio(aPreserveAspectRatio); } 
