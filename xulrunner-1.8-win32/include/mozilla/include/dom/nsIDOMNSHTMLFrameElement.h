/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/dom/public/idl/html/nsIDOMNSHTMLFrameElement.idl
 */
...
class NS_NO_VTABLE nsIDOMNSHTMLFrameElement : public nsISupports {
 public: 
