/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/dom/public/idl/svg/nsIDOMSVGAnimatedPoints.idl
 */
...
class NS_NO_VTABLE nsIDOMSVGAnimatedPoints : public nsISupports {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IDOMSVGANIMATEDPOINTS_IID)

  /* readonly attribute nsIDOMSVGPointList points; */
  NS_IMETHOD GetPoints(nsIDOMSVGPointList * *aPoints) = 0;

  /* readonly attribute nsIDOMSVGPointList animatedPoints; */
  NS_IMETHOD GetAnimatedPoints(nsIDOMSVGPointList * *aAnimatedPoints) = 0;

};

/* Use this macro when declaring classes that implement this interface. */
#define NS_DECL_NSIDOMSVGANIMATEDPOINTS \
  NS_IMETHOD GetPoints(nsIDOMSVGPointList * *aPoints); \
  NS_IMETHOD GetAnimatedPoints(nsIDOMSVGPointList * *aAnimatedPoints); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDOMSVGANIMATEDPOINTS(_to) \
  NS_IMETHOD GetPoints(nsIDOMSVGPointList * *aPoints) { return _to GetPoints(aPoints); } \
  NS_IMETHOD GetAnimatedPoints(nsIDOMSVGPointList * *aAnimatedPoints) { return _to GetAnimatedPoints(aAnimatedPoints); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDOMSVGANIMATEDPOINTS(_to) \
  NS_IMETHOD GetPoints(nsIDOMSVGPointList * *aPoints) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetPoints(aPoints); } \
  NS_IMETHOD GetAnimatedPoints(nsIDOMSVGPointList * *aAnimatedPoints) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetAnimatedPoints(aAnimatedPoints); } 
