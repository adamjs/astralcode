/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/dom/public/idl/range/nsIDOMRangeException.idl
 */
...
class NS_NO_VTABLE nsIDOMRangeException : public nsISupports {
 public: 

  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IDOMRANGEEXCEPTION_IID)
