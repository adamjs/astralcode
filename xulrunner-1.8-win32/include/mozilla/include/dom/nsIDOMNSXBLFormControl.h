/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/dom/public/idl/html/nsIDOMNSXBLFormControl.idl
 */
...
class NS_NO_VTABLE nsIDOMNSXBLFormControl : public nsISupports {
 public: 

  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IDOMNSXBLFORMCONTROL_IID)
