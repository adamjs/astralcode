/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/dom/public/idl/ls/nsIDOMLSLoadEvent.idl
 */
...
class NS_NO_VTABLE nsIDOMLSLoadEvent : public nsIDOMEvent {
 public: 

  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IDOMLSLOADEVENT_IID)

  /* readonly attribute nsIDOMDocument newDocument; */
  NS_IMETHOD GetNewDocument(nsIDOMDocument * *aNewDocument) = 0;
...
#define NS_DECL_NSIDOMLSLOADEVENT \
  NS_IMETHOD GetNewDocument(nsIDOMDocument * *aNewDocument); \
  NS_IMETHOD GetInput(nsIDOMLSInput * *aInput); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDOMLSLOADEVENT(_to) \
  NS_IMETHOD GetNewDocument(nsIDOMDocument * *aNewDocument) { return _to GetNewDocument(aNewDocument); } \
...
#define NS_FORWARD_SAFE_NSIDOMLSLOADEVENT(_to) \
  NS_IMETHOD GetNewDocument(nsIDOMDocument * *aNewDocument) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetNewDocument(aNewDocument); } \
