/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/dom/public/idl/html/nsIDOMNSHTMLFormElement.idl
 */
...
class NS_NO_VTABLE nsIDOMNSHTMLFormElement : public nsISupports {
 public: 
