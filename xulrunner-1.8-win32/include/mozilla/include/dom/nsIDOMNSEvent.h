/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/dom/public/idl/events/nsIDOMNSEvent.idl
 */
...
class NS_NO_VTABLE nsIDOMNSEvent : public nsISupports {
 public: 
  ...
  NS_IMETHOD GetIsTrusted(PRBool *aIsTrusted) = 0;
...
#define NS_DECL_NSIDOMNSEVENT \
  ...
  NS_IMETHOD GetIsTrusted(PRBool *aIsTrusted); 
...
#define NS_FORWARD_NSIDOMNSEVENT(_to) \
  ...
  NS_IMETHOD GetIsTrusted(PRBool *aIsTrusted) { return _to GetIsTrusted(aIsTrusted); } 
...
#define NS_FORWARD_SAFE_NSIDOMNSEVENT(_to) \
  ...
  NS_IMETHOD GetIsTrusted(PRBool *aIsTrusted) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetIsTrusted(aIsTrusted); } 
