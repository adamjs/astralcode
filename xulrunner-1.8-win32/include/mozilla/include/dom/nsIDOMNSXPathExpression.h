/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/dom/public/idl/xpath/nsIDOMNSXPathExpression.idl
 */
 ...
 */
class NS_NO_VTABLE nsIDOMNSXPathExpression : public nsISupports {
 public: 

  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IDOMNSXPATHEXPRESSION_IID)
  ...
  NS_IMETHOD EvaluateWithContext(nsIDOMNode *contextNode, PRUint32 contextPosition, PRUint32 contextSize, PRUint16 type, nsISupports *result, nsISupports **_retval) = 0;

};

/* Use this macro when declaring classes that implement this interface. */
#define NS_DECL_NSIDOMNSXPATHEXPRESSION \
  NS_IMETHOD EvaluateWithContext(nsIDOMNode *contextNode, PRUint32 contextPosition, PRUint32 contextSize, PRUint16 type, nsISupports *result, nsISupports **_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDOMNSXPATHEXPRESSION(_to) \
  NS_IMETHOD EvaluateWithContext(nsIDOMNode *contextNode, PRUint32 contextPosition, PRUint32 contextSize, PRUint16 type, nsISupports *result, nsISupports **_retval) { return _to EvaluateWithContext(contextNode, contextPosition, contextSize, type, result, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDOMNSXPATHEXPRESSION(_to) \
  NS_IMETHOD EvaluateWithContext(nsIDOMNode *contextNode, PRUint32 contextPosition, PRUint32 contextSize, PRUint16 type, nsISupports *result, nsISupports **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->EvaluateWithContext(contextNode, contextPosition, contextSize, type, result, _retval); } 
...
/* nsISupports evaluateWithContext (in nsIDOMNode contextNode, in unsigned long contextPosition, in unsigned long contextSize, in unsigned short type, in nsISupports result)  raises (XPathException, DOMException); */
NS_IMETHODIMP nsDOMNSXPathExpression::EvaluateWithContext(nsIDOMNode *contextNode, PRUint32 contextPosition, PRUint32 contextSize, PRUint16 type, nsISupports *result, nsISupports **_retval)
{
