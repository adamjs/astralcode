/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/dom/public/idl/svg/nsIDOMSVGAnimatedEnum.idl
 */
...
class NS_NO_VTABLE nsIDOMSVGAnimatedEnumeration : public nsISupports {
 public: 

  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IDOMSVGANIMATEDENUMERATION_IID)

  /* attribute unsigned short baseVal; */
  NS_IMETHOD GetBaseVal(PRUint16 *aBaseVal) = 0;
  NS_IMETHOD SetBaseVal(PRUint16 aBaseVal) = 0;

  /* readonly attribute unsigned short animVal; */
  NS_IMETHOD GetAnimVal(PRUint16 *aAnimVal) = 0;

};

/* Use this macro when declaring classes that implement this interface. */
#define NS_DECL_NSIDOMSVGANIMATEDENUMERATION \
  NS_IMETHOD GetBaseVal(PRUint16 *aBaseVal); \
  NS_IMETHOD SetBaseVal(PRUint16 aBaseVal); \
  NS_IMETHOD GetAnimVal(PRUint16 *aAnimVal); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDOMSVGANIMATEDENUMERATION(_to) \
  NS_IMETHOD GetBaseVal(PRUint16 *aBaseVal) { return _to GetBaseVal(aBaseVal); } \
  NS_IMETHOD SetBaseVal(PRUint16 aBaseVal) { return _to SetBaseVal(aBaseVal); } \
  NS_IMETHOD GetAnimVal(PRUint16 *aAnimVal) { return _to GetAnimVal(aAnimVal); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDOMSVGANIMATEDENUMERATION(_to) \
  NS_IMETHOD GetBaseVal(PRUint16 *aBaseVal) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetBaseVal(aBaseVal); } \
  NS_IMETHOD SetBaseVal(PRUint16 aBaseVal) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetBaseVal(aBaseVal); } \
  NS_IMETHOD GetAnimVal(PRUint16 *aAnimVal) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetAnimVal(aAnimVal); } 
