/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/dom/public/idl/svg/nsIDOMSVGAngle.idl
 */
 ...
 *
 */
class NS_NO_VTABLE nsIDOMSVGAngle : public nsISupports {
 public: 

  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IDOMSVGANGLE_IID)
