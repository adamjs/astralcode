/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/dom/public/idl/css/nsIDOMRGBColor.idl
 */
...
#define NS_FORWARD_SAFE_NSIDOMRGBCOLOR(_to) \
  NS_IMETHOD GetRed(nsIDOMCSSPrimitiveValue * *aRed) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetRed(aRed); } \
  NS_IMETHOD GetGreen(nsIDOMCSSPrimitiveValue * *aGreen) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetGreen(aGreen); } \
  NS_IMETHOD GetBlue(nsIDOMCSSPrimitiveValue * *aBlue) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetBlue(aBlue); } 
