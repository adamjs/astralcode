/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/dom/public/idl/css/nsIDOMElementCSSInlineStyle.idl
 */
 ...
 * @status FROZEN
 */
class NS_NO_VTABLE nsIDOMElementCSSInlineStyle : public nsISupports {
 public: 

  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IDOMELEMENTCSSINLINESTYLE_IID)
