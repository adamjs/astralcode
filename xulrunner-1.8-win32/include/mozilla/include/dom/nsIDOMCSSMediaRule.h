/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/dom/public/idl/css/nsIDOMCSSMediaRule.idl
 */
...
/* unsigned long insertRule (in DOMString rule, in unsigned long index)  raises (DOMException); */
NS_IMETHODIMP nsDOMCSSMediaRule::InsertRule(const nsAString & rule, PRUint32 index, PRUint32 *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
