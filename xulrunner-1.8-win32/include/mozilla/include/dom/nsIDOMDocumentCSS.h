/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/dom/public/idl/css/nsIDOMDocumentCSS.idl
 */
...
class NS_NO_VTABLE nsIDOMDocumentCSS : public nsIDOMDocumentStyle {
 public: 
  ...
  NS_IMETHOD GetOverrideStyle(nsIDOMElement *elt, const nsAString & pseudoElt, nsIDOMCSSStyleDeclaration **_retval) = 0;

};

/* Use this macro when declaring classes that implement this interface. */
#define NS_DECL_NSIDOMDOCUMENTCSS \
  NS_IMETHOD GetOverrideStyle(nsIDOMElement *elt, const nsAString & pseudoElt, nsIDOMCSSStyleDeclaration **_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDOMDOCUMENTCSS(_to) \
  NS_IMETHOD GetOverrideStyle(nsIDOMElement *elt, const nsAString & pseudoElt, nsIDOMCSSStyleDeclaration **_retval) { return _to GetOverrideStyle(elt, pseudoElt, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDOMDOCUMENTCSS(_to) \
  NS_IMETHOD GetOverrideStyle(nsIDOMElement *elt, const nsAString & pseudoElt, nsIDOMCSSStyleDeclaration **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetOverrideStyle(elt, pseudoElt, _retval); } 
...
/* nsIDOMCSSStyleDeclaration getOverrideStyle (in nsIDOMElement elt, in DOMString pseudoElt); */
NS_IMETHODIMP nsDOMDocumentCSS::GetOverrideStyle(nsIDOMElement *elt, const nsAString & pseudoElt, nsIDOMCSSStyleDeclaration **_retval)
{
