/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/dom/public/idl/xul/nsIDOMXULElement.idl
 */
...
#define NS_IDOMXULELEMENT_IID_STR "0574ed81-c088-11d2-96ed-00104b7b7deb"
...
class NS_NO_VTABLE nsIDOMXULElement : public nsIDOMElement {
 public: 
  ...
  NS_IMETHOD SetHidden(PRBool aHidden) = 0;

  /* attribute boolean collapsed; */
  NS_IMETHOD GetCollapsed(PRBool *aCollapsed) = 0;
  NS_IMETHOD SetCollapsed(PRBool aCollapsed) = 0;
  ...
  NS_IMETHOD GetAllowEvents(PRBool *aAllowEvents) = 0;
  NS_IMETHOD SetAllowEvents(PRBool aAllowEvents) = 0;
...
#define NS_DECL_NSIDOMXULELEMENT \
  ...
  NS_IMETHOD SetCollapsed(PRBool aCollapsed); \
  ...
  NS_IMETHOD GetAllowEvents(PRBool *aAllowEvents); \
  NS_IMETHOD SetAllowEvents(PRBool aAllowEvents); \
...
#define NS_FORWARD_NSIDOMXULELEMENT(_to) \
  ...
  NS_IMETHOD SetHidden(PRBool aHidden) { return _to SetHidden(aHidden); } \
  NS_IMETHOD GetCollapsed(PRBool *aCollapsed) { return _to GetCollapsed(aCollapsed); } \
  NS_IMETHOD SetCollapsed(PRBool aCollapsed) { return _to SetCollapsed(aCollapsed); } \
  ...
  NS_IMETHOD GetAllowEvents(PRBool *aAllowEvents) { return _to GetAllowEvents(aAllowEvents); } \
  NS_IMETHOD SetAllowEvents(PRBool aAllowEvents) { return _to SetAllowEvents(aAllowEvents); } \
...
#define NS_FORWARD_SAFE_NSIDOMXULELEMENT(_to) \
  ...
  NS_IMETHOD SetHidden(PRBool aHidden) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetHidden(aHidden); } \
  NS_IMETHOD GetCollapsed(PRBool *aCollapsed) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetCollapsed(aCollapsed); } \
  NS_IMETHOD SetCollapsed(PRBool aCollapsed) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetCollapsed(aCollapsed); } \
  ...
  NS_IMETHOD GetAllowEvents(PRBool *aAllowEvents) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetAllowEvents(aAllowEvents); } \
  NS_IMETHOD SetAllowEvents(PRBool aAllowEvents) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetAllowEvents(aAllowEvents); } \
...
/* readonly attribute nsIDOMCSSStyleDeclaration style; */
NS_IMETHODIMP nsDOMXULElement::GetStyle(nsIDOMCSSStyleDeclaration * *aStyle)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
