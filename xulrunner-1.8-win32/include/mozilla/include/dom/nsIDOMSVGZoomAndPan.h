/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/dom/public/idl/svg/nsIDOMSVGZoomAndPan.idl
 */
...
class NS_NO_VTABLE nsIDOMSVGZoomAndPan : public nsISupports {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IDOMSVGZOOMANDPAN_IID)
  ...
  NS_IMETHOD GetZoomAndPan(PRUint16 *aZoomAndPan) = 0;
  NS_IMETHOD SetZoomAndPan(PRUint16 aZoomAndPan) = 0;

};

/* Use this macro when declaring classes that implement this interface. */
#define NS_DECL_NSIDOMSVGZOOMANDPAN \
  NS_IMETHOD GetZoomAndPan(PRUint16 *aZoomAndPan); \
  NS_IMETHOD SetZoomAndPan(PRUint16 aZoomAndPan); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDOMSVGZOOMANDPAN(_to) \
  NS_IMETHOD GetZoomAndPan(PRUint16 *aZoomAndPan) { return _to GetZoomAndPan(aZoomAndPan); } \
  NS_IMETHOD SetZoomAndPan(PRUint16 aZoomAndPan) { return _to SetZoomAndPan(aZoomAndPan); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDOMSVGZOOMANDPAN(_to) \
  NS_IMETHOD GetZoomAndPan(PRUint16 *aZoomAndPan) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetZoomAndPan(aZoomAndPan); } \
  NS_IMETHOD SetZoomAndPan(PRUint16 aZoomAndPan) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetZoomAndPan(aZoomAndPan); } 
