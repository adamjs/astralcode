/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/dom/public/idl/svg/nsIDOMSVGRect.idl
 */
...
class NS_NO_VTABLE nsIDOMSVGRect : public nsISupports {
 public: 

  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IDOMSVGRECT_IID)
  ...
  NS_IMETHOD SetWidth(float aWidth) = 0;

  /* attribute float height; */
  NS_IMETHOD GetHeight(float *aHeight) = 0;
  NS_IMETHOD SetHeight(float aHeight) = 0;
...
#define NS_FORWARD_NSIDOMSVGRECT(_to) \
  ...
  NS_IMETHOD SetWidth(float aWidth) { return _to SetWidth(aWidth); } \
  NS_IMETHOD GetHeight(float *aHeight) { return _to GetHeight(aHeight); } \
  NS_IMETHOD SetHeight(float aHeight) { return _to SetHeight(aHeight); } 
...
#define NS_FORWARD_SAFE_NSIDOMSVGRECT(_to) \
  ...
  NS_IMETHOD SetWidth(float aWidth) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetWidth(aWidth); } \
  NS_IMETHOD GetHeight(float *aHeight) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetHeight(aHeight); } \
  NS_IMETHOD SetHeight(float aHeight) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetHeight(aHeight); } 
