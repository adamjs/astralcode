/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/dom/public/idl/xpath/nsIDOMXPathNSResolver.idl
 */
...
class NS_NO_VTABLE nsIDOMXPathNSResolver : public nsISupports {
 public: 

  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IDOMXPATHNSRESOLVER_IID)
...
/* DOMString lookupNamespaceURI (in DOMString prefix); */
NS_IMETHODIMP nsDOMXPathNSResolver::LookupNamespaceURI(const nsAString & prefix, nsAString & _retval)
{
