/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/dom/public/idl/core/nsIDOMXMLDocument.idl
 */
...
class NS_NO_VTABLE nsIDOMXMLDocument : public nsIDOMDocument {
 public: 
  ...
  NS_IMETHOD SetAsync(PRBool aAsync) = 0;
  ...
  NS_IMETHOD Load(const nsAString & url, PRBool *_retval) = 0;
  ...
  */
  ...
  NS_IMETHOD EvaluateXPointer(const nsAString & expression, nsIXPointerResult **_retval) = 0;
...
#define NS_DECL_NSIDOMXMLDOCUMENT \
  ...
  NS_IMETHOD SetAsync(PRBool aAsync); \
  NS_IMETHOD Load(const nsAString & url, PRBool *_retval); \
  NS_IMETHOD EvaluateFIXptr(const nsAString & expression, nsIDOMRange **_retval); \
  NS_IMETHOD EvaluateXPointer(const nsAString & expression, nsIXPointerResult **_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDOMXMLDOCUMENT(_to) \
  NS_IMETHOD GetAsync(PRBool *aAsync) { return _to GetAsync(aAsync); } \
  NS_IMETHOD SetAsync(PRBool aAsync) { return _to SetAsync(aAsync); } \
  NS_IMETHOD Load(const nsAString & url, PRBool *_retval) { return _to Load(url, _retval); } \
  NS_IMETHOD EvaluateFIXptr(const nsAString & expression, nsIDOMRange **_retval) { return _to EvaluateFIXptr(expression, _retval); } \
  NS_IMETHOD EvaluateXPointer(const nsAString & expression, nsIXPointerResult **_retval) { return _to EvaluateXPointer(expression, _retval); } 
...
#define NS_FORWARD_SAFE_NSIDOMXMLDOCUMENT(_to) \
  ...
  NS_IMETHOD SetAsync(PRBool aAsync) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetAsync(aAsync); } \
  NS_IMETHOD Load(const nsAString & url, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Load(url, _retval); } \
  ...
  NS_IMETHOD EvaluateXPointer(const nsAString & expression, nsIXPointerResult **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->EvaluateXPointer(expression, _retval); } 
...
/* boolean load (in DOMString url); */
NS_IMETHODIMP nsDOMXMLDocument::Load(const nsAString & url, PRBool *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* nsIXPointerResult evaluateXPointer (in DOMString expression); */
NS_IMETHODIMP nsDOMXMLDocument::EvaluateXPointer(const nsAString & expression, nsIXPointerResult **_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
