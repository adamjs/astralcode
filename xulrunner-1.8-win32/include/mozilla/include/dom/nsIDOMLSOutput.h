/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/dom/public/idl/ls/nsIDOMLSOutput.idl
 */
...
class NS_NO_VTABLE nsIDOMLSOutput : public nsISupports {
 public: 

  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IDOMLSOUTPUT_IID)
  ...
  NS_IMETHOD GetByteStream(nsIOutputStream * *aByteStream) = 0;
  NS_IMETHOD SetByteStream(nsIOutputStream * aByteStream) = 0;
...
#define NS_DECL_NSIDOMLSOUTPUT \
  ...
  NS_IMETHOD GetByteStream(nsIOutputStream * *aByteStream); \
  NS_IMETHOD SetByteStream(nsIOutputStream * aByteStream); \
...
#define NS_FORWARD_NSIDOMLSOUTPUT(_to) \
  ...
  NS_IMETHOD GetByteStream(nsIOutputStream * *aByteStream) { return _to GetByteStream(aByteStream); } \
  NS_IMETHOD SetByteStream(nsIOutputStream * aByteStream) { return _to SetByteStream(aByteStream); } \
...
#define NS_FORWARD_SAFE_NSIDOMLSOUTPUT(_to) \
  ...
  NS_IMETHOD GetByteStream(nsIOutputStream * *aByteStream) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetByteStream(aByteStream); } \
  NS_IMETHOD SetByteStream(nsIOutputStream * aByteStream) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetByteStream(aByteStream); } \
