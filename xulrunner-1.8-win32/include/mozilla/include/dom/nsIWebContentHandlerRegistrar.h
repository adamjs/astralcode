/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/dom/public/idl/sidebar/nsIWebContentHandlerRegistrar.idl
 */
...
class NS_NO_VTABLE nsIWebContentHandlerRegistrar : public nsISupports {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IWEBCONTENTHANDLERREGISTRAR_IID)
...
#define NS_DECL_NSIWEBCONTENTHANDLERREGISTRAR \
  NS_IMETHOD RegisterContentHandler(const nsAString & mimeType, const nsAString & uri, const nsAString & title, nsIDOMWindow *contentWindow); \
  NS_IMETHOD RegisterProtocolHandler(const nsAString & protocol, const nsAString & uri, const nsAString & title, nsIDOMWindow *contentWindow); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIWEBCONTENTHANDLERREGISTRAR(_to) \
  NS_IMETHOD RegisterContentHandler(const nsAString & mimeType, const nsAString & uri, const nsAString & title, nsIDOMWindow *contentWindow) { return _to RegisterContentHandler(mimeType, uri, title, contentWindow); } \
  NS_IMETHOD RegisterProtocolHandler(const nsAString & protocol, const nsAString & uri, const nsAString & title, nsIDOMWindow *contentWindow) { return _to RegisterProtocolHandler(protocol, uri, title, contentWindow); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIWEBCONTENTHANDLERREGISTRAR(_to) \
  NS_IMETHOD RegisterContentHandler(const nsAString & mimeType, const nsAString & uri, const nsAString & title, nsIDOMWindow *contentWindow) { return !_to ? NS_ERROR_NULL_POINTER : _to->RegisterContentHandler(mimeType, uri, title, contentWindow); } \
  NS_IMETHOD RegisterProtocolHandler(const nsAString & protocol, const nsAString & uri, const nsAString & title, nsIDOMWindow *contentWindow) { return !_to ? NS_ERROR_NULL_POINTER : _to->RegisterProtocolHandler(protocol, uri, title, contentWindow); } 
