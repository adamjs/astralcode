/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/dom/public/idl/svg/nsIDOMSVGTextContentElement.idl
 */
...
class NS_NO_VTABLE nsIDOMSVGTextContentElement : public nsIDOMSVGElement {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IDOMSVGTEXTCONTENTELEMENT_IID)
  ...
  NS_IMETHOD SelectSubString(PRUint32 charnum, PRUint32 nchars) = 0;
...
#define NS_DECL_NSIDOMSVGTEXTCONTENTELEMENT \
  ...
  NS_IMETHOD SelectSubString(PRUint32 charnum, PRUint32 nchars); 
...
#define NS_FORWARD_NSIDOMSVGTEXTCONTENTELEMENT(_to) \
  ...
  NS_IMETHOD GetNumberOfChars(PRInt32 *_retval) { return _to GetNumberOfChars(_retval); } \
  NS_IMETHOD GetComputedTextLength(float *_retval) { return _to GetComputedTextLength(_retval); } \
  NS_IMETHOD GetSubStringLength(PRUint32 charnum, PRUint32 nchars, float *_retval) { return _to GetSubStringLength(charnum, nchars, _retval); } \
  NS_IMETHOD GetStartPositionOfChar(PRUint32 charnum, nsIDOMSVGPoint **_retval) { return _to GetStartPositionOfChar(charnum, _retval); } \
  NS_IMETHOD GetEndPositionOfChar(PRUint32 charnum, nsIDOMSVGPoint **_retval) { return _to GetEndPositionOfChar(charnum, _retval); } \
  NS_IMETHOD GetExtentOfChar(PRUint32 charnum, nsIDOMSVGRect **_retval) { return _to GetExtentOfChar(charnum, _retval); } \
  NS_IMETHOD GetRotationOfChar(PRUint32 charnum, float *_retval) { return _to GetRotationOfChar(charnum, _retval); } \
  NS_IMETHOD GetCharNumAtPosition(nsIDOMSVGPoint *point, PRInt32 *_retval) { return _to GetCharNumAtPosition(point, _retval); } \
  NS_IMETHOD SelectSubString(PRUint32 charnum, PRUint32 nchars) { return _to SelectSubString(charnum, nchars); } 
...
#define NS_FORWARD_SAFE_NSIDOMSVGTEXTCONTENTELEMENT(_to) \
  ...
  NS_IMETHOD GetNumberOfChars(PRInt32 *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetNumberOfChars(_retval); } \
  NS_IMETHOD GetComputedTextLength(float *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetComputedTextLength(_retval); } \
  NS_IMETHOD GetSubStringLength(PRUint32 charnum, PRUint32 nchars, float *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetSubStringLength(charnum, nchars, _retval); } \
  NS_IMETHOD GetStartPositionOfChar(PRUint32 charnum, nsIDOMSVGPoint **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetStartPositionOfChar(charnum, _retval); } \
  NS_IMETHOD GetEndPositionOfChar(PRUint32 charnum, nsIDOMSVGPoint **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetEndPositionOfChar(charnum, _retval); } \
  ...
  NS_IMETHOD GetRotationOfChar(PRUint32 charnum, float *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetRotationOfChar(charnum, _retval); } \
  NS_IMETHOD GetCharNumAtPosition(nsIDOMSVGPoint *point, PRInt32 *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetCharNumAtPosition(point, _retval); } \
  NS_IMETHOD SelectSubString(PRUint32 charnum, PRUint32 nchars) { return !_to ? NS_ERROR_NULL_POINTER : _to->SelectSubString(charnum, nchars); } 
...
/* long getNumberOfChars (); */
NS_IMETHODIMP nsDOMSVGTextContentElement::GetNumberOfChars(PRInt32 *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* float getSubStringLength (in unsigned long charnum, in unsigned long nchars); */
NS_IMETHODIMP nsDOMSVGTextContentElement::GetSubStringLength(PRUint32 charnum, PRUint32 nchars, float *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* nsIDOMSVGPoint getStartPositionOfChar (in unsigned long charnum); */
NS_IMETHODIMP nsDOMSVGTextContentElement::GetStartPositionOfChar(PRUint32 charnum, nsIDOMSVGPoint **_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* nsIDOMSVGPoint getEndPositionOfChar (in unsigned long charnum); */
NS_IMETHODIMP nsDOMSVGTextContentElement::GetEndPositionOfChar(PRUint32 charnum, nsIDOMSVGPoint **_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* nsIDOMSVGRect getExtentOfChar (in unsigned long charnum); */
NS_IMETHODIMP nsDOMSVGTextContentElement::GetExtentOfChar(PRUint32 charnum, nsIDOMSVGRect **_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* float getRotationOfChar (in unsigned long charnum); */
NS_IMETHODIMP nsDOMSVGTextContentElement::GetRotationOfChar(PRUint32 charnum, float *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* long getCharNumAtPosition (in nsIDOMSVGPoint point); */
NS_IMETHODIMP nsDOMSVGTextContentElement::GetCharNumAtPosition(nsIDOMSVGPoint *point, PRInt32 *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
