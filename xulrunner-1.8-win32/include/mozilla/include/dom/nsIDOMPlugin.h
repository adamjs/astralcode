/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/dom/public/idl/base/nsIDOMPlugin.idl
 */
...
/* nsIDOMMimeType item (in unsigned long index); */
NS_IMETHODIMP nsDOMPlugin::Item(PRUint32 index, nsIDOMMimeType **_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
