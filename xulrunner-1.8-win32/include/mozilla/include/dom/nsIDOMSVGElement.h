/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/dom/public/idl/svg/nsIDOMSVGElement.idl
 */
...
class NS_NO_VTABLE nsIDOMSVGElement : public nsIDOMElement {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IDOMSVGELEMENT_IID)
  ...
  NS_IMETHOD GetOwnerSVGElement(nsIDOMSVGSVGElement * *aOwnerSVGElement) = 0;
...
#define NS_FORWARD_NSIDOMSVGELEMENT(_to) \
  ...
  NS_IMETHOD GetOwnerSVGElement(nsIDOMSVGSVGElement * *aOwnerSVGElement) { return _to GetOwnerSVGElement(aOwnerSVGElement); } \
...
#define NS_FORWARD_SAFE_NSIDOMSVGELEMENT(_to) \
  ...
  NS_IMETHOD GetOwnerSVGElement(nsIDOMSVGSVGElement * *aOwnerSVGElement) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetOwnerSVGElement(aOwnerSVGElement); } \
