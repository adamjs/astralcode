/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/dom/public/idl/svg/nsIDOMSVGAnimatedLengthList.idl
 */
...
class NS_NO_VTABLE nsIDOMSVGAnimatedLengthList : public nsISupports {
 public: 

  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IDOMSVGANIMATEDLENGTHLIST_IID)

  /* readonly attribute nsIDOMSVGLengthList baseVal; */
  NS_IMETHOD GetBaseVal(nsIDOMSVGLengthList * *aBaseVal) = 0;

  /* readonly attribute nsIDOMSVGLengthList animVal; */
  NS_IMETHOD GetAnimVal(nsIDOMSVGLengthList * *aAnimVal) = 0;

};

/* Use this macro when declaring classes that implement this interface. */
#define NS_DECL_NSIDOMSVGANIMATEDLENGTHLIST \
  NS_IMETHOD GetBaseVal(nsIDOMSVGLengthList * *aBaseVal); \
  NS_IMETHOD GetAnimVal(nsIDOMSVGLengthList * *aAnimVal); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDOMSVGANIMATEDLENGTHLIST(_to) \
  NS_IMETHOD GetBaseVal(nsIDOMSVGLengthList * *aBaseVal) { return _to GetBaseVal(aBaseVal); } \
  NS_IMETHOD GetAnimVal(nsIDOMSVGLengthList * *aAnimVal) { return _to GetAnimVal(aAnimVal); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDOMSVGANIMATEDLENGTHLIST(_to) \
  NS_IMETHOD GetBaseVal(nsIDOMSVGLengthList * *aBaseVal) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetBaseVal(aBaseVal); } \
  NS_IMETHOD GetAnimVal(nsIDOMSVGLengthList * *aAnimVal) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetAnimVal(aAnimVal); } 
