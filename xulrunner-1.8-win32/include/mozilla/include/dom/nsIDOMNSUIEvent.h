/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/dom/public/idl/events/nsIDOMNSUIEvent.idl
 */
...
class NS_NO_VTABLE nsIDOMNSUIEvent : public nsISupports {
 public: 
  ...
  NS_IMETHOD GetPreventDefault(PRBool *_retval) = 0;
...
#define NS_DECL_NSIDOMNSUIEVENT \
  NS_IMETHOD GetPreventDefault(PRBool *_retval); \
...
#define NS_FORWARD_SAFE_NSIDOMNSUIEVENT(_to) \
  NS_IMETHOD GetPreventDefault(PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetPreventDefault(_retval); } \
...
/* boolean getPreventDefault (); */
NS_IMETHODIMP nsDOMNSUIEvent::GetPreventDefault(PRBool *_retval)
{
