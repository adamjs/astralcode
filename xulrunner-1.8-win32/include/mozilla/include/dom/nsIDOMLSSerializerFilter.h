/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/dom/public/idl/ls/nsIDOMLSSerializerFilter.idl
 */
...
class NS_NO_VTABLE nsIDOMLSSerializerFilter : public nsIDOMNodeFilter {
 public: 

  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IDOMLSSERIALIZERFILTER_IID)
