/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/dom/public/idl/svg/nsIDOMSVGGradientElement.idl
 */
...
class NS_NO_VTABLE nsIDOMSVGGradientElement : public nsIDOMSVGElement {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IDOMSVGGRADIENTELEMENT_IID)
  ...
  NS_IMETHOD GetGradientTransform(nsIDOMSVGAnimatedTransformList * *aGradientTransform) = 0;
...
#define NS_DECL_NSIDOMSVGGRADIENTELEMENT \
  ...
  NS_IMETHOD GetGradientTransform(nsIDOMSVGAnimatedTransformList * *aGradientTransform); \
...
#define NS_FORWARD_NSIDOMSVGGRADIENTELEMENT(_to) \
  ...
  NS_IMETHOD GetGradientTransform(nsIDOMSVGAnimatedTransformList * *aGradientTransform) { return _to GetGradientTransform(aGradientTransform); } \
...
#define NS_FORWARD_SAFE_NSIDOMSVGGRADIENTELEMENT(_to) \
  ...
  NS_IMETHOD GetGradientTransform(nsIDOMSVGAnimatedTransformList * *aGradientTransform) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetGradientTransform(aGradientTransform); } \
...
class NS_NO_VTABLE nsIDOMSVGLinearGradientElement : public nsIDOMSVGGradientElement {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IDOMSVGLINEARGRADIENTELEMENT_IID)
...
class NS_NO_VTABLE nsIDOMSVGRadialGradientElement : public nsIDOMSVGGradientElement {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IDOMSVGRADIALGRADIENTELEMENT_IID)
