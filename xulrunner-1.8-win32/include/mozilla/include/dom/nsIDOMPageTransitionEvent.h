/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/dom/public/idl/events/nsIDOMPageTransitionEvent.idl
 */
...
class NS_NO_VTABLE nsIDOMPageTransitionEvent : public nsIDOMEvent {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IDOMPAGETRANSITIONEVENT_IID)
  ...
  NS_IMETHOD GetPersisted(PRBool *aPersisted) = 0;

  /* void initPageTransitionEvent (in DOMString typeArg, in boolean canBubbleArg, in boolean canCancelArg, in boolean persisted); */
  NS_IMETHOD InitPageTransitionEvent(const nsAString & typeArg, PRBool canBubbleArg, PRBool canCancelArg, PRBool persisted) = 0;

};

/* Use this macro when declaring classes that implement this interface. */
#define NS_DECL_NSIDOMPAGETRANSITIONEVENT \
  NS_IMETHOD GetPersisted(PRBool *aPersisted); \
  NS_IMETHOD InitPageTransitionEvent(const nsAString & typeArg, PRBool canBubbleArg, PRBool canCancelArg, PRBool persisted); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDOMPAGETRANSITIONEVENT(_to) \
  NS_IMETHOD GetPersisted(PRBool *aPersisted) { return _to GetPersisted(aPersisted); } \
  NS_IMETHOD InitPageTransitionEvent(const nsAString & typeArg, PRBool canBubbleArg, PRBool canCancelArg, PRBool persisted) { return _to InitPageTransitionEvent(typeArg, canBubbleArg, canCancelArg, persisted); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDOMPAGETRANSITIONEVENT(_to) \
  NS_IMETHOD GetPersisted(PRBool *aPersisted) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetPersisted(aPersisted); } \
  NS_IMETHOD InitPageTransitionEvent(const nsAString & typeArg, PRBool canBubbleArg, PRBool canCancelArg, PRBool persisted) { return !_to ? NS_ERROR_NULL_POINTER : _to->InitPageTransitionEvent(typeArg, canBubbleArg, canCancelArg, persisted); } 
