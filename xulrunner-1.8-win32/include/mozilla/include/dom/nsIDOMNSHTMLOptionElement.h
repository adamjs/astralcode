/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/dom/public/idl/html/nsIDOMNSHTMLOptionElement.idl
 */
...
class NS_NO_VTABLE nsIDOMNSHTMLOptionElement : public nsISupports {
 public: 
