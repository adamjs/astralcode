/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/dom/public/idl/svg/nsIDOMSVGURIReference.idl
 */
...
class NS_NO_VTABLE nsIDOMSVGURIReference : public nsISupports {
 public: 

  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IDOMSVGURIREFERENCE_IID)

  /* readonly attribute nsIDOMSVGAnimatedString href; */
  NS_IMETHOD GetHref(nsIDOMSVGAnimatedString * *aHref) = 0;

};

/* Use this macro when declaring classes that implement this interface. */
#define NS_DECL_NSIDOMSVGURIREFERENCE \
  NS_IMETHOD GetHref(nsIDOMSVGAnimatedString * *aHref); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDOMSVGURIREFERENCE(_to) \
  NS_IMETHOD GetHref(nsIDOMSVGAnimatedString * *aHref) { return _to GetHref(aHref); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDOMSVGURIREFERENCE(_to) \
  NS_IMETHOD GetHref(nsIDOMSVGAnimatedString * *aHref) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetHref(aHref); } 
