/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/dom/public/idl/svg/nsIDOMSVGPoint.idl
 */
...
class NS_NO_VTABLE nsIDOMSVGPoint : public nsISupports {
 public: 

  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IDOMSVGPOINT_IID)
  ...
  NS_IMETHOD MatrixTransform(nsIDOMSVGMatrix *matrix, nsIDOMSVGPoint **_retval) = 0;
...
#define NS_DECL_NSIDOMSVGPOINT \
  ...
  NS_IMETHOD MatrixTransform(nsIDOMSVGMatrix *matrix, nsIDOMSVGPoint **_retval); 
...
#define NS_FORWARD_NSIDOMSVGPOINT(_to) \
  ...
  NS_IMETHOD MatrixTransform(nsIDOMSVGMatrix *matrix, nsIDOMSVGPoint **_retval) { return _to MatrixTransform(matrix, _retval); } 
...
#define NS_FORWARD_SAFE_NSIDOMSVGPOINT(_to) \
  ...
  NS_IMETHOD MatrixTransform(nsIDOMSVGMatrix *matrix, nsIDOMSVGPoint **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->MatrixTransform(matrix, _retval); } 
...
/* nsIDOMSVGPoint matrixTransform (in nsIDOMSVGMatrix matrix); */
NS_IMETHODIMP nsDOMSVGPoint::MatrixTransform(nsIDOMSVGMatrix *matrix, nsIDOMSVGPoint **_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
