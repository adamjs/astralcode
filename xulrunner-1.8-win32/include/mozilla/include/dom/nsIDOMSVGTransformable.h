/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/dom/public/idl/svg/nsIDOMSVGTransformable.idl
 */
...
class NS_NO_VTABLE nsIDOMSVGTransformable : public nsIDOMSVGLocatable {
 public: 

  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IDOMSVGTRANSFORMABLE_IID)

  /* readonly attribute nsIDOMSVGAnimatedTransformList transform; */
  NS_IMETHOD GetTransform(nsIDOMSVGAnimatedTransformList * *aTransform) = 0;

};

/* Use this macro when declaring classes that implement this interface. */
#define NS_DECL_NSIDOMSVGTRANSFORMABLE \
  NS_IMETHOD GetTransform(nsIDOMSVGAnimatedTransformList * *aTransform); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDOMSVGTRANSFORMABLE(_to) \
  NS_IMETHOD GetTransform(nsIDOMSVGAnimatedTransformList * *aTransform) { return _to GetTransform(aTransform); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDOMSVGTRANSFORMABLE(_to) \
  NS_IMETHOD GetTransform(nsIDOMSVGAnimatedTransformList * *aTransform) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetTransform(aTransform); } 
