/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/xpcom/reflect/xptinfo/public/nsIXPTLoader.idl
 */
...
#define NS_FORWARD_NSIXPTLOADER(_to) \
  ...
  NS_IMETHOD LoadEntry(nsILocalFile *file, const char *name, nsIInputStream **_retval) { return _to LoadEntry(file, name, _retval); } 
...
#define NS_FORWARD_SAFE_NSIXPTLOADER(_to) \
  ...
  NS_IMETHOD LoadEntry(nsILocalFile *file, const char *name, nsIInputStream **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->LoadEntry(file, name, _retval); } 
...
/* nsIInputStream loadEntry (in nsILocalFile file, in string name); */
NS_IMETHODIMP nsXPTLoader::LoadEntry(nsILocalFile *file, const char *name, nsIInputStream **_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
