/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/xpcom/ds/nsITimelineService.idl
 */
 ...
 */
class NS_NO_VTABLE nsITimelineService : public nsISupports {
 public: 

  NS_DEFINE_STATIC_IID_ACCESSOR(NS_ITIMELINESERVICE_IID)
  ...
  NS_IMETHOD Mark(const char *text) = 0;
  ...
  /**
     ...
     */
  /* void indent (); */
  NS_IMETHOD Indent(void) = 0;

  /**
     * Causes subsequent marks to be outdented.
     */
  /* void outdent (); */
  NS_IMETHOD Outdent(void) = 0;
  ...
  NS_IMETHOD Enter(const char *text) = 0;

  /* void leave (in string text); */
  NS_IMETHOD Leave(const char *text) = 0;

  /* void startTimer (in string timerName); */
  NS_IMETHOD StartTimer(const char *timerName) = 0;

  /* void stopTimer (in string timerName); */
  NS_IMETHOD StopTimer(const char *timerName) = 0;

  /* void markTimer (in string timerName); */
  NS_IMETHOD MarkTimer(const char *timerName) = 0;

  /* void resetTimer (in string timerName); */
  NS_IMETHOD ResetTimer(const char *timerName) = 0;

  /* void markTimerWithComment (in string timerName, in string comment); */
  NS_IMETHOD MarkTimerWithComment(const char *timerName, const char *comment) = 0;

};

/* Use this macro when declaring classes that implement this interface. */
#define NS_DECL_NSITIMELINESERVICE \
  NS_IMETHOD Mark(const char *text); \
  NS_IMETHOD Indent(void); \
  NS_IMETHOD Outdent(void); \
  NS_IMETHOD Enter(const char *text); \
  NS_IMETHOD Leave(const char *text); \
  NS_IMETHOD StartTimer(const char *timerName); \
  NS_IMETHOD StopTimer(const char *timerName); \
  NS_IMETHOD MarkTimer(const char *timerName); \
  NS_IMETHOD ResetTimer(const char *timerName); \
  NS_IMETHOD MarkTimerWithComment(const char *timerName, const char *comment); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSITIMELINESERVICE(_to) \
  NS_IMETHOD Mark(const char *text) { return _to Mark(text); } \
  NS_IMETHOD Indent(void) { return _to Indent(); } \
  NS_IMETHOD Outdent(void) { return _to Outdent(); } \
  NS_IMETHOD Enter(const char *text) { return _to Enter(text); } \
  NS_IMETHOD Leave(const char *text) { return _to Leave(text); } \
  NS_IMETHOD StartTimer(const char *timerName) { return _to StartTimer(timerName); } \
  NS_IMETHOD StopTimer(const char *timerName) { return _to StopTimer(timerName); } \
  NS_IMETHOD MarkTimer(const char *timerName) { return _to MarkTimer(timerName); } \
  NS_IMETHOD ResetTimer(const char *timerName) { return _to ResetTimer(timerName); } \
  NS_IMETHOD MarkTimerWithComment(const char *timerName, const char *comment) { return _to MarkTimerWithComment(timerName, comment); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSITIMELINESERVICE(_to) \
  NS_IMETHOD Mark(const char *text) { return !_to ? NS_ERROR_NULL_POINTER : _to->Mark(text); } \
  NS_IMETHOD Indent(void) { return !_to ? NS_ERROR_NULL_POINTER : _to->Indent(); } \
  NS_IMETHOD Outdent(void) { return !_to ? NS_ERROR_NULL_POINTER : _to->Outdent(); } \
  NS_IMETHOD Enter(const char *text) { return !_to ? NS_ERROR_NULL_POINTER : _to->Enter(text); } \
  NS_IMETHOD Leave(const char *text) { return !_to ? NS_ERROR_NULL_POINTER : _to->Leave(text); } \
  NS_IMETHOD StartTimer(const char *timerName) { return !_to ? NS_ERROR_NULL_POINTER : _to->StartTimer(timerName); } \
  NS_IMETHOD StopTimer(const char *timerName) { return !_to ? NS_ERROR_NULL_POINTER : _to->StopTimer(timerName); } \
  NS_IMETHOD MarkTimer(const char *timerName) { return !_to ? NS_ERROR_NULL_POINTER : _to->MarkTimer(timerName); } \
  NS_IMETHOD ResetTimer(const char *timerName) { return !_to ? NS_ERROR_NULL_POINTER : _to->ResetTimer(timerName); } \
  NS_IMETHOD MarkTimerWithComment(const char *timerName, const char *comment) { return !_to ? NS_ERROR_NULL_POINTER : _to->MarkTimerWithComment(timerName, comment); } 
