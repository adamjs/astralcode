/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/xpcom/ds/nsIWindowsRegKey.idl
 */
...
class NS_NO_VTABLE nsIWindowsRegKey : public nsISupports {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IWINDOWSREGKEY_IID)
  ...
  NS_IMETHOD Open(PRUint32 rootKey, const nsAString & relPath, PRUint32 mode) = 0;
  ...
  NS_IMETHOD Create(PRUint32 rootKey, const nsAString & relPath, PRUint32 mode) = 0;
  ...
  NS_IMETHOD OpenChild(const nsAString & relPath, PRUint32 mode, nsIWindowsRegKey **_retval) = 0;
  ...
  NS_IMETHOD CreateChild(const nsAString & relPath, PRUint32 mode, nsIWindowsRegKey **_retval) = 0;

  /**
   * This attribute returns the number of child keys.
   */
  /* readonly attribute unsigned long childCount; */
  NS_IMETHOD GetChildCount(PRUint32 *aChildCount) = 0;
  ...
  NS_IMETHOD GetChildName(PRUint32 index, nsAString & _retval) = 0;
  ...
  NS_IMETHOD HasChild(const nsAString & name, PRBool *_retval) = 0;

  /**
   * This attribute returns the number of values under this key.
   */
  /* readonly attribute unsigned long valueCount; */
  NS_IMETHOD GetValueCount(PRUint32 *aValueCount) = 0;
  ...
  NS_IMETHOD GetValueName(PRUint32 index, nsAString & _retval) = 0;
  ...
  NS_IMETHOD HasValue(const nsAString & name, PRBool *_retval) = 0;
  ...
  NS_IMETHOD GetValueType(const nsAString & name, PRUint32 *_retval) = 0;
  ...
  NS_IMETHOD ReadIntValue(const nsAString & name, PRUint32 *_retval) = 0;
  ...
  NS_IMETHOD ReadInt64Value(const nsAString & name, PRUint64 *_retval) = 0;
  ...
  NS_IMETHOD WriteIntValue(const nsAString & name, PRUint32 data) = 0;
  ...
  NS_IMETHOD WriteInt64Value(const nsAString & name, PRUint64 data) = 0;
  ...
  NS_IMETHOD StartWatching(PRBool recurse) = 0;
   ...
   */
  /* boolean isWatching (); */
  NS_IMETHOD IsWatching(PRBool *_retval) = 0;
   ...
   */
  /* boolean hasChanged (); */
  NS_IMETHOD HasChanged(PRBool *_retval) = 0;
...
#define NS_DECL_NSIWINDOWSREGKEY \
  ...
  NS_IMETHOD Open(PRUint32 rootKey, const nsAString & relPath, PRUint32 mode); \
  NS_IMETHOD Create(PRUint32 rootKey, const nsAString & relPath, PRUint32 mode); \
  NS_IMETHOD OpenChild(const nsAString & relPath, PRUint32 mode, nsIWindowsRegKey **_retval); \
  NS_IMETHOD CreateChild(const nsAString & relPath, PRUint32 mode, nsIWindowsRegKey **_retval); \
  NS_IMETHOD GetChildCount(PRUint32 *aChildCount); \
  NS_IMETHOD GetChildName(PRUint32 index, nsAString & _retval); \
  NS_IMETHOD HasChild(const nsAString & name, PRBool *_retval); \
  NS_IMETHOD GetValueCount(PRUint32 *aValueCount); \
  NS_IMETHOD GetValueName(PRUint32 index, nsAString & _retval); \
  NS_IMETHOD HasValue(const nsAString & name, PRBool *_retval); \
  NS_IMETHOD RemoveChild(const nsAString & relPath); \
  NS_IMETHOD RemoveValue(const nsAString & name); \
  NS_IMETHOD GetValueType(const nsAString & name, PRUint32 *_retval); \
  NS_IMETHOD ReadStringValue(const nsAString & name, nsAString & _retval); \
  NS_IMETHOD ReadIntValue(const nsAString & name, PRUint32 *_retval); \
  NS_IMETHOD ReadInt64Value(const nsAString & name, PRUint64 *_retval); \
  ...
  NS_IMETHOD WriteIntValue(const nsAString & name, PRUint32 data); \
  NS_IMETHOD WriteInt64Value(const nsAString & name, PRUint64 data); \
  NS_IMETHOD WriteBinaryValue(const nsAString & name, const nsACString & data); \
  NS_IMETHOD StartWatching(PRBool recurse); \
  NS_IMETHOD StopWatching(void); \
  NS_IMETHOD IsWatching(PRBool *_retval); \
  NS_IMETHOD HasChanged(PRBool *_retval); 
...
#define NS_FORWARD_NSIWINDOWSREGKEY(_to) \
  ...
  NS_IMETHOD Open(PRUint32 rootKey, const nsAString & relPath, PRUint32 mode) { return _to Open(rootKey, relPath, mode); } \
  NS_IMETHOD Create(PRUint32 rootKey, const nsAString & relPath, PRUint32 mode) { return _to Create(rootKey, relPath, mode); } \
  NS_IMETHOD OpenChild(const nsAString & relPath, PRUint32 mode, nsIWindowsRegKey **_retval) { return _to OpenChild(relPath, mode, _retval); } \
  NS_IMETHOD CreateChild(const nsAString & relPath, PRUint32 mode, nsIWindowsRegKey **_retval) { return _to CreateChild(relPath, mode, _retval); } \
  NS_IMETHOD GetChildCount(PRUint32 *aChildCount) { return _to GetChildCount(aChildCount); } \
  NS_IMETHOD GetChildName(PRUint32 index, nsAString & _retval) { return _to GetChildName(index, _retval); } \
  NS_IMETHOD HasChild(const nsAString & name, PRBool *_retval) { return _to HasChild(name, _retval); } \
  NS_IMETHOD GetValueCount(PRUint32 *aValueCount) { return _to GetValueCount(aValueCount); } \
  NS_IMETHOD GetValueName(PRUint32 index, nsAString & _retval) { return _to GetValueName(index, _retval); } \
  NS_IMETHOD HasValue(const nsAString & name, PRBool *_retval) { return _to HasValue(name, _retval); } \
  ...
  NS_IMETHOD GetValueType(const nsAString & name, PRUint32 *_retval) { return _to GetValueType(name, _retval); } \
  NS_IMETHOD ReadStringValue(const nsAString & name, nsAString & _retval) { return _to ReadStringValue(name, _retval); } \
  NS_IMETHOD ReadIntValue(const nsAString & name, PRUint32 *_retval) { return _to ReadIntValue(name, _retval); } \
  NS_IMETHOD ReadInt64Value(const nsAString & name, PRUint64 *_retval) { return _to ReadInt64Value(name, _retval); } \
  ...
  NS_IMETHOD WriteIntValue(const nsAString & name, PRUint32 data) { return _to WriteIntValue(name, data); } \
  NS_IMETHOD WriteInt64Value(const nsAString & name, PRUint64 data) { return _to WriteInt64Value(name, data); } \
  NS_IMETHOD WriteBinaryValue(const nsAString & name, const nsACString & data) { return _to WriteBinaryValue(name, data); } \
  NS_IMETHOD StartWatching(PRBool recurse) { return _to StartWatching(recurse); } \
  NS_IMETHOD StopWatching(void) { return _to StopWatching(); } \
  NS_IMETHOD IsWatching(PRBool *_retval) { return _to IsWatching(_retval); } \
  NS_IMETHOD HasChanged(PRBool *_retval) { return _to HasChanged(_retval); } 
...
#define NS_FORWARD_SAFE_NSIWINDOWSREGKEY(_to) \
  ...
  NS_IMETHOD Open(PRUint32 rootKey, const nsAString & relPath, PRUint32 mode) { return !_to ? NS_ERROR_NULL_POINTER : _to->Open(rootKey, relPath, mode); } \
  NS_IMETHOD Create(PRUint32 rootKey, const nsAString & relPath, PRUint32 mode) { return !_to ? NS_ERROR_NULL_POINTER : _to->Create(rootKey, relPath, mode); } \
  NS_IMETHOD OpenChild(const nsAString & relPath, PRUint32 mode, nsIWindowsRegKey **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->OpenChild(relPath, mode, _retval); } \
  NS_IMETHOD CreateChild(const nsAString & relPath, PRUint32 mode, nsIWindowsRegKey **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->CreateChild(relPath, mode, _retval); } \
  NS_IMETHOD GetChildCount(PRUint32 *aChildCount) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetChildCount(aChildCount); } \
  NS_IMETHOD GetChildName(PRUint32 index, nsAString & _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetChildName(index, _retval); } \
  NS_IMETHOD HasChild(const nsAString & name, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->HasChild(name, _retval); } \
  NS_IMETHOD GetValueCount(PRUint32 *aValueCount) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetValueCount(aValueCount); } \
  NS_IMETHOD GetValueName(PRUint32 index, nsAString & _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetValueName(index, _retval); } \
  NS_IMETHOD HasValue(const nsAString & name, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->HasValue(name, _retval); } \
  ...
  NS_IMETHOD GetValueType(const nsAString & name, PRUint32 *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetValueType(name, _retval); } \
  ...
  NS_IMETHOD ReadIntValue(const nsAString & name, PRUint32 *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->ReadIntValue(name, _retval); } \
  NS_IMETHOD ReadInt64Value(const nsAString & name, PRUint64 *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->ReadInt64Value(name, _retval); } \
  ...
  NS_IMETHOD WriteIntValue(const nsAString & name, PRUint32 data) { return !_to ? NS_ERROR_NULL_POINTER : _to->WriteIntValue(name, data); } \
  NS_IMETHOD WriteInt64Value(const nsAString & name, PRUint64 data) { return !_to ? NS_ERROR_NULL_POINTER : _to->WriteInt64Value(name, data); } \
  ...
  NS_IMETHOD StartWatching(PRBool recurse) { return !_to ? NS_ERROR_NULL_POINTER : _to->StartWatching(recurse); } \
  NS_IMETHOD StopWatching(void) { return !_to ? NS_ERROR_NULL_POINTER : _to->StopWatching(); } \
  NS_IMETHOD IsWatching(PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsWatching(_retval); } \
  NS_IMETHOD HasChanged(PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->HasChanged(_retval); } 
