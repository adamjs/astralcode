/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/xpcom/base/nsIVersionComparator.idl
 */
...
class NS_NO_VTABLE nsIVersionComparator : public nsISupports {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IVERSIONCOMPARATOR_IID)
  ...
  NS_IMETHOD Compare(const nsACString & A, const nsACString & B, PRInt32 *_retval) = 0;

};

/* Use this macro when declaring classes that implement this interface. */
#define NS_DECL_NSIVERSIONCOMPARATOR \
  NS_IMETHOD Compare(const nsACString & A, const nsACString & B, PRInt32 *_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIVERSIONCOMPARATOR(_to) \
  NS_IMETHOD Compare(const nsACString & A, const nsACString & B, PRInt32 *_retval) { return _to Compare(A, B, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIVERSIONCOMPARATOR(_to) \
  NS_IMETHOD Compare(const nsACString & A, const nsACString & B, PRInt32 *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Compare(A, B, _retval); } 
...
/* long compare (in ACString A, in ACString B); */
NS_IMETHODIMP nsVersionComparator::Compare(const nsACString & A, const nsACString & B, PRInt32 *_retval)
{
