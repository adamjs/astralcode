/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/xpcom/ds/nsISupportsIterators.idl
 */
...
#define NS_FORWARD_NSIINPUTITERATOR(_to) \
  ...
  NS_IMETHOD StepForward(void) { return _to StepForward(); } \
  NS_IMETHOD IsEqualTo(nsISupports *anotherIterator, PRBool *_retval) { return _to IsEqualTo(anotherIterator, _retval); } \
...
#define NS_FORWARD_SAFE_NSIINPUTITERATOR(_to) \
  ...
  NS_IMETHOD StepForward(void) { return !_to ? NS_ERROR_NULL_POINTER : _to->StepForward(); } \
  NS_IMETHOD IsEqualTo(nsISupports *anotherIterator, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsEqualTo(anotherIterator, _retval); } \
...
/* boolean isEqualTo (in nsISupports anotherIterator); */
NS_IMETHODIMP nsInputIterator::IsEqualTo(nsISupports *anotherIterator, PRBool *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* boolean isEqualTo (in nsISupports anotherIterator); */
NS_IMETHODIMP nsForwardIterator::IsEqualTo(nsISupports *anotherIterator, PRBool *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* boolean isEqualTo (in nsISupports anotherIterator); */
NS_IMETHODIMP nsBidirectionalIterator::IsEqualTo(nsISupports *anotherIterator, PRBool *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
#define NS_FORWARD_NSIRANDOMACCESSITERATOR(_to) \
  NS_IMETHOD GetElement(nsISupports **_retval) { return _to GetElement(_retval); } \
  NS_IMETHOD GetElementAt(PRInt32 anOffset, nsISupports **_retval) { return _to GetElementAt(anOffset, _retval); } \
  NS_IMETHOD PutElement(nsISupports *anElementToPut) { return _to PutElement(anElementToPut); } \
...
#define NS_FORWARD_SAFE_NSIRANDOMACCESSITERATOR(_to) \
  NS_IMETHOD GetElement(nsISupports **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetElement(_retval); } \
  NS_IMETHOD GetElementAt(PRInt32 anOffset, nsISupports **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetElementAt(anOffset, _retval); } \
  NS_IMETHOD PutElement(nsISupports *anElementToPut) { return !_to ? NS_ERROR_NULL_POINTER : _to->PutElement(anElementToPut); } \
...
/* nsISupports getElementAt (in PRInt32 anOffset); */
NS_IMETHODIMP nsRandomAccessIterator::GetElementAt(PRInt32 anOffset, nsISupports **_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* boolean isEqualTo (in nsISupports anotherIterator); */
NS_IMETHODIMP nsRandomAccessIterator::IsEqualTo(nsISupports *anotherIterator, PRBool *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
