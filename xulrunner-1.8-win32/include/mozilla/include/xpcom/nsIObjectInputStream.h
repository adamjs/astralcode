/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/xpcom/io/nsIObjectInputStream.idl
 */
...
#define NS_FORWARD_NSIOBJECTINPUTSTREAM(_to) \
  NS_IMETHOD ReadObject(PRBool aIsStrongRef, nsISupports **_retval) { return _to ReadObject(aIsStrongRef, _retval); } \
...
#define NS_FORWARD_SAFE_NSIOBJECTINPUTSTREAM(_to) \
  NS_IMETHOD ReadObject(PRBool aIsStrongRef, nsISupports **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->ReadObject(aIsStrongRef, _retval); } \
...
/* nsISupports readObject (in PRBool aIsStrongRef); */
NS_IMETHODIMP nsObjectInputStream::ReadObject(PRBool aIsStrongRef, nsISupports **_retval)
{
