/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/xpcom/io/nsIUnicharOutputStream.idl
 */
...
class NS_NO_VTABLE nsIUnicharOutputStream : public nsISupports {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IUNICHAROUTPUTSTREAM_IID)
  ...
  NS_IMETHOD Write(PRUint32 aCount, const PRUnichar *c, PRBool *_retval) = 0;
  ...
  NS_IMETHOD WriteString(const nsAString & str, PRBool *_retval) = 0;
...
#define NS_DECL_NSIUNICHAROUTPUTSTREAM \
  NS_IMETHOD Write(PRUint32 aCount, const PRUnichar *c, PRBool *_retval); \
  NS_IMETHOD WriteString(const nsAString & str, PRBool *_retval); \
  NS_IMETHOD Flush(void); \
  NS_IMETHOD Close(void); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIUNICHAROUTPUTSTREAM(_to) \
  NS_IMETHOD Write(PRUint32 aCount, const PRUnichar *c, PRBool *_retval) { return _to Write(aCount, c, _retval); } \
  NS_IMETHOD WriteString(const nsAString & str, PRBool *_retval) { return _to WriteString(str, _retval); } \
  NS_IMETHOD Flush(void) { return _to Flush(); } \
  NS_IMETHOD Close(void) { return _to Close(); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIUNICHAROUTPUTSTREAM(_to) \
  NS_IMETHOD Write(PRUint32 aCount, const PRUnichar *c, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Write(aCount, c, _retval); } \
  NS_IMETHOD WriteString(const nsAString & str, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->WriteString(str, _retval); } \
...
/* boolean write (in unsigned long aCount, [array, size_is (aCount), const] in PRUnichar c); */
NS_IMETHODIMP nsUnicharOutputStream::Write(PRUint32 aCount, const PRUnichar *c, PRBool *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* boolean writeString (in AString str); */
NS_IMETHODIMP nsUnicharOutputStream::WriteString(const nsAString & str, PRBool *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
