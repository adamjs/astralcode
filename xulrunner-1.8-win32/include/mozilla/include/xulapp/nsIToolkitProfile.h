/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/toolkit/profile/public/nsIToolkitProfile.idl
 */
...
class NS_NO_VTABLE nsIProfileLock : public nsISupports {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IPROFILELOCK_IID)

  /**
     * The main profile directory.
     */
  /* readonly attribute nsILocalFile directory; */
  NS_IMETHOD GetDirectory(nsILocalFile * *aDirectory) = 0;
  ...
  NS_IMETHOD GetLocalDirectory(nsILocalFile * *aLocalDirectory) = 0;
...
#define NS_DECL_NSIPROFILELOCK \
  NS_IMETHOD GetDirectory(nsILocalFile * *aDirectory); \
  NS_IMETHOD GetLocalDirectory(nsILocalFile * *aLocalDirectory); \
  NS_IMETHOD Unlock(void); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIPROFILELOCK(_to) \
  NS_IMETHOD GetDirectory(nsILocalFile * *aDirectory) { return _to GetDirectory(aDirectory); } \
  NS_IMETHOD GetLocalDirectory(nsILocalFile * *aLocalDirectory) { return _to GetLocalDirectory(aLocalDirectory); } \
  NS_IMETHOD Unlock(void) { return _to Unlock(); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIPROFILELOCK(_to) \
  NS_IMETHOD GetDirectory(nsILocalFile * *aDirectory) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetDirectory(aDirectory); } \
  NS_IMETHOD GetLocalDirectory(nsILocalFile * *aLocalDirectory) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetLocalDirectory(aLocalDirectory); } \
...
class NS_NO_VTABLE nsIToolkitProfile : public nsISupports {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_ITOOLKITPROFILE_IID)
...
/**
  ...
  NS_IMETHOD GetRootDir(nsILocalFile * *aRootDir) = 0;
  ...
  NS_IMETHOD GetLocalDir(nsILocalFile * *aLocalDir) = 0;
  ...
  NS_IMETHOD Remove(PRBool removeFiles) = 0;
...
#define NS_DECL_NSITOOLKITPROFILE \
  NS_IMETHOD GetRootDir(nsILocalFile * *aRootDir); \
  NS_IMETHOD GetLocalDir(nsILocalFile * *aLocalDir); \
  NS_IMETHOD GetName(nsACString & aName); \
  NS_IMETHOD SetName(const nsACString & aName); \
  NS_IMETHOD Remove(PRBool removeFiles); \
  NS_IMETHOD Lock(nsIProfileUnlocker **aUnlocker, nsIProfileLock **_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSITOOLKITPROFILE(_to) \
  NS_IMETHOD GetRootDir(nsILocalFile * *aRootDir) { return _to GetRootDir(aRootDir); } \
  NS_IMETHOD GetLocalDir(nsILocalFile * *aLocalDir) { return _to GetLocalDir(aLocalDir); } \
  ...
  NS_IMETHOD Remove(PRBool removeFiles) { return _to Remove(removeFiles); } \
...
#define NS_FORWARD_SAFE_NSITOOLKITPROFILE(_to) \
  NS_IMETHOD GetRootDir(nsILocalFile * *aRootDir) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetRootDir(aRootDir); } \
  NS_IMETHOD GetLocalDir(nsILocalFile * *aLocalDir) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetLocalDir(aLocalDir); } \
  ...
  NS_IMETHOD Remove(PRBool removeFiles) { return !_to ? NS_ERROR_NULL_POINTER : _to->Remove(removeFiles); } \
