/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/toolkit/profile/public/nsIProfileMigrator.idl
 */
...
class NS_NO_VTABLE nsIProfileStartup : public nsISupports {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IPROFILESTARTUP_IID)
...
class NS_NO_VTABLE nsIProfileMigrator : public nsISupports {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IPROFILEMIGRATOR_IID)
  ...
  NS_IMETHOD Migrate(nsIProfileStartup *aStartup) = 0;

};

/* Use this macro when declaring classes that implement this interface. */
#define NS_DECL_NSIPROFILEMIGRATOR \
  NS_IMETHOD Import(void); \
  NS_IMETHOD Migrate(nsIProfileStartup *aStartup); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIPROFILEMIGRATOR(_to) \
  NS_IMETHOD Import(void) { return _to Import(); } \
  NS_IMETHOD Migrate(nsIProfileStartup *aStartup) { return _to Migrate(aStartup); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIPROFILEMIGRATOR(_to) \
  NS_IMETHOD Import(void) { return !_to ? NS_ERROR_NULL_POINTER : _to->Import(); } \
  NS_IMETHOD Migrate(nsIProfileStartup *aStartup) { return !_to ? NS_ERROR_NULL_POINTER : _to->Migrate(aStartup); } 
