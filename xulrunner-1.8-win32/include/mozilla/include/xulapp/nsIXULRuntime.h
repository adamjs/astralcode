/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/toolkit/xre/nsIXULRuntime.idl
 */
...
class NS_NO_VTABLE nsIXULRuntime : public nsISupports {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IXULRUNTIME_IID)

  /**
   * Whether the application was launched in safe mode.
   */
  /* readonly attribute boolean inSafeMode; */
  NS_IMETHOD GetInSafeMode(PRBool *aInSafeMode) = 0;
  ...
  NS_IMETHOD GetLogConsoleErrors(PRBool *aLogConsoleErrors) = 0;
  NS_IMETHOD SetLogConsoleErrors(PRBool aLogConsoleErrors) = 0;
...
#define NS_DECL_NSIXULRUNTIME \
  NS_IMETHOD GetInSafeMode(PRBool *aInSafeMode); \
  NS_IMETHOD GetLogConsoleErrors(PRBool *aLogConsoleErrors); \
  NS_IMETHOD SetLogConsoleErrors(PRBool aLogConsoleErrors); \
...
#define NS_FORWARD_NSIXULRUNTIME(_to) \
  NS_IMETHOD GetInSafeMode(PRBool *aInSafeMode) { return _to GetInSafeMode(aInSafeMode); } \
  NS_IMETHOD GetLogConsoleErrors(PRBool *aLogConsoleErrors) { return _to GetLogConsoleErrors(aLogConsoleErrors); } \
  NS_IMETHOD SetLogConsoleErrors(PRBool aLogConsoleErrors) { return _to SetLogConsoleErrors(aLogConsoleErrors); } \
...
#define NS_FORWARD_SAFE_NSIXULRUNTIME(_to) \
  NS_IMETHOD GetInSafeMode(PRBool *aInSafeMode) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetInSafeMode(aInSafeMode); } \
  NS_IMETHOD GetLogConsoleErrors(PRBool *aLogConsoleErrors) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetLogConsoleErrors(aLogConsoleErrors); } \
  NS_IMETHOD SetLogConsoleErrors(PRBool aLogConsoleErrors) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetLogConsoleErrors(aLogConsoleErrors); } \
