/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/layout/xul/base/public/nsIScrollBoxObject.idl
 */
...
class NS_NO_VTABLE nsIScrollBoxObject : public nsISupports {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_ISCROLLBOXOBJECT_IID)
  ...
  NS_IMETHOD ScrollTo(PRInt32 x, PRInt32 y) = 0;
  ...
  NS_IMETHOD ScrollBy(PRInt32 dx, PRInt32 dy) = 0;

  /* void scrollByLine (in long dlines); */
  NS_IMETHOD ScrollByLine(PRInt32 dlines) = 0;

  /* void scrollByIndex (in long dindexes); */
  NS_IMETHOD ScrollByIndex(PRInt32 dindexes) = 0;

  /* void scrollToLine (in long line); */
  NS_IMETHOD ScrollToLine(PRInt32 line) = 0;
  ...
  NS_IMETHOD ScrollToIndex(PRInt32 index) = 0;
  ...
  NS_IMETHOD GetScrolledSize(PRInt32 *width, PRInt32 *height) = 0;
  ...
  NS_IMETHOD EnsureIndexIsVisible(PRInt32 index) = 0;

  /* void ensureLineIsVisible (in long line); */
  NS_IMETHOD EnsureLineIsVisible(PRInt32 line) = 0;

};

/* Use this macro when declaring classes that implement this interface. */
#define NS_DECL_NSISCROLLBOXOBJECT \
  NS_IMETHOD ScrollTo(PRInt32 x, PRInt32 y); \
  NS_IMETHOD ScrollBy(PRInt32 dx, PRInt32 dy); \
  NS_IMETHOD ScrollByLine(PRInt32 dlines); \
  NS_IMETHOD ScrollByIndex(PRInt32 dindexes); \
  NS_IMETHOD ScrollToLine(PRInt32 line); \
  NS_IMETHOD ScrollToElement(nsIDOMElement *child); \
  NS_IMETHOD ScrollToIndex(PRInt32 index); \
  NS_IMETHOD GetPosition(PRInt32 *x, PRInt32 *y); \
  NS_IMETHOD GetScrolledSize(PRInt32 *width, PRInt32 *height); \
  NS_IMETHOD EnsureElementIsVisible(nsIDOMElement *child); \
  NS_IMETHOD EnsureIndexIsVisible(PRInt32 index); \
  NS_IMETHOD EnsureLineIsVisible(PRInt32 line); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSISCROLLBOXOBJECT(_to) \
  NS_IMETHOD ScrollTo(PRInt32 x, PRInt32 y) { return _to ScrollTo(x, y); } \
  NS_IMETHOD ScrollBy(PRInt32 dx, PRInt32 dy) { return _to ScrollBy(dx, dy); } \
  NS_IMETHOD ScrollByLine(PRInt32 dlines) { return _to ScrollByLine(dlines); } \
  NS_IMETHOD ScrollByIndex(PRInt32 dindexes) { return _to ScrollByIndex(dindexes); } \
  NS_IMETHOD ScrollToLine(PRInt32 line) { return _to ScrollToLine(line); } \
  NS_IMETHOD ScrollToElement(nsIDOMElement *child) { return _to ScrollToElement(child); } \
  NS_IMETHOD ScrollToIndex(PRInt32 index) { return _to ScrollToIndex(index); } \
  NS_IMETHOD GetPosition(PRInt32 *x, PRInt32 *y) { return _to GetPosition(x, y); } \
  NS_IMETHOD GetScrolledSize(PRInt32 *width, PRInt32 *height) { return _to GetScrolledSize(width, height); } \
  NS_IMETHOD EnsureElementIsVisible(nsIDOMElement *child) { return _to EnsureElementIsVisible(child); } \
  NS_IMETHOD EnsureIndexIsVisible(PRInt32 index) { return _to EnsureIndexIsVisible(index); } \
  NS_IMETHOD EnsureLineIsVisible(PRInt32 line) { return _to EnsureLineIsVisible(line); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSISCROLLBOXOBJECT(_to) \
  NS_IMETHOD ScrollTo(PRInt32 x, PRInt32 y) { return !_to ? NS_ERROR_NULL_POINTER : _to->ScrollTo(x, y); } \
  NS_IMETHOD ScrollBy(PRInt32 dx, PRInt32 dy) { return !_to ? NS_ERROR_NULL_POINTER : _to->ScrollBy(dx, dy); } \
  NS_IMETHOD ScrollByLine(PRInt32 dlines) { return !_to ? NS_ERROR_NULL_POINTER : _to->ScrollByLine(dlines); } \
  NS_IMETHOD ScrollByIndex(PRInt32 dindexes) { return !_to ? NS_ERROR_NULL_POINTER : _to->ScrollByIndex(dindexes); } \
  NS_IMETHOD ScrollToLine(PRInt32 line) { return !_to ? NS_ERROR_NULL_POINTER : _to->ScrollToLine(line); } \
  NS_IMETHOD ScrollToElement(nsIDOMElement *child) { return !_to ? NS_ERROR_NULL_POINTER : _to->ScrollToElement(child); } \
  NS_IMETHOD ScrollToIndex(PRInt32 index) { return !_to ? NS_ERROR_NULL_POINTER : _to->ScrollToIndex(index); } \
  NS_IMETHOD GetPosition(PRInt32 *x, PRInt32 *y) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetPosition(x, y); } \
  NS_IMETHOD GetScrolledSize(PRInt32 *width, PRInt32 *height) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetScrolledSize(width, height); } \
  NS_IMETHOD EnsureElementIsVisible(nsIDOMElement *child) { return !_to ? NS_ERROR_NULL_POINTER : _to->EnsureElementIsVisible(child); } \
  NS_IMETHOD EnsureIndexIsVisible(PRInt32 index) { return !_to ? NS_ERROR_NULL_POINTER : _to->EnsureIndexIsVisible(index); } \
  NS_IMETHOD EnsureLineIsVisible(PRInt32 line) { return !_to ? NS_ERROR_NULL_POINTER : _to->EnsureLineIsVisible(line); } 
