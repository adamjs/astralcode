/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/layout/xul/base/src/tree/public/nsITreeContentView.idl
 */
...
class NS_NO_VTABLE nsITreeContentView : public nsISupports {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_ITREECONTENTVIEW_IID)
...
/* nsIDOMElement getItemAtIndex (in long index); */
NS_IMETHODIMP nsTreeContentView::GetItemAtIndex(PRInt32 index, nsIDOMElement **_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* long getIndexOfItem (in nsIDOMElement item); */
NS_IMETHODIMP nsTreeContentView::GetIndexOfItem(nsIDOMElement *item, PRInt32 *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
