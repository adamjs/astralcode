/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/modules/libpref/public/nsIRelativeFilePref.idl
 */
...
class NS_NO_VTABLE nsIRelativeFilePref : public nsISupports {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IRELATIVEFILEPREF_IID)
  ...
  NS_IMETHOD SetFile(nsILocalFile * aFile) = 0;
...
#define NS_DECL_NSIRELATIVEFILEPREF \
  ...
  NS_IMETHOD SetFile(nsILocalFile * aFile); \
...
#define NS_FORWARD_NSIRELATIVEFILEPREF(_to) \
  ...
  NS_IMETHOD SetFile(nsILocalFile * aFile) { return _to SetFile(aFile); } \
...
#define NS_FORWARD_SAFE_NSIRELATIVEFILEPREF(_to) \
  ...
  NS_IMETHOD SetFile(nsILocalFile * aFile) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetFile(aFile); } \
