/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/modules/libpref/public/nsIPref.idl
 */
...
class NS_NO_VTABLE nsIPref : public nsISupports {
 public: 
  ...
  NS_IMETHOD SetFilePref(const char *pref, nsIFileSpec *value, PRBool setDefault) = 0;
...
#define NS_FORWARD_NSIPREF(_to) \
  ...
  NS_IMETHOD SetFilePref(const char *pref, nsIFileSpec *value, PRBool setDefault) { return _to SetFilePref(pref, value, setDefault); } \
...
#define NS_FORWARD_SAFE_NSIPREF(_to) \
  ...
  NS_IMETHOD SetFilePref(const char *pref, nsIFileSpec *value, PRBool setDefault) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetFilePref(pref, value, setDefault); } \
...
/* nsIPrefBranch getBranch (in string aPrefRoot); */
NS_IMETHODIMP nsPref::GetBranch(const char *aPrefRoot, nsIPrefBranch **_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* nsIPrefBranch getDefaultBranch (in string aPrefRoot); */
NS_IMETHODIMP nsPref::GetDefaultBranch(const char *aPrefRoot, nsIPrefBranch **_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
