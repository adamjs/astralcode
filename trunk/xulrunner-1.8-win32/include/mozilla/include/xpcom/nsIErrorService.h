/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/xpcom/base/nsIErrorService.idl
 */
...
#define NS_FORWARD_NSIERRORSERVICE(_to) \
  ...
  NS_IMETHOD GetErrorStringBundle(PRInt16 errorModule, char **_retval) { return _to GetErrorStringBundle(errorModule, _retval); } \
...
#define NS_FORWARD_SAFE_NSIERRORSERVICE(_to) \
  ...
  NS_IMETHOD GetErrorStringBundle(PRInt16 errorModule, char **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetErrorStringBundle(errorModule, _retval); } \
...
/* string getErrorStringBundle (in short errorModule); */
NS_IMETHODIMP nsErrorService::GetErrorStringBundle(PRInt16 errorModule, char **_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
