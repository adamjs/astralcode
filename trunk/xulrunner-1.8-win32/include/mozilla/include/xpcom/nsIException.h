/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/xpcom/base/nsIException.idl
 */
...
/* string toString (); */
NS_IMETHODIMP nsStackFrame::ToString(char **_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* string toString (); */
NS_IMETHODIMP nsException::ToString(char **_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
