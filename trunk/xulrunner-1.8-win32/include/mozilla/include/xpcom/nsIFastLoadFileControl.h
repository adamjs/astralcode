/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/xpcom/io/nsIFastLoadFileControl.idl
 */
 ...
 */
class NS_NO_VTABLE nsIFastLoadFileControl : public nsISupports {
 public: 

  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IFASTLOADFILECONTROL_IID)

  /**
     * Get and set the recorded checksum value from the FastLoad file header.
     */
  /* attribute PRUint32 checksum; */
  NS_IMETHOD GetChecksum(PRUint32 *aChecksum) = 0;
  NS_IMETHOD SetChecksum(PRUint32 aChecksum) = 0;
  ...
  NS_IMETHOD StartMuxedDocument(nsISupports *aURI, const char *aURISpec) = 0;
...
#define NS_DECL_NSIFASTLOADFILECONTROL \
  NS_IMETHOD GetChecksum(PRUint32 *aChecksum); \
  NS_IMETHOD SetChecksum(PRUint32 aChecksum); \
  NS_IMETHOD StartMuxedDocument(nsISupports *aURI, const char *aURISpec); \
...
#define NS_FORWARD_NSIFASTLOADFILECONTROL(_to) \
  NS_IMETHOD GetChecksum(PRUint32 *aChecksum) { return _to GetChecksum(aChecksum); } \
  NS_IMETHOD SetChecksum(PRUint32 aChecksum) { return _to SetChecksum(aChecksum); } \
  NS_IMETHOD StartMuxedDocument(nsISupports *aURI, const char *aURISpec) { return _to StartMuxedDocument(aURI, aURISpec); } \
...
#define NS_FORWARD_SAFE_NSIFASTLOADFILECONTROL(_to) \
  NS_IMETHOD GetChecksum(PRUint32 *aChecksum) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetChecksum(aChecksum); } \
  NS_IMETHOD SetChecksum(PRUint32 aChecksum) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetChecksum(aChecksum); } \
  NS_IMETHOD StartMuxedDocument(nsISupports *aURI, const char *aURISpec) { return !_to ? NS_ERROR_NULL_POINTER : _to->StartMuxedDocument(aURI, aURISpec); } \
...
/* nsISupports selectMuxedDocument (in nsISupports aURI); */
NS_IMETHODIMP nsFastLoadFileControl::SelectMuxedDocument(nsISupports *aURI, nsISupports **_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* boolean hasMuxedDocument (in string aURISpec); */
NS_IMETHODIMP nsFastLoadFileControl::HasMuxedDocument(const char *aURISpec, PRBool *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
class NS_NO_VTABLE nsIFastLoadReadControl : public nsIFastLoadFileControl {
 public: 

  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IFASTLOADREADCONTROL_IID)
  ...
  NS_IMETHOD ComputeChecksum(PRUint32 *_retval) = 0;
  ...
  NS_IMETHOD GetDependencies(nsISimpleEnumerator * *aDependencies) = 0;

};

/* Use this macro when declaring classes that implement this interface. */
#define NS_DECL_NSIFASTLOADREADCONTROL \
  NS_IMETHOD ComputeChecksum(PRUint32 *_retval); \
  NS_IMETHOD GetDependencies(nsISimpleEnumerator * *aDependencies); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIFASTLOADREADCONTROL(_to) \
  NS_IMETHOD ComputeChecksum(PRUint32 *_retval) { return _to ComputeChecksum(_retval); } \
  NS_IMETHOD GetDependencies(nsISimpleEnumerator * *aDependencies) { return _to GetDependencies(aDependencies); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIFASTLOADREADCONTROL(_to) \
  NS_IMETHOD ComputeChecksum(PRUint32 *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->ComputeChecksum(_retval); } \
  NS_IMETHOD GetDependencies(nsISimpleEnumerator * *aDependencies) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetDependencies(aDependencies); } 
...
/* PRUint32 computeChecksum (); */
NS_IMETHODIMP nsFastLoadReadControl::ComputeChecksum(PRUint32 *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
class NS_NO_VTABLE nsIFastLoadWriteControl : public nsIFastLoadFileControl {
 public: 

  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IFASTLOADWRITECONTROL_IID)
