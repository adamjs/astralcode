/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/xpcom/io/nsIMultiplexInputStream.idl
 */
...
class NS_NO_VTABLE nsIMultiplexInputStream : public nsIInputStream {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IMULTIPLEXINPUTSTREAM_IID)
  ...
  NS_IMETHOD InsertStream(nsIInputStream *stream, PRUint32 index) = 0;
  ...
  NS_IMETHOD RemoveStream(PRUint32 index) = 0;
  ...
  NS_IMETHOD GetStream(PRUint32 index, nsIInputStream **_retval) = 0;
...
#define NS_DECL_NSIMULTIPLEXINPUTSTREAM \
  ...
  NS_IMETHOD InsertStream(nsIInputStream *stream, PRUint32 index); \
  NS_IMETHOD RemoveStream(PRUint32 index); \
  NS_IMETHOD GetStream(PRUint32 index, nsIInputStream **_retval); 
...
#define NS_FORWARD_NSIMULTIPLEXINPUTSTREAM(_to) \
  ...
  NS_IMETHOD InsertStream(nsIInputStream *stream, PRUint32 index) { return _to InsertStream(stream, index); } \
  NS_IMETHOD RemoveStream(PRUint32 index) { return _to RemoveStream(index); } \
  NS_IMETHOD GetStream(PRUint32 index, nsIInputStream **_retval) { return _to GetStream(index, _retval); } 
...
#define NS_FORWARD_SAFE_NSIMULTIPLEXINPUTSTREAM(_to) \
  ...
  NS_IMETHOD InsertStream(nsIInputStream *stream, PRUint32 index) { return !_to ? NS_ERROR_NULL_POINTER : _to->InsertStream(stream, index); } \
  NS_IMETHOD RemoveStream(PRUint32 index) { return !_to ? NS_ERROR_NULL_POINTER : _to->RemoveStream(index); } \
  NS_IMETHOD GetStream(PRUint32 index, nsIInputStream **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetStream(index, _retval); } 
...
/* nsIInputStream getStream (in unsigned long index); */
NS_IMETHODIMP nsMultiplexInputStream::GetStream(PRUint32 index, nsIInputStream **_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
