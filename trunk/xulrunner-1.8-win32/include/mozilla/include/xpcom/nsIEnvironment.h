/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/xpcom/threads/nsIEnvironment.idl
 */
...
class NS_NO_VTABLE nsIEnvironment : public nsISupports {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IENVIRONMENT_IID)
  ...
  NS_IMETHOD Exists(const nsAString & aName, PRBool *_retval) = 0;
...
#define NS_DECL_NSIENVIRONMENT \
  ...
  NS_IMETHOD Exists(const nsAString & aName, PRBool *_retval); 
...
#define NS_FORWARD_NSIENVIRONMENT(_to) \
  ...
  NS_IMETHOD Exists(const nsAString & aName, PRBool *_retval) { return _to Exists(aName, _retval); } 
...
#define NS_FORWARD_SAFE_NSIENVIRONMENT(_to) \
  ...
  NS_IMETHOD Exists(const nsAString & aName, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Exists(aName, _retval); } 
...
/* boolean exists (in AString aName); */
NS_IMETHODIMP nsEnvironment::Exists(const nsAString & aName, PRBool *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
