/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/xpcom/ds/nsIRecyclingAllocator.idl
 */
 ...
 */
class NS_NO_VTABLE nsIRecyclingAllocator : public nsIMemory {
 public: 

  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IRECYCLINGALLOCATOR_IID)

  /* void init (in size_t nblocks, in size_t recycleAfter, in string id); */
  NS_IMETHOD Init(size_t nblocks, size_t recycleAfter, const char *id) = 0;

};

/* Use this macro when declaring classes that implement this interface. */
#define NS_DECL_NSIRECYCLINGALLOCATOR \
  NS_IMETHOD Init(size_t nblocks, size_t recycleAfter, const char *id); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIRECYCLINGALLOCATOR(_to) \
  NS_IMETHOD Init(size_t nblocks, size_t recycleAfter, const char *id) { return _to Init(nblocks, recycleAfter, id); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIRECYCLINGALLOCATOR(_to) \
  NS_IMETHOD Init(size_t nblocks, size_t recycleAfter, const char *id) { return !_to ? NS_ERROR_NULL_POINTER : _to->Init(nblocks, recycleAfter, id); } 
