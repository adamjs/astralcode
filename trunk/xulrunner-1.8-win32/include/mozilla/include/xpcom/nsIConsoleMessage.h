/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/xpcom/base/nsIConsoleMessage.idl
 */
...
class NS_NO_VTABLE nsIConsoleMessage : public nsISupports {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_ICONSOLEMESSAGE_IID)
...
/* readonly attribute wstring message; */
NS_IMETHODIMP nsConsoleMessage::GetMessage(PRUnichar * *aMessage)
{
