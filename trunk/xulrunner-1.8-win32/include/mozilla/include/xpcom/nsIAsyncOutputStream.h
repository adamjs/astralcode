/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/xpcom/io/nsIAsyncOutputStream.idl
 */
...
#define NS_IASYNCOUTPUTSTREAM_IID_STR "10dc9c94-8aff-49c6-8af9-d7fdb7339dae"

#define NS_IASYNCOUTPUTSTREAM_IID \
  {0x10dc9c94, 0x8aff, 0x49c6, \
    { 0x8a, 0xf9, 0xd7, 0xfd, 0xb7, 0x33, 0x9d, 0xae }}
...
class NS_NO_VTABLE nsIAsyncOutputStream : public nsIOutputStream {
 public: 
  ...
  NS_IMETHOD AsyncWait(nsIOutputStreamCallback *aCallback, PRUint32 aFlags, PRUint32 aRequestedCount, nsIEventTarget *aEventTarget) = 0;
...
#define NS_DECL_NSIASYNCOUTPUTSTREAM \
  ...
  NS_IMETHOD AsyncWait(nsIOutputStreamCallback *aCallback, PRUint32 aFlags, PRUint32 aRequestedCount, nsIEventTarget *aEventTarget); \
...
#define NS_FORWARD_NSIASYNCOUTPUTSTREAM(_to) \
  ...
  NS_IMETHOD AsyncWait(nsIOutputStreamCallback *aCallback, PRUint32 aFlags, PRUint32 aRequestedCount, nsIEventTarget *aEventTarget) { return _to AsyncWait(aCallback, aFlags, aRequestedCount, aEventTarget); } \
...
#define NS_FORWARD_SAFE_NSIASYNCOUTPUTSTREAM(_to) \
  ...
  NS_IMETHOD AsyncWait(nsIOutputStreamCallback *aCallback, PRUint32 aFlags, PRUint32 aRequestedCount, nsIEventTarget *aEventTarget) { return !_to ? NS_ERROR_NULL_POINTER : _to->AsyncWait(aCallback, aFlags, aRequestedCount, aEventTarget); } \
...
class NS_NO_VTABLE nsIOutputStreamCallback : public nsISupports {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IOUTPUTSTREAMCALLBACK_IID)
