/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/xpcom/io/nsISeekableStream.idl
 */
...
class NS_NO_VTABLE nsISeekableStream : public nsISupports {
 public: 
  ...
  NS_IMETHOD Seek(PRInt32 whence, PRInt64 offset) = 0;
  ...
  /**
     ...
     */
  /* long long tell (); */
  NS_IMETHOD Tell(PRInt64 *_retval) = 0;
...
#define NS_DECL_NSISEEKABLESTREAM \
  NS_IMETHOD Seek(PRInt32 whence, PRInt64 offset); \
  NS_IMETHOD Tell(PRInt64 *_retval); \
  NS_IMETHOD SetEOF(void); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSISEEKABLESTREAM(_to) \
  NS_IMETHOD Seek(PRInt32 whence, PRInt64 offset) { return _to Seek(whence, offset); } \
  NS_IMETHOD Tell(PRInt64 *_retval) { return _to Tell(_retval); } \
  NS_IMETHOD SetEOF(void) { return _to SetEOF(); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSISEEKABLESTREAM(_to) \
  NS_IMETHOD Seek(PRInt32 whence, PRInt64 offset) { return !_to ? NS_ERROR_NULL_POINTER : _to->Seek(whence, offset); } \
  NS_IMETHOD Tell(PRInt64 *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Tell(_retval); } \
...
/* long long tell (); */
NS_IMETHODIMP nsSeekableStream::Tell(PRInt64 *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
