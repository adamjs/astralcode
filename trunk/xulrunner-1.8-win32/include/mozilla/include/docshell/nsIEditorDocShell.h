/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/docshell/base/nsIEditorDocShell.idl
 */
 ...
 * from out side.
 */
class NS_NO_VTABLE nsIEditorDocShell : public nsISupports {
 public: 

  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IEDITORDOCSHELL_IID)
  ...
  NS_IMETHOD GetHasEditingSession(PRBool *aHasEditingSession) = 0;
  ...
  NS_IMETHOD MakeEditable(PRBool inWaitForUriLoad) = 0;
...
#define NS_DECL_NSIEDITORDOCSHELL \
  ...
  NS_IMETHOD GetHasEditingSession(PRBool *aHasEditingSession); \
  NS_IMETHOD MakeEditable(PRBool inWaitForUriLoad); 
...
#define NS_FORWARD_NSIEDITORDOCSHELL(_to) \
  ...
  NS_IMETHOD GetHasEditingSession(PRBool *aHasEditingSession) { return _to GetHasEditingSession(aHasEditingSession); } \
  NS_IMETHOD MakeEditable(PRBool inWaitForUriLoad) { return _to MakeEditable(inWaitForUriLoad); } 
...
#define NS_FORWARD_SAFE_NSIEDITORDOCSHELL(_to) \
  ...
  NS_IMETHOD GetHasEditingSession(PRBool *aHasEditingSession) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetHasEditingSession(aHasEditingSession); } \
  NS_IMETHOD MakeEditable(PRBool inWaitForUriLoad) { return !_to ? NS_ERROR_NULL_POINTER : _to->MakeEditable(inWaitForUriLoad); } 
