/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/docshell/base/nsIWebNavigationInfo.idl
 */
...
class NS_NO_VTABLE nsIWebNavigationInfo : public nsISupports {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IWEBNAVIGATIONINFO_IID)
...
/**
  ...
  NS_IMETHOD IsTypeSupported(const nsACString & aType, nsIWebNavigation *aWebNav, PRUint32 *_retval) = 0;

};

/* Use this macro when declaring classes that implement this interface. */
#define NS_DECL_NSIWEBNAVIGATIONINFO \
  NS_IMETHOD IsTypeSupported(const nsACString & aType, nsIWebNavigation *aWebNav, PRUint32 *_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIWEBNAVIGATIONINFO(_to) \
  NS_IMETHOD IsTypeSupported(const nsACString & aType, nsIWebNavigation *aWebNav, PRUint32 *_retval) { return _to IsTypeSupported(aType, aWebNav, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIWEBNAVIGATIONINFO(_to) \
  NS_IMETHOD IsTypeSupported(const nsACString & aType, nsIWebNavigation *aWebNav, PRUint32 *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsTypeSupported(aType, aWebNav, _retval); } 
...
/* unsigned long isTypeSupported (in ACString aType, in nsIWebNavigation aWebNav); */
NS_IMETHODIMP nsWebNavigationInfo::IsTypeSupported(const nsACString & aType, nsIWebNavigation *aWebNav, PRUint32 *_retval)
{
