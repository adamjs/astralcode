/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/docshell/base/nsIScrollable.idl
 */
...
class NS_NO_VTABLE nsIScrollable : public nsISupports {
 public: 
  ...
  NS_IMETHOD GetCurScrollPos(PRInt32 scrollOrientation, PRInt32 *_retval) = 0;
  ...
  NS_IMETHOD GetDefaultScrollbarPreferences(PRInt32 scrollOrientation, PRInt32 *_retval) = 0;
...
#define NS_DECL_NSISCROLLABLE \
  NS_IMETHOD GetCurScrollPos(PRInt32 scrollOrientation, PRInt32 *_retval); \
  ...
  NS_IMETHOD GetDefaultScrollbarPreferences(PRInt32 scrollOrientation, PRInt32 *_retval); \
...
#define NS_FORWARD_NSISCROLLABLE(_to) \
  NS_IMETHOD GetCurScrollPos(PRInt32 scrollOrientation, PRInt32 *_retval) { return _to GetCurScrollPos(scrollOrientation, _retval); } \
  ...
  NS_IMETHOD GetDefaultScrollbarPreferences(PRInt32 scrollOrientation, PRInt32 *_retval) { return _to GetDefaultScrollbarPreferences(scrollOrientation, _retval); } \
...
#define NS_FORWARD_SAFE_NSISCROLLABLE(_to) \
  NS_IMETHOD GetCurScrollPos(PRInt32 scrollOrientation, PRInt32 *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetCurScrollPos(scrollOrientation, _retval); } \
  ...
  NS_IMETHOD GetDefaultScrollbarPreferences(PRInt32 scrollOrientation, PRInt32 *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetDefaultScrollbarPreferences(scrollOrientation, _retval); } \
...
/* long getCurScrollPos (in long scrollOrientation); */
NS_IMETHODIMP nsScrollable::GetCurScrollPos(PRInt32 scrollOrientation, PRInt32 *_retval)
{
...
/* long getDefaultScrollbarPreferences (in long scrollOrientation); */
NS_IMETHODIMP nsScrollable::GetDefaultScrollbarPreferences(PRInt32 scrollOrientation, PRInt32 *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
