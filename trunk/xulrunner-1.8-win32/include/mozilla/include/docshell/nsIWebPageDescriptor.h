/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/docshell/base/nsIWebPageDescriptor.idl
 */
...
class NS_NO_VTABLE nsIWebPageDescriptor : public nsISupports {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IWEBPAGEDESCRIPTOR_IID)
  ...
  */
  ...
  NS_IMETHOD LoadPage(nsISupports *aPageDescriptor, PRUint32 aDisplayType) = 0;
...
#define NS_DECL_NSIWEBPAGEDESCRIPTOR \
  NS_IMETHOD LoadPage(nsISupports *aPageDescriptor, PRUint32 aDisplayType); \
...
#define NS_FORWARD_NSIWEBPAGEDESCRIPTOR(_to) \
  NS_IMETHOD LoadPage(nsISupports *aPageDescriptor, PRUint32 aDisplayType) { return _to LoadPage(aPageDescriptor, aDisplayType); } \
...
#define NS_FORWARD_SAFE_NSIWEBPAGEDESCRIPTOR(_to) \
  NS_IMETHOD LoadPage(nsISupports *aPageDescriptor, PRUint32 aDisplayType) { return !_to ? NS_ERROR_NULL_POINTER : _to->LoadPage(aPageDescriptor, aDisplayType); } \
