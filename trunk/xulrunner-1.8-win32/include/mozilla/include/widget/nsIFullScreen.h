/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/widget/public/nsIFullScreen.idl
 */
...
class NS_NO_VTABLE nsIFullScreen : public nsISupports {
 public: 

  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IFULLSCREEN_IID)

  /**
   * Hide all registered OS chrome components
   */
  /* void hideAllOSChrome (); */
  NS_IMETHOD HideAllOSChrome(void) = 0;

  /**
   * Show all registered OS chrome components
   */
  /* void showAllOSChrome (); */
  NS_IMETHOD ShowAllOSChrome(void) = 0;

  /**
   * Return an enumerator of all registered OS chrome components
   */
  /* nsISimpleEnumerator getChromeItems (); */
  NS_IMETHOD GetChromeItems(nsISimpleEnumerator **_retval) = 0;

};

/* Use this macro when declaring classes that implement this interface. */
#define NS_DECL_NSIFULLSCREEN \
  NS_IMETHOD HideAllOSChrome(void); \
  NS_IMETHOD ShowAllOSChrome(void); \
  NS_IMETHOD GetChromeItems(nsISimpleEnumerator **_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIFULLSCREEN(_to) \
  NS_IMETHOD HideAllOSChrome(void) { return _to HideAllOSChrome(); } \
  NS_IMETHOD ShowAllOSChrome(void) { return _to ShowAllOSChrome(); } \
  NS_IMETHOD GetChromeItems(nsISimpleEnumerator **_retval) { return _to GetChromeItems(_retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIFULLSCREEN(_to) \
  NS_IMETHOD HideAllOSChrome(void) { return !_to ? NS_ERROR_NULL_POINTER : _to->HideAllOSChrome(); } \
  NS_IMETHOD ShowAllOSChrome(void) { return !_to ? NS_ERROR_NULL_POINTER : _to->ShowAllOSChrome(); } \
  NS_IMETHOD GetChromeItems(nsISimpleEnumerator **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetChromeItems(_retval); } 
...
/* nsISimpleEnumerator getChromeItems (); */
NS_IMETHODIMP nsFullScreen::GetChromeItems(nsISimpleEnumerator **_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
class NS_NO_VTABLE nsIOSChromeItem : public nsISupports {
 public: 

  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IOSCHROMEITEM_IID)
