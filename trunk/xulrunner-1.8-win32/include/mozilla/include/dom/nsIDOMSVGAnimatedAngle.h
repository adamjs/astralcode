/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/dom/public/idl/svg/nsIDOMSVGAnimatedAngle.idl
 */
 ...
 *
 */
class NS_NO_VTABLE nsIDOMSVGAnimatedAngle : public nsISupports {
 public: 

  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IDOMSVGANIMATEDANGLE_IID)

  /* readonly attribute nsIDOMSVGAngle baseVal; */
  NS_IMETHOD GetBaseVal(nsIDOMSVGAngle * *aBaseVal) = 0;

  /* readonly attribute nsIDOMSVGAngle animVal; */
  NS_IMETHOD GetAnimVal(nsIDOMSVGAngle * *aAnimVal) = 0;
...
#define NS_FORWARD_NSIDOMSVGANIMATEDANGLE(_to) \
  NS_IMETHOD GetBaseVal(nsIDOMSVGAngle * *aBaseVal) { return _to GetBaseVal(aBaseVal); } \
  NS_IMETHOD GetAnimVal(nsIDOMSVGAngle * *aAnimVal) { return _to GetAnimVal(aAnimVal); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDOMSVGANIMATEDANGLE(_to) \
  NS_IMETHOD GetBaseVal(nsIDOMSVGAngle * *aBaseVal) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetBaseVal(aBaseVal); } \
  NS_IMETHOD GetAnimVal(nsIDOMSVGAngle * *aAnimVal) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetAnimVal(aAnimVal); } 
