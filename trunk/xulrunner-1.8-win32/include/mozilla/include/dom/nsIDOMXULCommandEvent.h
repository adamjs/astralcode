/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/dom/public/idl/xul/nsIDOMXULCommandEvent.idl
 */
...
class NS_NO_VTABLE nsIDOMXULCommandEvent : public nsIDOMUIEvent {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IDOMXULCOMMANDEVENT_IID)
  ...
  NS_IMETHOD InitCommandEvent(const nsAString & typeArg, PRBool canBubbleArg, PRBool cancelableArg, nsIDOMAbstractView *viewArg, PRInt32 detailArg, PRBool ctrlKeyArg, PRBool altKeyArg, PRBool shiftKeyArg, PRBool metaKeyArg, nsIDOMEvent *sourceEvent) = 0;
...
#define NS_DECL_NSIDOMXULCOMMANDEVENT \
  ...
  NS_IMETHOD InitCommandEvent(const nsAString & typeArg, PRBool canBubbleArg, PRBool cancelableArg, nsIDOMAbstractView *viewArg, PRInt32 detailArg, PRBool ctrlKeyArg, PRBool altKeyArg, PRBool shiftKeyArg, PRBool metaKeyArg, nsIDOMEvent *sourceEvent); 
