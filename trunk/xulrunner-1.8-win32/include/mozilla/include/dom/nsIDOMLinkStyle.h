/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/dom/public/idl/stylesheets/nsIDOMLinkStyle.idl
 */
...
#define NS_FORWARD_SAFE_NSIDOMLINKSTYLE(_to) \
  NS_IMETHOD GetSheet(nsIDOMStyleSheet * *aSheet) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetSheet(aSheet); } 
