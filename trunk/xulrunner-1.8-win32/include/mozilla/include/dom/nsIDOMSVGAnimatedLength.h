/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/dom/public/idl/svg/nsIDOMSVGAnimatedLength.idl
 */
...
class NS_NO_VTABLE nsIDOMSVGAnimatedLength : public nsISupports {
 public: 

  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IDOMSVGANIMATEDLENGTH_IID)

  /* readonly attribute nsIDOMSVGLength baseVal; */
  NS_IMETHOD GetBaseVal(nsIDOMSVGLength * *aBaseVal) = 0;

  /* readonly attribute nsIDOMSVGLength animVal; */
  NS_IMETHOD GetAnimVal(nsIDOMSVGLength * *aAnimVal) = 0;
...
#define NS_FORWARD_NSIDOMSVGANIMATEDLENGTH(_to) \
  NS_IMETHOD GetBaseVal(nsIDOMSVGLength * *aBaseVal) { return _to GetBaseVal(aBaseVal); } \
  NS_IMETHOD GetAnimVal(nsIDOMSVGLength * *aAnimVal) { return _to GetAnimVal(aAnimVal); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDOMSVGANIMATEDLENGTH(_to) \
  NS_IMETHOD GetBaseVal(nsIDOMSVGLength * *aBaseVal) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetBaseVal(aBaseVal); } \
  NS_IMETHOD GetAnimVal(nsIDOMSVGLength * *aAnimVal) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetAnimVal(aAnimVal); } 
