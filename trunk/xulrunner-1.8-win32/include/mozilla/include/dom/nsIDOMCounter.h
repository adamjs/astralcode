/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/dom/public/idl/css/nsIDOMCounter.idl
 */
...
#define NS_DECL_NSIDOMCOUNTER \
  ...
  NS_IMETHOD GetSeparator(nsAString & aSeparator); 
...
#define NS_FORWARD_NSIDOMCOUNTER(_to) \
  ...
  NS_IMETHOD GetSeparator(nsAString & aSeparator) { return _to GetSeparator(aSeparator); } 
...
#define NS_FORWARD_SAFE_NSIDOMCOUNTER(_to) \
  ...
  NS_IMETHOD GetSeparator(nsAString & aSeparator) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetSeparator(aSeparator); } 
