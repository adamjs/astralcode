/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/dom/public/idl/css/nsIDOMCSSCharsetRule.idl
 */
...
class NS_NO_VTABLE nsIDOMCSSCharsetRule : public nsIDOMCSSRule {
 public: 

  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IDOMCSSCHARSETRULE_IID)
