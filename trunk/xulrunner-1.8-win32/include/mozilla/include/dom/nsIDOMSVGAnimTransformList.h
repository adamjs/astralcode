/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/dom/public/idl/svg/nsIDOMSVGAnimTransformList.idl
 */
...
class NS_NO_VTABLE nsIDOMSVGAnimatedTransformList : public nsISupports {
 public: 

  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IDOMSVGANIMATEDTRANSFORMLIST_IID)

  /* readonly attribute nsIDOMSVGTransformList baseVal; */
  NS_IMETHOD GetBaseVal(nsIDOMSVGTransformList * *aBaseVal) = 0;

  /* readonly attribute nsIDOMSVGTransformList animVal; */
  NS_IMETHOD GetAnimVal(nsIDOMSVGTransformList * *aAnimVal) = 0;

};

/* Use this macro when declaring classes that implement this interface. */
#define NS_DECL_NSIDOMSVGANIMATEDTRANSFORMLIST \
  NS_IMETHOD GetBaseVal(nsIDOMSVGTransformList * *aBaseVal); \
  NS_IMETHOD GetAnimVal(nsIDOMSVGTransformList * *aAnimVal); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDOMSVGANIMATEDTRANSFORMLIST(_to) \
  NS_IMETHOD GetBaseVal(nsIDOMSVGTransformList * *aBaseVal) { return _to GetBaseVal(aBaseVal); } \
  NS_IMETHOD GetAnimVal(nsIDOMSVGTransformList * *aAnimVal) { return _to GetAnimVal(aAnimVal); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDOMSVGANIMATEDTRANSFORMLIST(_to) \
  NS_IMETHOD GetBaseVal(nsIDOMSVGTransformList * *aBaseVal) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetBaseVal(aBaseVal); } \
  NS_IMETHOD GetAnimVal(nsIDOMSVGTransformList * *aAnimVal) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetAnimVal(aAnimVal); } 
