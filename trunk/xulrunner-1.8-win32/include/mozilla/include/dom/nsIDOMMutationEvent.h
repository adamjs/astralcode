/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/dom/public/idl/events/nsIDOMMutationEvent.idl
 */
...
class NS_NO_VTABLE nsIDOMMutationEvent : public nsIDOMEvent {
 public: 
  ...
  NS_IMETHOD InitMutationEvent(const nsAString & typeArg, PRBool canBubbleArg, PRBool cancelableArg, nsIDOMNode *relatedNodeArg, const nsAString & prevValueArg, const nsAString & newValueArg, const nsAString & attrNameArg, PRUint16 attrChangeArg) = 0;
...
#define NS_DECL_NSIDOMMUTATIONEVENT \
  ...
  NS_IMETHOD InitMutationEvent(const nsAString & typeArg, PRBool canBubbleArg, PRBool cancelableArg, nsIDOMNode *relatedNodeArg, const nsAString & prevValueArg, const nsAString & newValueArg, const nsAString & attrNameArg, PRUint16 attrChangeArg); 
...
#define NS_FORWARD_SAFE_NSIDOMMUTATIONEVENT(_to) \
  ...
  NS_IMETHOD GetAttrChange(PRUint16 *aAttrChange) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetAttrChange(aAttrChange); } \
