/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/dom/public/idl/xul/nsIDOMXULButtonElement.idl
 */
...
class NS_NO_VTABLE nsIDOMXULButtonElement : public nsIDOMXULLabeledControlElement {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IDOMXULBUTTONELEMENT_IID)
  ...
  NS_IMETHOD GetOpen(PRBool *aOpen) = 0;
  NS_IMETHOD SetOpen(PRBool aOpen) = 0;
  ...
  NS_IMETHOD GetCheckState(PRInt32 *aCheckState) = 0;
  NS_IMETHOD SetCheckState(PRInt32 aCheckState) = 0;

  /* attribute boolean autoCheck; */
  NS_IMETHOD GetAutoCheck(PRBool *aAutoCheck) = 0;
  NS_IMETHOD SetAutoCheck(PRBool aAutoCheck) = 0;
...
#define NS_DECL_NSIDOMXULBUTTONELEMENT \
  ...
  NS_IMETHOD GetOpen(PRBool *aOpen); \
  NS_IMETHOD SetOpen(PRBool aOpen); \
  NS_IMETHOD GetChecked(PRBool *aChecked); \
  NS_IMETHOD SetChecked(PRBool aChecked); \
  NS_IMETHOD GetCheckState(PRInt32 *aCheckState); \
  NS_IMETHOD SetCheckState(PRInt32 aCheckState); \
  NS_IMETHOD GetAutoCheck(PRBool *aAutoCheck); \
  NS_IMETHOD SetAutoCheck(PRBool aAutoCheck); \
...
#define NS_FORWARD_NSIDOMXULBUTTONELEMENT(_to) \
  ...
  NS_IMETHOD GetOpen(PRBool *aOpen) { return _to GetOpen(aOpen); } \
  NS_IMETHOD SetOpen(PRBool aOpen) { return _to SetOpen(aOpen); } \
  ...
  NS_IMETHOD GetCheckState(PRInt32 *aCheckState) { return _to GetCheckState(aCheckState); } \
  NS_IMETHOD SetCheckState(PRInt32 aCheckState) { return _to SetCheckState(aCheckState); } \
  NS_IMETHOD GetAutoCheck(PRBool *aAutoCheck) { return _to GetAutoCheck(aAutoCheck); } \
  NS_IMETHOD SetAutoCheck(PRBool aAutoCheck) { return _to SetAutoCheck(aAutoCheck); } \
...
#define NS_FORWARD_SAFE_NSIDOMXULBUTTONELEMENT(_to) \
  ...
  NS_IMETHOD GetOpen(PRBool *aOpen) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetOpen(aOpen); } \
  NS_IMETHOD SetOpen(PRBool aOpen) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetOpen(aOpen); } \
  ...
  NS_IMETHOD GetCheckState(PRInt32 *aCheckState) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetCheckState(aCheckState); } \
  NS_IMETHOD SetCheckState(PRInt32 aCheckState) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetCheckState(aCheckState); } \
  NS_IMETHOD GetAutoCheck(PRBool *aAutoCheck) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetAutoCheck(aAutoCheck); } \
  NS_IMETHOD SetAutoCheck(PRBool aAutoCheck) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetAutoCheck(aAutoCheck); } \
