/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/dom/public/idl/base/nsIDOMCRMFObject.idl
 */
...
class NS_NO_VTABLE nsIDOMCRMFObject : public nsISupports {
 public: 
  ...
  NS_IMETHOD GetRequest(nsAString & aRequest) = 0;

};

/* Use this macro when declaring classes that implement this interface. */
#define NS_DECL_NSIDOMCRMFOBJECT \
  NS_IMETHOD GetRequest(nsAString & aRequest); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDOMCRMFOBJECT(_to) \
  NS_IMETHOD GetRequest(nsAString & aRequest) { return _to GetRequest(aRequest); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDOMCRMFOBJECT(_to) \
  NS_IMETHOD GetRequest(nsAString & aRequest) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetRequest(aRequest); } 
