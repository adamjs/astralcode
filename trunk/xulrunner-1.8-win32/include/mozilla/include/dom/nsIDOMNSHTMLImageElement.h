/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/dom/public/idl/html/nsIDOMNSHTMLImageElement.idl
 */
...
class NS_NO_VTABLE nsIDOMNSHTMLImageElement : public nsISupports {
 public: 
...
#define NS_FORWARD_SAFE_NSIDOMNSHTMLIMAGEELEMENT(_to) \
  ...
  NS_IMETHOD GetComplete(PRBool *aComplete) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetComplete(aComplete); } \
  NS_IMETHOD GetNaturalHeight(PRInt32 *aNaturalHeight) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetNaturalHeight(aNaturalHeight); } \
  NS_IMETHOD GetNaturalWidth(PRInt32 *aNaturalWidth) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetNaturalWidth(aNaturalWidth); } \
