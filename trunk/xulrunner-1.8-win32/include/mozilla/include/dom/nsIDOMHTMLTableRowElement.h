/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/dom/public/idl/html/nsIDOMHTMLTableRowElement.idl
 */
...
class NS_NO_VTABLE nsIDOMHTMLTableRowElement : public nsIDOMHTMLElement {
 public: 
  ...
  NS_IMETHOD InsertCell(PRInt32 index, nsIDOMHTMLElement **_retval) = 0;

  /* void deleteCell (in long index)  raises (DOMException); */
  NS_IMETHOD DeleteCell(PRInt32 index) = 0;
...
#define NS_DECL_NSIDOMHTMLTABLEROWELEMENT \
  ...
  NS_IMETHOD InsertCell(PRInt32 index, nsIDOMHTMLElement **_retval); \
  NS_IMETHOD DeleteCell(PRInt32 index); 
...
#define NS_FORWARD_NSIDOMHTMLTABLEROWELEMENT(_to) \
  ...
  NS_IMETHOD InsertCell(PRInt32 index, nsIDOMHTMLElement **_retval) { return _to InsertCell(index, _retval); } \
  NS_IMETHOD DeleteCell(PRInt32 index) { return _to DeleteCell(index); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDOMHTMLTABLEROWELEMENT(_to) \
  NS_IMETHOD GetRowIndex(PRInt32 *aRowIndex) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetRowIndex(aRowIndex); } \
  NS_IMETHOD GetSectionRowIndex(PRInt32 *aSectionRowIndex) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetSectionRowIndex(aSectionRowIndex); } \
  ...
  NS_IMETHOD InsertCell(PRInt32 index, nsIDOMHTMLElement **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->InsertCell(index, _retval); } \
  NS_IMETHOD DeleteCell(PRInt32 index) { return !_to ? NS_ERROR_NULL_POINTER : _to->DeleteCell(index); } 
