/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/dom/public/idl/html/nsIDOMNSHTMLHRElement.idl
 */
 ...
 */
class NS_NO_VTABLE nsIDOMNSHTMLHRElement : public nsISupports {
 public: 
