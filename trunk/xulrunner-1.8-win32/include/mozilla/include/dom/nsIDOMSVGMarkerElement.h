/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/dom/public/idl/svg/nsIDOMSVGMarkerElement.idl
 */
...
#define NS_IDOMSVGMARKERELEMENT_IID_STR "7d89ceb8-f985-4095-8f24-421910704e5e"
...
class NS_NO_VTABLE nsIDOMSVGMarkerElement : public nsIDOMSVGElement {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IDOMSVGMARKERELEMENT_IID)
  ...
  NS_IMETHOD GetOrientAngle(nsIDOMSVGAnimatedAngle * *aOrientAngle) = 0;

  /* void setOrientToAuto (); */
  NS_IMETHOD SetOrientToAuto(void) = 0;

  /* void setOrientToAngle (in nsIDOMSVGAngle angle); */
  NS_IMETHOD SetOrientToAngle(nsIDOMSVGAngle *angle) = 0;

  /* [noscript] nsIDOMSVGMatrix getMarkerTransform (in float strokeWidth, in float x, in float y, in float angle); */
  NS_IMETHOD GetMarkerTransform(float strokeWidth, float x, float y, float angle, nsIDOMSVGMatrix **_retval) = 0;
...
#define NS_DECL_NSIDOMSVGMARKERELEMENT \
  ...
  NS_IMETHOD GetOrientAngle(nsIDOMSVGAnimatedAngle * *aOrientAngle); \
  NS_IMETHOD SetOrientToAuto(void); \
  NS_IMETHOD SetOrientToAngle(nsIDOMSVGAngle *angle); \
  NS_IMETHOD GetMarkerTransform(float strokeWidth, float x, float y, float angle, nsIDOMSVGMatrix **_retval); \
...
#define NS_FORWARD_NSIDOMSVGMARKERELEMENT(_to) \
  ...
  NS_IMETHOD GetOrientAngle(nsIDOMSVGAnimatedAngle * *aOrientAngle) { return _to GetOrientAngle(aOrientAngle); } \
  NS_IMETHOD SetOrientToAuto(void) { return _to SetOrientToAuto(); } \
  NS_IMETHOD SetOrientToAngle(nsIDOMSVGAngle *angle) { return _to SetOrientToAngle(angle); } \
  NS_IMETHOD GetMarkerTransform(float strokeWidth, float x, float y, float angle, nsIDOMSVGMatrix **_retval) { return _to GetMarkerTransform(strokeWidth, x, y, angle, _retval); } \
...
#define NS_FORWARD_SAFE_NSIDOMSVGMARKERELEMENT(_to) \
  ...
  NS_IMETHOD GetOrientAngle(nsIDOMSVGAnimatedAngle * *aOrientAngle) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetOrientAngle(aOrientAngle); } \
  NS_IMETHOD SetOrientToAuto(void) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetOrientToAuto(); } \
  NS_IMETHOD SetOrientToAngle(nsIDOMSVGAngle *angle) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetOrientToAngle(angle); } \
  NS_IMETHOD GetMarkerTransform(float strokeWidth, float x, float y, float angle, nsIDOMSVGMatrix **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetMarkerTransform(strokeWidth, x, y, angle, _retval); } \
...
/* [noscript] nsIDOMSVGMatrix getMarkerTransform (in float strokeWidth, in float x, in float y, in float angle); */
NS_IMETHODIMP nsDOMSVGMarkerElement::GetMarkerTransform(float strokeWidth, float x, float y, float angle, nsIDOMSVGMatrix **_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* [noscript] nsIDOMSVGMatrix getViewboxToViewportTransform (); */
NS_IMETHODIMP nsDOMSVGMarkerElement::GetViewboxToViewportTransform(nsIDOMSVGMatrix **_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
