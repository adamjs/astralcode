/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/dom/public/idl/svg/nsIDOMSVGAnimatedRect.idl
 */
...
class NS_NO_VTABLE nsIDOMSVGAnimatedRect : public nsISupports {
 public: 

  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IDOMSVGANIMATEDRECT_IID)

  /* readonly attribute nsIDOMSVGRect baseVal; */
  NS_IMETHOD GetBaseVal(nsIDOMSVGRect * *aBaseVal) = 0;

  /* readonly attribute nsIDOMSVGRect animVal; */
  NS_IMETHOD GetAnimVal(nsIDOMSVGRect * *aAnimVal) = 0;
...
#define NS_FORWARD_NSIDOMSVGANIMATEDRECT(_to) \
  NS_IMETHOD GetBaseVal(nsIDOMSVGRect * *aBaseVal) { return _to GetBaseVal(aBaseVal); } \
  NS_IMETHOD GetAnimVal(nsIDOMSVGRect * *aAnimVal) { return _to GetAnimVal(aAnimVal); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDOMSVGANIMATEDRECT(_to) \
  NS_IMETHOD GetBaseVal(nsIDOMSVGRect * *aBaseVal) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetBaseVal(aBaseVal); } \
  NS_IMETHOD GetAnimVal(nsIDOMSVGRect * *aAnimVal) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetAnimVal(aAnimVal); } 
