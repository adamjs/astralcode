/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/dom/public/idl/css/nsIDOMCSS2Properties.idl
 */
...
class NS_NO_VTABLE nsIDOMCSS2Properties : public nsISupports {
 public: 
  ...
  NS_IMETHOD GetAzimuth(nsAString & aAzimuth) = 0;
  NS_IMETHOD SetAzimuth(const nsAString & aAzimuth) = 0;
  ...
  NS_IMETHOD GetCue(nsAString & aCue) = 0;
  NS_IMETHOD SetCue(const nsAString & aCue) = 0;

  /* attribute DOMString cueAfter; */
  NS_IMETHOD GetCueAfter(nsAString & aCueAfter) = 0;
  NS_IMETHOD SetCueAfter(const nsAString & aCueAfter) = 0;

  /* attribute DOMString cueBefore; */
  NS_IMETHOD GetCueBefore(nsAString & aCueBefore) = 0;
  NS_IMETHOD SetCueBefore(const nsAString & aCueBefore) = 0;
  ...
  NS_IMETHOD GetElevation(nsAString & aElevation) = 0;
  NS_IMETHOD SetElevation(const nsAString & aElevation) = 0;
  ...
  NS_IMETHOD GetPause(nsAString & aPause) = 0;
  NS_IMETHOD SetPause(const nsAString & aPause) = 0;

  /* attribute DOMString pauseAfter; */
  NS_IMETHOD GetPauseAfter(nsAString & aPauseAfter) = 0;
  NS_IMETHOD SetPauseAfter(const nsAString & aPauseAfter) = 0;

  /* attribute DOMString pauseBefore; */
  NS_IMETHOD GetPauseBefore(nsAString & aPauseBefore) = 0;
  NS_IMETHOD SetPauseBefore(const nsAString & aPauseBefore) = 0;

  /* attribute DOMString pitch; */
  NS_IMETHOD GetPitch(nsAString & aPitch) = 0;
  NS_IMETHOD SetPitch(const nsAString & aPitch) = 0;

  /* attribute DOMString pitchRange; */
  NS_IMETHOD GetPitchRange(nsAString & aPitchRange) = 0;
  NS_IMETHOD SetPitchRange(const nsAString & aPitchRange) = 0;
  ...
  NS_IMETHOD GetRichness(nsAString & aRichness) = 0;
  NS_IMETHOD SetRichness(const nsAString & aRichness) = 0;
  ...
  NS_IMETHOD GetSpeak(nsAString & aSpeak) = 0;
  NS_IMETHOD SetSpeak(const nsAString & aSpeak) = 0;

  /* attribute DOMString speakHeader; */
  NS_IMETHOD GetSpeakHeader(nsAString & aSpeakHeader) = 0;
  NS_IMETHOD SetSpeakHeader(const nsAString & aSpeakHeader) = 0;

  /* attribute DOMString speakNumeral; */
  NS_IMETHOD GetSpeakNumeral(nsAString & aSpeakNumeral) = 0;
  NS_IMETHOD SetSpeakNumeral(const nsAString & aSpeakNumeral) = 0;

  /* attribute DOMString speakPunctuation; */
  NS_IMETHOD GetSpeakPunctuation(nsAString & aSpeakPunctuation) = 0;
  NS_IMETHOD SetSpeakPunctuation(const nsAString & aSpeakPunctuation) = 0;

  /* attribute DOMString speechRate; */
  NS_IMETHOD GetSpeechRate(nsAString & aSpeechRate) = 0;
  NS_IMETHOD SetSpeechRate(const nsAString & aSpeechRate) = 0;

  /* attribute DOMString stress; */
  NS_IMETHOD GetStress(nsAString & aStress) = 0;
  NS_IMETHOD SetStress(const nsAString & aStress) = 0;
  ...
  NS_IMETHOD GetVoiceFamily(nsAString & aVoiceFamily) = 0;
  NS_IMETHOD SetVoiceFamily(const nsAString & aVoiceFamily) = 0;

  /* attribute DOMString volume; */
  NS_IMETHOD GetVolume(nsAString & aVolume) = 0;
  NS_IMETHOD SetVolume(const nsAString & aVolume) = 0;
...
#define NS_DECL_NSIDOMCSS2PROPERTIES \
  NS_IMETHOD GetAzimuth(nsAString & aAzimuth); \
  NS_IMETHOD SetAzimuth(const nsAString & aAzimuth); \
  ...
  NS_IMETHOD GetCue(nsAString & aCue); \
  NS_IMETHOD SetCue(const nsAString & aCue); \
  NS_IMETHOD GetCueAfter(nsAString & aCueAfter); \
  NS_IMETHOD SetCueAfter(const nsAString & aCueAfter); \
  NS_IMETHOD GetCueBefore(nsAString & aCueBefore); \
  NS_IMETHOD SetCueBefore(const nsAString & aCueBefore); \
  ...
  NS_IMETHOD GetElevation(nsAString & aElevation); \
  NS_IMETHOD SetElevation(const nsAString & aElevation); \
  ...
  NS_IMETHOD GetPause(nsAString & aPause); \
  NS_IMETHOD SetPause(const nsAString & aPause); \
  NS_IMETHOD GetPauseAfter(nsAString & aPauseAfter); \
  NS_IMETHOD SetPauseAfter(const nsAString & aPauseAfter); \
  NS_IMETHOD GetPauseBefore(nsAString & aPauseBefore); \
  NS_IMETHOD SetPauseBefore(const nsAString & aPauseBefore); \
  NS_IMETHOD GetPitch(nsAString & aPitch); \
  NS_IMETHOD SetPitch(const nsAString & aPitch); \
  NS_IMETHOD GetPitchRange(nsAString & aPitchRange); \
  NS_IMETHOD SetPitchRange(const nsAString & aPitchRange); \
  ...
  NS_IMETHOD GetRichness(nsAString & aRichness); \
  NS_IMETHOD SetRichness(const nsAString & aRichness); \
  ...
  NS_IMETHOD GetSpeak(nsAString & aSpeak); \
  NS_IMETHOD SetSpeak(const nsAString & aSpeak); \
  NS_IMETHOD GetSpeakHeader(nsAString & aSpeakHeader); \
  NS_IMETHOD SetSpeakHeader(const nsAString & aSpeakHeader); \
  NS_IMETHOD GetSpeakNumeral(nsAString & aSpeakNumeral); \
  NS_IMETHOD SetSpeakNumeral(const nsAString & aSpeakNumeral); \
  NS_IMETHOD GetSpeakPunctuation(nsAString & aSpeakPunctuation); \
  NS_IMETHOD SetSpeakPunctuation(const nsAString & aSpeakPunctuation); \
  NS_IMETHOD GetSpeechRate(nsAString & aSpeechRate); \
  NS_IMETHOD SetSpeechRate(const nsAString & aSpeechRate); \
  NS_IMETHOD GetStress(nsAString & aStress); \
  NS_IMETHOD SetStress(const nsAString & aStress); \
  ...
  NS_IMETHOD GetVoiceFamily(nsAString & aVoiceFamily); \
  NS_IMETHOD SetVoiceFamily(const nsAString & aVoiceFamily); \
  NS_IMETHOD GetVolume(nsAString & aVolume); \
  NS_IMETHOD SetVolume(const nsAString & aVolume); \
...
#define NS_FORWARD_NSIDOMCSS2PROPERTIES(_to) \
  NS_IMETHOD GetAzimuth(nsAString & aAzimuth) { return _to GetAzimuth(aAzimuth); } \
  NS_IMETHOD SetAzimuth(const nsAString & aAzimuth) { return _to SetAzimuth(aAzimuth); } \
  ...
  NS_IMETHOD GetCue(nsAString & aCue) { return _to GetCue(aCue); } \
  NS_IMETHOD SetCue(const nsAString & aCue) { return _to SetCue(aCue); } \
  NS_IMETHOD GetCueAfter(nsAString & aCueAfter) { return _to GetCueAfter(aCueAfter); } \
  NS_IMETHOD SetCueAfter(const nsAString & aCueAfter) { return _to SetCueAfter(aCueAfter); } \
  NS_IMETHOD GetCueBefore(nsAString & aCueBefore) { return _to GetCueBefore(aCueBefore); } \
  NS_IMETHOD SetCueBefore(const nsAString & aCueBefore) { return _to SetCueBefore(aCueBefore); } \
  ...
  NS_IMETHOD GetElevation(nsAString & aElevation) { return _to GetElevation(aElevation); } \
  NS_IMETHOD SetElevation(const nsAString & aElevation) { return _to SetElevation(aElevation); } \
  ...
  NS_IMETHOD GetPause(nsAString & aPause) { return _to GetPause(aPause); } \
  NS_IMETHOD SetPause(const nsAString & aPause) { return _to SetPause(aPause); } \
  NS_IMETHOD GetPauseAfter(nsAString & aPauseAfter) { return _to GetPauseAfter(aPauseAfter); } \
  NS_IMETHOD SetPauseAfter(const nsAString & aPauseAfter) { return _to SetPauseAfter(aPauseAfter); } \
  NS_IMETHOD GetPauseBefore(nsAString & aPauseBefore) { return _to GetPauseBefore(aPauseBefore); } \
  NS_IMETHOD SetPauseBefore(const nsAString & aPauseBefore) { return _to SetPauseBefore(aPauseBefore); } \
  NS_IMETHOD GetPitch(nsAString & aPitch) { return _to GetPitch(aPitch); } \
  NS_IMETHOD SetPitch(const nsAString & aPitch) { return _to SetPitch(aPitch); } \
  NS_IMETHOD GetPitchRange(nsAString & aPitchRange) { return _to GetPitchRange(aPitchRange); } \
  NS_IMETHOD SetPitchRange(const nsAString & aPitchRange) { return _to SetPitchRange(aPitchRange); } \
  ...
  NS_IMETHOD GetRichness(nsAString & aRichness) { return _to GetRichness(aRichness); } \
  NS_IMETHOD SetRichness(const nsAString & aRichness) { return _to SetRichness(aRichness); } \
  ...
  NS_IMETHOD GetSpeak(nsAString & aSpeak) { return _to GetSpeak(aSpeak); } \
  NS_IMETHOD SetSpeak(const nsAString & aSpeak) { return _to SetSpeak(aSpeak); } \
  NS_IMETHOD GetSpeakHeader(nsAString & aSpeakHeader) { return _to GetSpeakHeader(aSpeakHeader); } \
  NS_IMETHOD SetSpeakHeader(const nsAString & aSpeakHeader) { return _to SetSpeakHeader(aSpeakHeader); } \
  NS_IMETHOD GetSpeakNumeral(nsAString & aSpeakNumeral) { return _to GetSpeakNumeral(aSpeakNumeral); } \
  NS_IMETHOD SetSpeakNumeral(const nsAString & aSpeakNumeral) { return _to SetSpeakNumeral(aSpeakNumeral); } \
  NS_IMETHOD GetSpeakPunctuation(nsAString & aSpeakPunctuation) { return _to GetSpeakPunctuation(aSpeakPunctuation); } \
  NS_IMETHOD SetSpeakPunctuation(const nsAString & aSpeakPunctuation) { return _to SetSpeakPunctuation(aSpeakPunctuation); } \
  NS_IMETHOD GetSpeechRate(nsAString & aSpeechRate) { return _to GetSpeechRate(aSpeechRate); } \
  NS_IMETHOD SetSpeechRate(const nsAString & aSpeechRate) { return _to SetSpeechRate(aSpeechRate); } \
  NS_IMETHOD GetStress(nsAString & aStress) { return _to GetStress(aStress); } \
  NS_IMETHOD SetStress(const nsAString & aStress) { return _to SetStress(aStress); } \
  ...
  NS_IMETHOD GetVoiceFamily(nsAString & aVoiceFamily) { return _to GetVoiceFamily(aVoiceFamily); } \
  NS_IMETHOD SetVoiceFamily(const nsAString & aVoiceFamily) { return _to SetVoiceFamily(aVoiceFamily); } \
  NS_IMETHOD GetVolume(nsAString & aVolume) { return _to GetVolume(aVolume); } \
  NS_IMETHOD SetVolume(const nsAString & aVolume) { return _to SetVolume(aVolume); } \
...
#define NS_FORWARD_SAFE_NSIDOMCSS2PROPERTIES(_to) \
  NS_IMETHOD GetAzimuth(nsAString & aAzimuth) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetAzimuth(aAzimuth); } \
  NS_IMETHOD SetAzimuth(const nsAString & aAzimuth) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetAzimuth(aAzimuth); } \
  ...
  NS_IMETHOD GetCue(nsAString & aCue) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetCue(aCue); } \
  NS_IMETHOD SetCue(const nsAString & aCue) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetCue(aCue); } \
  NS_IMETHOD GetCueAfter(nsAString & aCueAfter) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetCueAfter(aCueAfter); } \
  NS_IMETHOD SetCueAfter(const nsAString & aCueAfter) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetCueAfter(aCueAfter); } \
  NS_IMETHOD GetCueBefore(nsAString & aCueBefore) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetCueBefore(aCueBefore); } \
  NS_IMETHOD SetCueBefore(const nsAString & aCueBefore) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetCueBefore(aCueBefore); } \
  ...
  NS_IMETHOD GetElevation(nsAString & aElevation) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetElevation(aElevation); } \
  NS_IMETHOD SetElevation(const nsAString & aElevation) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetElevation(aElevation); } \
  ...
  NS_IMETHOD GetPause(nsAString & aPause) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetPause(aPause); } \
  NS_IMETHOD SetPause(const nsAString & aPause) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetPause(aPause); } \
  NS_IMETHOD GetPauseAfter(nsAString & aPauseAfter) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetPauseAfter(aPauseAfter); } \
  NS_IMETHOD SetPauseAfter(const nsAString & aPauseAfter) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetPauseAfter(aPauseAfter); } \
  NS_IMETHOD GetPauseBefore(nsAString & aPauseBefore) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetPauseBefore(aPauseBefore); } \
  NS_IMETHOD SetPauseBefore(const nsAString & aPauseBefore) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetPauseBefore(aPauseBefore); } \
  NS_IMETHOD GetPitch(nsAString & aPitch) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetPitch(aPitch); } \
  NS_IMETHOD SetPitch(const nsAString & aPitch) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetPitch(aPitch); } \
  NS_IMETHOD GetPitchRange(nsAString & aPitchRange) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetPitchRange(aPitchRange); } \
  NS_IMETHOD SetPitchRange(const nsAString & aPitchRange) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetPitchRange(aPitchRange); } \
  ...
  NS_IMETHOD GetRichness(nsAString & aRichness) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetRichness(aRichness); } \
  NS_IMETHOD SetRichness(const nsAString & aRichness) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetRichness(aRichness); } \
  ...
  NS_IMETHOD GetSpeak(nsAString & aSpeak) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetSpeak(aSpeak); } \
  NS_IMETHOD SetSpeak(const nsAString & aSpeak) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetSpeak(aSpeak); } \
  NS_IMETHOD GetSpeakHeader(nsAString & aSpeakHeader) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetSpeakHeader(aSpeakHeader); } \
  NS_IMETHOD SetSpeakHeader(const nsAString & aSpeakHeader) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetSpeakHeader(aSpeakHeader); } \
  NS_IMETHOD GetSpeakNumeral(nsAString & aSpeakNumeral) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetSpeakNumeral(aSpeakNumeral); } \
  NS_IMETHOD SetSpeakNumeral(const nsAString & aSpeakNumeral) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetSpeakNumeral(aSpeakNumeral); } \
  NS_IMETHOD GetSpeakPunctuation(nsAString & aSpeakPunctuation) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetSpeakPunctuation(aSpeakPunctuation); } \
  NS_IMETHOD SetSpeakPunctuation(const nsAString & aSpeakPunctuation) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetSpeakPunctuation(aSpeakPunctuation); } \
  NS_IMETHOD GetSpeechRate(nsAString & aSpeechRate) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetSpeechRate(aSpeechRate); } \
  NS_IMETHOD SetSpeechRate(const nsAString & aSpeechRate) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetSpeechRate(aSpeechRate); } \
  NS_IMETHOD GetStress(nsAString & aStress) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetStress(aStress); } \
  NS_IMETHOD SetStress(const nsAString & aStress) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetStress(aStress); } \
  ...
  NS_IMETHOD GetVoiceFamily(nsAString & aVoiceFamily) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetVoiceFamily(aVoiceFamily); } \
  NS_IMETHOD SetVoiceFamily(const nsAString & aVoiceFamily) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetVoiceFamily(aVoiceFamily); } \
  NS_IMETHOD GetVolume(nsAString & aVolume) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetVolume(aVolume); } \
  NS_IMETHOD SetVolume(const nsAString & aVolume) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetVolume(aVolume); } \
...
#define NS_IDOMNSCSS2PROPERTIES_IID_STR "06b42e9d-61b5-400d-9561-b43f0e9883c0"
...
class NS_NO_VTABLE nsIDOMNSCSS2Properties : public nsIDOMCSS2Properties {
 public: 
  ...
  NS_IMETHOD GetMozBackgroundClip(nsAString & aMozBackgroundClip) = 0;
  NS_IMETHOD SetMozBackgroundClip(const nsAString & aMozBackgroundClip) = 0;
  ...
  NS_IMETHOD GetMozBackgroundOrigin(nsAString & aMozBackgroundOrigin) = 0;
  NS_IMETHOD SetMozBackgroundOrigin(const nsAString & aMozBackgroundOrigin) = 0;
  ...
  NS_IMETHOD GetMozBorderRadius(nsAString & aMozBorderRadius) = 0;
  NS_IMETHOD SetMozBorderRadius(const nsAString & aMozBorderRadius) = 0;

  /* attribute DOMString MozBorderRadiusTopleft; */
  NS_IMETHOD GetMozBorderRadiusTopleft(nsAString & aMozBorderRadiusTopleft) = 0;
  NS_IMETHOD SetMozBorderRadiusTopleft(const nsAString & aMozBorderRadiusTopleft) = 0;

  /* attribute DOMString MozBorderRadiusTopright; */
  NS_IMETHOD GetMozBorderRadiusTopright(nsAString & aMozBorderRadiusTopright) = 0;
  NS_IMETHOD SetMozBorderRadiusTopright(const nsAString & aMozBorderRadiusTopright) = 0;

  /* attribute DOMString MozBorderRadiusBottomleft; */
  NS_IMETHOD GetMozBorderRadiusBottomleft(nsAString & aMozBorderRadiusBottomleft) = 0;
  NS_IMETHOD SetMozBorderRadiusBottomleft(const nsAString & aMozBorderRadiusBottomleft) = 0;

  /* attribute DOMString MozBorderRadiusBottomright; */
  NS_IMETHOD GetMozBorderRadiusBottomright(nsAString & aMozBorderRadiusBottomright) = 0;
  NS_IMETHOD SetMozBorderRadiusBottomright(const nsAString & aMozBorderRadiusBottomright) = 0;
  ...
  NS_IMETHOD GetMozOpacity(nsAString & aMozOpacity) = 0;
  NS_IMETHOD SetMozOpacity(const nsAString & aMozOpacity) = 0;

  /* attribute DOMString MozOutline; */
  NS_IMETHOD GetMozOutline(nsAString & aMozOutline) = 0;
  NS_IMETHOD SetMozOutline(const nsAString & aMozOutline) = 0;

  /* attribute DOMString MozOutlineColor; */
  NS_IMETHOD GetMozOutlineColor(nsAString & aMozOutlineColor) = 0;
  NS_IMETHOD SetMozOutlineColor(const nsAString & aMozOutlineColor) = 0;
  ...
  NS_IMETHOD GetMozOutlineStyle(nsAString & aMozOutlineStyle) = 0;
  NS_IMETHOD SetMozOutlineStyle(const nsAString & aMozOutlineStyle) = 0;

  /* attribute DOMString MozOutlineWidth; */
  NS_IMETHOD GetMozOutlineWidth(nsAString & aMozOutlineWidth) = 0;
  NS_IMETHOD SetMozOutlineWidth(const nsAString & aMozOutlineWidth) = 0;

  /* attribute DOMString MozOutlineOffset; */
  NS_IMETHOD GetMozOutlineOffset(nsAString & aMozOutlineOffset) = 0;
  NS_IMETHOD SetMozOutlineOffset(const nsAString & aMozOutlineOffset) = 0;
...
#define NS_DECL_NSIDOMNSCSS2PROPERTIES \
  ...
  NS_IMETHOD GetMozBackgroundClip(nsAString & aMozBackgroundClip); \
  NS_IMETHOD SetMozBackgroundClip(const nsAString & aMozBackgroundClip); \
  ...
  NS_IMETHOD GetMozBackgroundOrigin(nsAString & aMozBackgroundOrigin); \
  NS_IMETHOD SetMozBackgroundOrigin(const nsAString & aMozBackgroundOrigin); \
  ...
  NS_IMETHOD GetMozBorderRadius(nsAString & aMozBorderRadius); \
  ...
  NS_IMETHOD GetMozBorderRadiusTopright(nsAString & aMozBorderRadiusTopright); \
  NS_IMETHOD SetMozBorderRadiusTopright(const nsAString & aMozBorderRadiusTopright); \
  NS_IMETHOD GetMozBorderRadiusBottomleft(nsAString & aMozBorderRadiusBottomleft); \
  NS_IMETHOD SetMozBorderRadiusBottomleft(const nsAString & aMozBorderRadiusBottomleft); \
  NS_IMETHOD GetMozBorderRadiusBottomright(nsAString & aMozBorderRadiusBottomright); \
  NS_IMETHOD SetMozBorderRadiusBottomright(const nsAString & aMozBorderRadiusBottomright); \
  ...
  NS_IMETHOD GetMozOpacity(nsAString & aMozOpacity); \
  NS_IMETHOD SetMozOpacity(const nsAString & aMozOpacity); \
  NS_IMETHOD GetMozOutline(nsAString & aMozOutline); \
  NS_IMETHOD SetMozOutline(const nsAString & aMozOutline); \
  NS_IMETHOD GetMozOutlineColor(nsAString & aMozOutlineColor); \
  NS_IMETHOD SetMozOutlineColor(const nsAString & aMozOutlineColor); \
  ...
  NS_IMETHOD GetMozOutlineStyle(nsAString & aMozOutlineStyle); \
  NS_IMETHOD SetMozOutlineStyle(const nsAString & aMozOutlineStyle); \
  NS_IMETHOD GetMozOutlineWidth(nsAString & aMozOutlineWidth); \
  NS_IMETHOD SetMozOutlineWidth(const nsAString & aMozOutlineWidth); \
  NS_IMETHOD GetMozOutlineOffset(nsAString & aMozOutlineOffset); \
  NS_IMETHOD SetMozOutlineOffset(const nsAString & aMozOutlineOffset); \
...
#define NS_FORWARD_NSIDOMNSCSS2PROPERTIES(_to) \
  ...
  NS_IMETHOD GetMozBackgroundClip(nsAString & aMozBackgroundClip) { return _to GetMozBackgroundClip(aMozBackgroundClip); } \
  NS_IMETHOD SetMozBackgroundClip(const nsAString & aMozBackgroundClip) { return _to SetMozBackgroundClip(aMozBackgroundClip); } \
  ...
  NS_IMETHOD GetMozBackgroundOrigin(nsAString & aMozBackgroundOrigin) { return _to GetMozBackgroundOrigin(aMozBackgroundOrigin); } \
  NS_IMETHOD SetMozBackgroundOrigin(const nsAString & aMozBackgroundOrigin) { return _to SetMozBackgroundOrigin(aMozBackgroundOrigin); } \
  ...
  NS_IMETHOD GetMozBorderRadius(nsAString & aMozBorderRadius) { return _to GetMozBorderRadius(aMozBorderRadius); } \
  NS_IMETHOD SetMozBorderRadius(const nsAString & aMozBorderRadius) { return _to SetMozBorderRadius(aMozBorderRadius); } \
  NS_IMETHOD GetMozBorderRadiusTopleft(nsAString & aMozBorderRadiusTopleft) { return _to GetMozBorderRadiusTopleft(aMozBorderRadiusTopleft); } \
  NS_IMETHOD SetMozBorderRadiusTopleft(const nsAString & aMozBorderRadiusTopleft) { return _to SetMozBorderRadiusTopleft(aMozBorderRadiusTopleft); } \
  NS_IMETHOD GetMozBorderRadiusTopright(nsAString & aMozBorderRadiusTopright) { return _to GetMozBorderRadiusTopright(aMozBorderRadiusTopright); } \
  NS_IMETHOD SetMozBorderRadiusTopright(const nsAString & aMozBorderRadiusTopright) { return _to SetMozBorderRadiusTopright(aMozBorderRadiusTopright); } \
  NS_IMETHOD GetMozBorderRadiusBottomleft(nsAString & aMozBorderRadiusBottomleft) { return _to GetMozBorderRadiusBottomleft(aMozBorderRadiusBottomleft); } \
  NS_IMETHOD SetMozBorderRadiusBottomleft(const nsAString & aMozBorderRadiusBottomleft) { return _to SetMozBorderRadiusBottomleft(aMozBorderRadiusBottomleft); } \
  NS_IMETHOD GetMozBorderRadiusBottomright(nsAString & aMozBorderRadiusBottomright) { return _to GetMozBorderRadiusBottomright(aMozBorderRadiusBottomright); } \
  NS_IMETHOD SetMozBorderRadiusBottomright(const nsAString & aMozBorderRadiusBottomright) { return _to SetMozBorderRadiusBottomright(aMozBorderRadiusBottomright); } \
  ...
  NS_IMETHOD GetMozOpacity(nsAString & aMozOpacity) { return _to GetMozOpacity(aMozOpacity); } \
  NS_IMETHOD SetMozOpacity(const nsAString & aMozOpacity) { return _to SetMozOpacity(aMozOpacity); } \
  NS_IMETHOD GetMozOutline(nsAString & aMozOutline) { return _to GetMozOutline(aMozOutline); } \
  NS_IMETHOD SetMozOutline(const nsAString & aMozOutline) { return _to SetMozOutline(aMozOutline); } \
  NS_IMETHOD GetMozOutlineColor(nsAString & aMozOutlineColor) { return _to GetMozOutlineColor(aMozOutlineColor); } \
  NS_IMETHOD SetMozOutlineColor(const nsAString & aMozOutlineColor) { return _to SetMozOutlineColor(aMozOutlineColor); } \
  ...
  NS_IMETHOD GetMozOutlineStyle(nsAString & aMozOutlineStyle) { return _to GetMozOutlineStyle(aMozOutlineStyle); } \
  NS_IMETHOD SetMozOutlineStyle(const nsAString & aMozOutlineStyle) { return _to SetMozOutlineStyle(aMozOutlineStyle); } \
  NS_IMETHOD GetMozOutlineWidth(nsAString & aMozOutlineWidth) { return _to GetMozOutlineWidth(aMozOutlineWidth); } \
  NS_IMETHOD SetMozOutlineWidth(const nsAString & aMozOutlineWidth) { return _to SetMozOutlineWidth(aMozOutlineWidth); } \
  NS_IMETHOD GetMozOutlineOffset(nsAString & aMozOutlineOffset) { return _to GetMozOutlineOffset(aMozOutlineOffset); } \
  NS_IMETHOD SetMozOutlineOffset(const nsAString & aMozOutlineOffset) { return _to SetMozOutlineOffset(aMozOutlineOffset); } \
...
#define NS_FORWARD_SAFE_NSIDOMNSCSS2PROPERTIES(_to) \
  ...
  NS_IMETHOD GetMozBackgroundClip(nsAString & aMozBackgroundClip) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetMozBackgroundClip(aMozBackgroundClip); } \
  NS_IMETHOD SetMozBackgroundClip(const nsAString & aMozBackgroundClip) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetMozBackgroundClip(aMozBackgroundClip); } \
  ...
  NS_IMETHOD GetMozBackgroundOrigin(nsAString & aMozBackgroundOrigin) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetMozBackgroundOrigin(aMozBackgroundOrigin); } \
  NS_IMETHOD SetMozBackgroundOrigin(const nsAString & aMozBackgroundOrigin) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetMozBackgroundOrigin(aMozBackgroundOrigin); } \
  ...
  NS_IMETHOD GetMozBorderRadius(nsAString & aMozBorderRadius) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetMozBorderRadius(aMozBorderRadius); } \
  NS_IMETHOD SetMozBorderRadius(const nsAString & aMozBorderRadius) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetMozBorderRadius(aMozBorderRadius); } \
  NS_IMETHOD GetMozBorderRadiusTopleft(nsAString & aMozBorderRadiusTopleft) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetMozBorderRadiusTopleft(aMozBorderRadiusTopleft); } \
  NS_IMETHOD SetMozBorderRadiusTopleft(const nsAString & aMozBorderRadiusTopleft) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetMozBorderRadiusTopleft(aMozBorderRadiusTopleft); } \
  NS_IMETHOD GetMozBorderRadiusTopright(nsAString & aMozBorderRadiusTopright) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetMozBorderRadiusTopright(aMozBorderRadiusTopright); } \
  NS_IMETHOD SetMozBorderRadiusTopright(const nsAString & aMozBorderRadiusTopright) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetMozBorderRadiusTopright(aMozBorderRadiusTopright); } \
  NS_IMETHOD GetMozBorderRadiusBottomleft(nsAString & aMozBorderRadiusBottomleft) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetMozBorderRadiusBottomleft(aMozBorderRadiusBottomleft); } \
  NS_IMETHOD SetMozBorderRadiusBottomleft(const nsAString & aMozBorderRadiusBottomleft) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetMozBorderRadiusBottomleft(aMozBorderRadiusBottomleft); } \
  NS_IMETHOD GetMozBorderRadiusBottomright(nsAString & aMozBorderRadiusBottomright) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetMozBorderRadiusBottomright(aMozBorderRadiusBottomright); } \
  NS_IMETHOD SetMozBorderRadiusBottomright(const nsAString & aMozBorderRadiusBottomright) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetMozBorderRadiusBottomright(aMozBorderRadiusBottomright); } \
  ...
  NS_IMETHOD GetMozOpacity(nsAString & aMozOpacity) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetMozOpacity(aMozOpacity); } \
  NS_IMETHOD SetMozOpacity(const nsAString & aMozOpacity) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetMozOpacity(aMozOpacity); } \
  NS_IMETHOD GetMozOutline(nsAString & aMozOutline) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetMozOutline(aMozOutline); } \
  NS_IMETHOD SetMozOutline(const nsAString & aMozOutline) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetMozOutline(aMozOutline); } \
  NS_IMETHOD GetMozOutlineColor(nsAString & aMozOutlineColor) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetMozOutlineColor(aMozOutlineColor); } \
  NS_IMETHOD SetMozOutlineColor(const nsAString & aMozOutlineColor) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetMozOutlineColor(aMozOutlineColor); } \
  ...
  NS_IMETHOD GetMozOutlineStyle(nsAString & aMozOutlineStyle) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetMozOutlineStyle(aMozOutlineStyle); } \
  NS_IMETHOD SetMozOutlineStyle(const nsAString & aMozOutlineStyle) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetMozOutlineStyle(aMozOutlineStyle); } \
  NS_IMETHOD GetMozOutlineWidth(nsAString & aMozOutlineWidth) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetMozOutlineWidth(aMozOutlineWidth); } \
  NS_IMETHOD SetMozOutlineWidth(const nsAString & aMozOutlineWidth) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetMozOutlineWidth(aMozOutlineWidth); } \
  NS_IMETHOD GetMozOutlineOffset(nsAString & aMozOutlineOffset) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetMozOutlineOffset(aMozOutlineOffset); } \
  NS_IMETHOD SetMozOutlineOffset(const nsAString & aMozOutlineOffset) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetMozOutlineOffset(aMozOutlineOffset); } \
