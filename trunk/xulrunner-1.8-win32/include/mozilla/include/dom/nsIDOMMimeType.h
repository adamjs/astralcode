/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/dom/public/idl/base/nsIDOMMimeType.idl
 */
...
class NS_NO_VTABLE nsIDOMMimeType : public nsISupports {
 public: 
  ...
  NS_IMETHOD GetSuffixes(nsAString & aSuffixes) = 0;
...
#define NS_FORWARD_NSIDOMMIMETYPE(_to) \
  ...
  NS_IMETHOD GetSuffixes(nsAString & aSuffixes) { return _to GetSuffixes(aSuffixes); } \
...
#define NS_FORWARD_SAFE_NSIDOMMIMETYPE(_to) \
  ...
  NS_IMETHOD GetEnabledPlugin(nsIDOMPlugin * *aEnabledPlugin) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetEnabledPlugin(aEnabledPlugin); } \
  NS_IMETHOD GetSuffixes(nsAString & aSuffixes) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetSuffixes(aSuffixes); } \
