/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/dom/public/idl/html/nsIDOMNSHTMLDocument.idl
 */
...
class NS_NO_VTABLE nsIDOMNSHTMLDocument : public nsISupports {
 public: 
  ...
  NS_IMETHOD GetSelection(nsAString & _retval) = 0;

  /* nsIDOMDocument open (in ACString aContentType, in boolean aReplace); */
  NS_IMETHOD Open(const nsACString & aContentType, PRBool aReplace, nsIDOMDocument **_retval) = 0;

  /* void write (); */
  NS_IMETHOD Write(void) = 0;

  /* void writeln (); */
  NS_IMETHOD Writeln(void) = 0;
  ...
  NS_IMETHOD ExecCommand(const nsAString & commandID, PRBool doShowUI, const nsAString & value, PRBool *_retval) = 0;

  /* boolean execCommandShowHelp (in DOMString commandID); */
  NS_IMETHOD ExecCommandShowHelp(const nsAString & commandID, PRBool *_retval) = 0;

  /* boolean queryCommandEnabled (in DOMString commandID); */
  NS_IMETHOD QueryCommandEnabled(const nsAString & commandID, PRBool *_retval) = 0;

  /* boolean queryCommandIndeterm (in DOMString commandID); */
  NS_IMETHOD QueryCommandIndeterm(const nsAString & commandID, PRBool *_retval) = 0;

  /* boolean queryCommandState (in DOMString commandID); */
  NS_IMETHOD QueryCommandState(const nsAString & commandID, PRBool *_retval) = 0;

  /* boolean queryCommandSupported (in DOMString commandID); */
  NS_IMETHOD QueryCommandSupported(const nsAString & commandID, PRBool *_retval) = 0;

  /* DOMString queryCommandText (in DOMString commandID); */
  NS_IMETHOD QueryCommandText(const nsAString & commandID, nsAString & _retval) = 0;
...
#define NS_DECL_NSIDOMNSHTMLDOCUMENT \
  ...
  NS_IMETHOD GetSelection(nsAString & _retval); \
  NS_IMETHOD Open(const nsACString & aContentType, PRBool aReplace, nsIDOMDocument **_retval); \
  NS_IMETHOD Write(void); \
  NS_IMETHOD Writeln(void); \
  ...
  NS_IMETHOD ExecCommand(const nsAString & commandID, PRBool doShowUI, const nsAString & value, PRBool *_retval); \
  NS_IMETHOD ExecCommandShowHelp(const nsAString & commandID, PRBool *_retval); \
  NS_IMETHOD QueryCommandEnabled(const nsAString & commandID, PRBool *_retval); \
  NS_IMETHOD QueryCommandIndeterm(const nsAString & commandID, PRBool *_retval); \
  NS_IMETHOD QueryCommandState(const nsAString & commandID, PRBool *_retval); \
  NS_IMETHOD QueryCommandSupported(const nsAString & commandID, PRBool *_retval); \
  NS_IMETHOD QueryCommandText(const nsAString & commandID, nsAString & _retval); \
...
#define NS_FORWARD_NSIDOMNSHTMLDOCUMENT(_to) \
  ...
  NS_IMETHOD GetSelection(nsAString & _retval) { return _to GetSelection(_retval); } \
  NS_IMETHOD Open(const nsACString & aContentType, PRBool aReplace, nsIDOMDocument **_retval) { return _to Open(aContentType, aReplace, _retval); } \
  NS_IMETHOD Write(void) { return _to Write(); } \
  NS_IMETHOD Writeln(void) { return _to Writeln(); } \
  ...
  NS_IMETHOD ExecCommand(const nsAString & commandID, PRBool doShowUI, const nsAString & value, PRBool *_retval) { return _to ExecCommand(commandID, doShowUI, value, _retval); } \
  NS_IMETHOD ExecCommandShowHelp(const nsAString & commandID, PRBool *_retval) { return _to ExecCommandShowHelp(commandID, _retval); } \
  NS_IMETHOD QueryCommandEnabled(const nsAString & commandID, PRBool *_retval) { return _to QueryCommandEnabled(commandID, _retval); } \
  NS_IMETHOD QueryCommandIndeterm(const nsAString & commandID, PRBool *_retval) { return _to QueryCommandIndeterm(commandID, _retval); } \
  NS_IMETHOD QueryCommandState(const nsAString & commandID, PRBool *_retval) { return _to QueryCommandState(commandID, _retval); } \
  NS_IMETHOD QueryCommandSupported(const nsAString & commandID, PRBool *_retval) { return _to QueryCommandSupported(commandID, _retval); } \
  NS_IMETHOD QueryCommandText(const nsAString & commandID, nsAString & _retval) { return _to QueryCommandText(commandID, _retval); } \
...
#define NS_FORWARD_SAFE_NSIDOMNSHTMLDOCUMENT(_to) \
  ...
  NS_IMETHOD GetSelection(nsAString & _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetSelection(_retval); } \
  NS_IMETHOD Open(const nsACString & aContentType, PRBool aReplace, nsIDOMDocument **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Open(aContentType, aReplace, _retval); } \
  NS_IMETHOD Write(void) { return !_to ? NS_ERROR_NULL_POINTER : _to->Write(); } \
  NS_IMETHOD Writeln(void) { return !_to ? NS_ERROR_NULL_POINTER : _to->Writeln(); } \
  ...
  NS_IMETHOD ExecCommand(const nsAString & commandID, PRBool doShowUI, const nsAString & value, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->ExecCommand(commandID, doShowUI, value, _retval); } \
  NS_IMETHOD ExecCommandShowHelp(const nsAString & commandID, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->ExecCommandShowHelp(commandID, _retval); } \
  NS_IMETHOD QueryCommandEnabled(const nsAString & commandID, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->QueryCommandEnabled(commandID, _retval); } \
  NS_IMETHOD QueryCommandIndeterm(const nsAString & commandID, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->QueryCommandIndeterm(commandID, _retval); } \
  NS_IMETHOD QueryCommandState(const nsAString & commandID, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->QueryCommandState(commandID, _retval); } \
  NS_IMETHOD QueryCommandSupported(const nsAString & commandID, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->QueryCommandSupported(commandID, _retval); } \
  NS_IMETHOD QueryCommandText(const nsAString & commandID, nsAString & _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->QueryCommandText(commandID, _retval); } \
...
/* DOMString getSelection (); */
NS_IMETHODIMP nsDOMNSHTMLDocument::GetSelection(nsAString & _retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* nsIDOMDocument open (in ACString aContentType, in boolean aReplace); */
NS_IMETHODIMP nsDOMNSHTMLDocument::Open(const nsACString & aContentType, PRBool aReplace, nsIDOMDocument **_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* boolean execCommand (in DOMString commandID, in boolean doShowUI, in DOMString value); */
NS_IMETHODIMP nsDOMNSHTMLDocument::ExecCommand(const nsAString & commandID, PRBool doShowUI, const nsAString & value, PRBool *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* boolean execCommandShowHelp (in DOMString commandID); */
NS_IMETHODIMP nsDOMNSHTMLDocument::ExecCommandShowHelp(const nsAString & commandID, PRBool *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* boolean queryCommandEnabled (in DOMString commandID); */
NS_IMETHODIMP nsDOMNSHTMLDocument::QueryCommandEnabled(const nsAString & commandID, PRBool *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* boolean queryCommandIndeterm (in DOMString commandID); */
NS_IMETHODIMP nsDOMNSHTMLDocument::QueryCommandIndeterm(const nsAString & commandID, PRBool *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* boolean queryCommandState (in DOMString commandID); */
NS_IMETHODIMP nsDOMNSHTMLDocument::QueryCommandState(const nsAString & commandID, PRBool *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* boolean queryCommandSupported (in DOMString commandID); */
NS_IMETHODIMP nsDOMNSHTMLDocument::QueryCommandSupported(const nsAString & commandID, PRBool *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* DOMString queryCommandText (in DOMString commandID); */
NS_IMETHODIMP nsDOMNSHTMLDocument::QueryCommandText(const nsAString & commandID, nsAString & _retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* DOMString queryCommandValue (in DOMString commandID); */
NS_IMETHODIMP nsDOMNSHTMLDocument::QueryCommandValue(const nsAString & commandID, nsAString & _retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
