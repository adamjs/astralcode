/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/dom/public/idl/svg/nsIDOMSVGTextPositionElem.idl
 */
...
class NS_NO_VTABLE nsIDOMSVGTextPositioningElement : public nsIDOMSVGTextContentElement {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IDOMSVGTEXTPOSITIONINGELEMENT_IID)

  /* readonly attribute nsIDOMSVGAnimatedLengthList x; */
  NS_IMETHOD GetX(nsIDOMSVGAnimatedLengthList * *aX) = 0;

  /* readonly attribute nsIDOMSVGAnimatedLengthList y; */
  NS_IMETHOD GetY(nsIDOMSVGAnimatedLengthList * *aY) = 0;

  /* readonly attribute nsIDOMSVGAnimatedLengthList dx; */
  NS_IMETHOD GetDx(nsIDOMSVGAnimatedLengthList * *aDx) = 0;

  /* readonly attribute nsIDOMSVGAnimatedLengthList dy; */
  NS_IMETHOD GetDy(nsIDOMSVGAnimatedLengthList * *aDy) = 0;

  /* readonly attribute nsIDOMSVGAnimatedNumberList rotate; */
  NS_IMETHOD GetRotate(nsIDOMSVGAnimatedNumberList * *aRotate) = 0;

};

/* Use this macro when declaring classes that implement this interface. */
#define NS_DECL_NSIDOMSVGTEXTPOSITIONINGELEMENT \
  NS_IMETHOD GetX(nsIDOMSVGAnimatedLengthList * *aX); \
  NS_IMETHOD GetY(nsIDOMSVGAnimatedLengthList * *aY); \
  NS_IMETHOD GetDx(nsIDOMSVGAnimatedLengthList * *aDx); \
  NS_IMETHOD GetDy(nsIDOMSVGAnimatedLengthList * *aDy); \
  NS_IMETHOD GetRotate(nsIDOMSVGAnimatedNumberList * *aRotate); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDOMSVGTEXTPOSITIONINGELEMENT(_to) \
  NS_IMETHOD GetX(nsIDOMSVGAnimatedLengthList * *aX) { return _to GetX(aX); } \
  NS_IMETHOD GetY(nsIDOMSVGAnimatedLengthList * *aY) { return _to GetY(aY); } \
  NS_IMETHOD GetDx(nsIDOMSVGAnimatedLengthList * *aDx) { return _to GetDx(aDx); } \
  NS_IMETHOD GetDy(nsIDOMSVGAnimatedLengthList * *aDy) { return _to GetDy(aDy); } \
  NS_IMETHOD GetRotate(nsIDOMSVGAnimatedNumberList * *aRotate) { return _to GetRotate(aRotate); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDOMSVGTEXTPOSITIONINGELEMENT(_to) \
  NS_IMETHOD GetX(nsIDOMSVGAnimatedLengthList * *aX) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetX(aX); } \
  NS_IMETHOD GetY(nsIDOMSVGAnimatedLengthList * *aY) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetY(aY); } \
  NS_IMETHOD GetDx(nsIDOMSVGAnimatedLengthList * *aDx) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetDx(aDx); } \
  NS_IMETHOD GetDy(nsIDOMSVGAnimatedLengthList * *aDy) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetDy(aDy); } \
  NS_IMETHOD GetRotate(nsIDOMSVGAnimatedNumberList * *aRotate) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetRotate(aRotate); } 
