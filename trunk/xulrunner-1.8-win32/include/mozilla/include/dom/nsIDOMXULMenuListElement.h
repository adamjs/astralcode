/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/dom/public/idl/xul/nsIDOMXULMenuListElement.idl
 */
...
class NS_NO_VTABLE nsIDOMXULMenuListElement : public nsIDOMXULSelectControlElement {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IDOMXULMENULISTELEMENT_IID)

  /* attribute boolean editable; */
  NS_IMETHOD GetEditable(PRBool *aEditable) = 0;
  NS_IMETHOD SetEditable(PRBool aEditable) = 0;
...
#define NS_DECL_NSIDOMXULMENULISTELEMENT \
  ...
  NS_IMETHOD SetEditable(PRBool aEditable); \
...
#define NS_FORWARD_NSIDOMXULMENULISTELEMENT(_to) \
  ...
  NS_IMETHOD SetEditable(PRBool aEditable) { return _to SetEditable(aEditable); } \
...
#define NS_FORWARD_SAFE_NSIDOMXULMENULISTELEMENT(_to) \
  ...
  NS_IMETHOD SetEditable(PRBool aEditable) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetEditable(aEditable); } \
...
/* readonly attribute nsIDOMXULTextBoxElement inputField; */
NS_IMETHODIMP nsDOMXULMenuListElement::GetInputField(nsIDOMXULTextBoxElement * *aInputField)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
