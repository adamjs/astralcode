/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/dom/public/idl/xpath/nsIDOMXPathResult.idl
 */
...
class NS_NO_VTABLE nsIDOMXPathResult : public nsISupports {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IDOMXPATHRESULT_IID)
  ...
  NS_IMETHOD GetResultType(PRUint16 *aResultType) = 0;
  ...
  NS_IMETHOD GetBooleanValue(PRBool *aBooleanValue) = 0;

  /* readonly attribute nsIDOMNode singleNodeValue; */
  NS_IMETHOD GetSingleNodeValue(nsIDOMNode * *aSingleNodeValue) = 0;

  /* readonly attribute boolean invalidIteratorState; */
  NS_IMETHOD GetInvalidIteratorState(PRBool *aInvalidIteratorState) = 0;

  /* readonly attribute unsigned long snapshotLength; */
  NS_IMETHOD GetSnapshotLength(PRUint32 *aSnapshotLength) = 0;
  ...
  NS_IMETHOD SnapshotItem(PRUint32 index, nsIDOMNode **_retval) = 0;

};

/* Use this macro when declaring classes that implement this interface. */
#define NS_DECL_NSIDOMXPATHRESULT \
  NS_IMETHOD GetResultType(PRUint16 *aResultType); \
  NS_IMETHOD GetNumberValue(double *aNumberValue); \
  NS_IMETHOD GetStringValue(nsAString & aStringValue); \
  NS_IMETHOD GetBooleanValue(PRBool *aBooleanValue); \
  NS_IMETHOD GetSingleNodeValue(nsIDOMNode * *aSingleNodeValue); \
  NS_IMETHOD GetInvalidIteratorState(PRBool *aInvalidIteratorState); \
  NS_IMETHOD GetSnapshotLength(PRUint32 *aSnapshotLength); \
  NS_IMETHOD IterateNext(nsIDOMNode **_retval); \
  NS_IMETHOD SnapshotItem(PRUint32 index, nsIDOMNode **_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDOMXPATHRESULT(_to) \
  NS_IMETHOD GetResultType(PRUint16 *aResultType) { return _to GetResultType(aResultType); } \
  ...
  NS_IMETHOD GetBooleanValue(PRBool *aBooleanValue) { return _to GetBooleanValue(aBooleanValue); } \
  NS_IMETHOD GetSingleNodeValue(nsIDOMNode * *aSingleNodeValue) { return _to GetSingleNodeValue(aSingleNodeValue); } \
  NS_IMETHOD GetInvalidIteratorState(PRBool *aInvalidIteratorState) { return _to GetInvalidIteratorState(aInvalidIteratorState); } \
  NS_IMETHOD GetSnapshotLength(PRUint32 *aSnapshotLength) { return _to GetSnapshotLength(aSnapshotLength); } \
  NS_IMETHOD IterateNext(nsIDOMNode **_retval) { return _to IterateNext(_retval); } \
  NS_IMETHOD SnapshotItem(PRUint32 index, nsIDOMNode **_retval) { return _to SnapshotItem(index, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDOMXPATHRESULT(_to) \
  NS_IMETHOD GetResultType(PRUint16 *aResultType) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetResultType(aResultType); } \
  ...
  NS_IMETHOD GetBooleanValue(PRBool *aBooleanValue) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetBooleanValue(aBooleanValue); } \
  ...
  NS_IMETHOD GetInvalidIteratorState(PRBool *aInvalidIteratorState) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetInvalidIteratorState(aInvalidIteratorState); } \
  NS_IMETHOD GetSnapshotLength(PRUint32 *aSnapshotLength) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetSnapshotLength(aSnapshotLength); } \
  NS_IMETHOD IterateNext(nsIDOMNode **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->IterateNext(_retval); } \
  NS_IMETHOD SnapshotItem(PRUint32 index, nsIDOMNode **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->SnapshotItem(index, _retval); } 
...
/* nsIDOMNode snapshotItem (in unsigned long index)  raises (XPathException); */
NS_IMETHODIMP nsDOMXPathResult::SnapshotItem(PRUint32 index, nsIDOMNode **_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
