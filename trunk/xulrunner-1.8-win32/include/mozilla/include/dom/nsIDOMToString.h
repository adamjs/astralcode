/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/dom/public/idl/storage/nsIDOMToString.idl
 */
 ...
 */
class NS_NO_VTABLE nsIDOMToString : public nsISupports {
 public: 

  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IDOMTOSTRING_IID)
...
/* DOMString toString (); */
NS_IMETHODIMP nsDOMToString::ToString(nsAString & _retval)
{
