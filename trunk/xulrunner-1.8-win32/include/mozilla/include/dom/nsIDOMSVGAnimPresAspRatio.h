/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/dom/public/idl/svg/nsIDOMSVGAnimPresAspRatio.idl
 */
...
class NS_NO_VTABLE nsIDOMSVGAnimatedPreserveAspectRatio : public nsISupports {
 public: 

  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IDOMSVGANIMATEDPRESERVEASPECTRATIO_IID)

  /* readonly attribute nsIDOMSVGPreserveAspectRatio baseVal; */
  NS_IMETHOD GetBaseVal(nsIDOMSVGPreserveAspectRatio * *aBaseVal) = 0;

  /* readonly attribute nsIDOMSVGPreserveAspectRatio animVal; */
  NS_IMETHOD GetAnimVal(nsIDOMSVGPreserveAspectRatio * *aAnimVal) = 0;
...
#define NS_FORWARD_NSIDOMSVGANIMATEDPRESERVEASPECTRATIO(_to) \
  NS_IMETHOD GetBaseVal(nsIDOMSVGPreserveAspectRatio * *aBaseVal) { return _to GetBaseVal(aBaseVal); } \
  NS_IMETHOD GetAnimVal(nsIDOMSVGPreserveAspectRatio * *aAnimVal) { return _to GetAnimVal(aAnimVal); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDOMSVGANIMATEDPRESERVEASPECTRATIO(_to) \
  NS_IMETHOD GetBaseVal(nsIDOMSVGPreserveAspectRatio * *aBaseVal) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetBaseVal(aBaseVal); } \
  NS_IMETHOD GetAnimVal(nsIDOMSVGPreserveAspectRatio * *aAnimVal) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetAnimVal(aAnimVal); } 
