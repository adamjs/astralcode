/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/dom/public/idl/ls/nsIDOMLSException.idl
 */
...
class NS_NO_VTABLE nsIDOMLSException : public nsISupports {
 public: 

  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IDOMLSEXCEPTION_IID)
