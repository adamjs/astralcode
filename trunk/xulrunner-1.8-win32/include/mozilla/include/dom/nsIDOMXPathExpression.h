/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/dom/public/idl/xpath/nsIDOMXPathExpression.idl
 */
...
class NS_NO_VTABLE nsIDOMXPathExpression : public nsISupports {
 public: 

  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IDOMXPATHEXPRESSION_IID)
  ...
  NS_IMETHOD Evaluate(nsIDOMNode *contextNode, PRUint16 type, nsISupports *result, nsISupports **_retval) = 0;

};

/* Use this macro when declaring classes that implement this interface. */
#define NS_DECL_NSIDOMXPATHEXPRESSION \
  NS_IMETHOD Evaluate(nsIDOMNode *contextNode, PRUint16 type, nsISupports *result, nsISupports **_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDOMXPATHEXPRESSION(_to) \
  NS_IMETHOD Evaluate(nsIDOMNode *contextNode, PRUint16 type, nsISupports *result, nsISupports **_retval) { return _to Evaluate(contextNode, type, result, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDOMXPATHEXPRESSION(_to) \
  NS_IMETHOD Evaluate(nsIDOMNode *contextNode, PRUint16 type, nsISupports *result, nsISupports **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Evaluate(contextNode, type, result, _retval); } 
...
/* nsISupports evaluate (in nsIDOMNode contextNode, in unsigned short type, in nsISupports result)  raises (XPathException, DOMException); */
NS_IMETHODIMP nsDOMXPathExpression::Evaluate(nsIDOMNode *contextNode, PRUint16 type, nsISupports *result, nsISupports **_retval)
{
