/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/dom/public/idl/base/nsIDOMLocation.idl
 */
...
class NS_NO_VTABLE nsIDOMLocation : public nsISupports {
 public: 
  ...
  NS_IMETHOD Reload(PRBool forceget) = 0;
...
#define NS_DECL_NSIDOMLOCATION \
  ...
  NS_IMETHOD Reload(PRBool forceget); \
  NS_IMETHOD Replace(const nsAString & url); \
  NS_IMETHOD Assign(const nsAString & url); \
...
#define NS_FORWARD_NSIDOMLOCATION(_to) \
  ...
  NS_IMETHOD Reload(PRBool forceget) { return _to Reload(forceget); } \
  NS_IMETHOD Replace(const nsAString & url) { return _to Replace(url); } \
  NS_IMETHOD Assign(const nsAString & url) { return _to Assign(url); } \
...
#define NS_FORWARD_SAFE_NSIDOMLOCATION(_to) \
  ...
  NS_IMETHOD Reload(PRBool forceget) { return !_to ? NS_ERROR_NULL_POINTER : _to->Reload(forceget); } \
  NS_IMETHOD Replace(const nsAString & url) { return !_to ? NS_ERROR_NULL_POINTER : _to->Replace(url); } \
  NS_IMETHOD Assign(const nsAString & url) { return !_to ? NS_ERROR_NULL_POINTER : _to->Assign(url); } \
