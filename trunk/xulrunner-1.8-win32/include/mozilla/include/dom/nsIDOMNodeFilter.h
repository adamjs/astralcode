/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/dom/public/idl/traversal/nsIDOMNodeFilter.idl
 */
...
class NS_NO_VTABLE nsIDOMNodeFilter : public nsISupports {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IDOMNODEFILTER_IID)
  ...
  NS_IMETHOD AcceptNode(nsIDOMNode *n, PRInt16 *_retval) = 0;

};

/* Use this macro when declaring classes that implement this interface. */
#define NS_DECL_NSIDOMNODEFILTER \
  NS_IMETHOD AcceptNode(nsIDOMNode *n, PRInt16 *_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDOMNODEFILTER(_to) \
  NS_IMETHOD AcceptNode(nsIDOMNode *n, PRInt16 *_retval) { return _to AcceptNode(n, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDOMNODEFILTER(_to) \
  NS_IMETHOD AcceptNode(nsIDOMNode *n, PRInt16 *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->AcceptNode(n, _retval); } 
...
/* short acceptNode (in nsIDOMNode n); */
NS_IMETHODIMP nsDOMNodeFilter::AcceptNode(nsIDOMNode *n, PRInt16 *_retval)
{
