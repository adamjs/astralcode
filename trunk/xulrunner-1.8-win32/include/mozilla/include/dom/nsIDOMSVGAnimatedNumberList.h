/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/dom/public/idl/svg/nsIDOMSVGAnimatedNumberList.idl
 */
...
class NS_NO_VTABLE nsIDOMSVGAnimatedNumberList : public nsISupports {
 public: 

  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IDOMSVGANIMATEDNUMBERLIST_IID)

  /* readonly attribute nsIDOMSVGNumberList baseVal; */
  NS_IMETHOD GetBaseVal(nsIDOMSVGNumberList * *aBaseVal) = 0;

  /* readonly attribute nsIDOMSVGNumberList animVal; */
  NS_IMETHOD GetAnimVal(nsIDOMSVGNumberList * *aAnimVal) = 0;

};

/* Use this macro when declaring classes that implement this interface. */
#define NS_DECL_NSIDOMSVGANIMATEDNUMBERLIST \
  NS_IMETHOD GetBaseVal(nsIDOMSVGNumberList * *aBaseVal); \
  NS_IMETHOD GetAnimVal(nsIDOMSVGNumberList * *aAnimVal); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDOMSVGANIMATEDNUMBERLIST(_to) \
  NS_IMETHOD GetBaseVal(nsIDOMSVGNumberList * *aBaseVal) { return _to GetBaseVal(aBaseVal); } \
  NS_IMETHOD GetAnimVal(nsIDOMSVGNumberList * *aAnimVal) { return _to GetAnimVal(aAnimVal); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDOMSVGANIMATEDNUMBERLIST(_to) \
  NS_IMETHOD GetBaseVal(nsIDOMSVGNumberList * *aBaseVal) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetBaseVal(aBaseVal); } \
  NS_IMETHOD GetAnimVal(nsIDOMSVGNumberList * *aAnimVal) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetAnimVal(aAnimVal); } 
