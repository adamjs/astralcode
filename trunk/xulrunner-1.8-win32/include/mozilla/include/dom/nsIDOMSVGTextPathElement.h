/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/dom/public/idl/svg/nsIDOMSVGTextPathElement.idl
 */
...
class NS_NO_VTABLE nsIDOMSVGTextPathElement : public nsIDOMSVGTextContentElement {
 public: 

  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IDOMSVGTEXTPATHELEMENT_IID)
  ...
  NS_IMETHOD GetStartOffset(nsIDOMSVGAnimatedLength * *aStartOffset) = 0;

  /* readonly attribute nsIDOMSVGAnimatedEnumeration method; */
  NS_IMETHOD GetMethod(nsIDOMSVGAnimatedEnumeration * *aMethod) = 0;

  /* readonly attribute nsIDOMSVGAnimatedEnumeration spacing; */
  NS_IMETHOD GetSpacing(nsIDOMSVGAnimatedEnumeration * *aSpacing) = 0;

};

/* Use this macro when declaring classes that implement this interface. */
#define NS_DECL_NSIDOMSVGTEXTPATHELEMENT \
  NS_IMETHOD GetStartOffset(nsIDOMSVGAnimatedLength * *aStartOffset); \
  NS_IMETHOD GetMethod(nsIDOMSVGAnimatedEnumeration * *aMethod); \
  NS_IMETHOD GetSpacing(nsIDOMSVGAnimatedEnumeration * *aSpacing); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDOMSVGTEXTPATHELEMENT(_to) \
  NS_IMETHOD GetStartOffset(nsIDOMSVGAnimatedLength * *aStartOffset) { return _to GetStartOffset(aStartOffset); } \
  NS_IMETHOD GetMethod(nsIDOMSVGAnimatedEnumeration * *aMethod) { return _to GetMethod(aMethod); } \
  NS_IMETHOD GetSpacing(nsIDOMSVGAnimatedEnumeration * *aSpacing) { return _to GetSpacing(aSpacing); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDOMSVGTEXTPATHELEMENT(_to) \
  NS_IMETHOD GetStartOffset(nsIDOMSVGAnimatedLength * *aStartOffset) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetStartOffset(aStartOffset); } \
  NS_IMETHOD GetMethod(nsIDOMSVGAnimatedEnumeration * *aMethod) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetMethod(aMethod); } \
  NS_IMETHOD GetSpacing(nsIDOMSVGAnimatedEnumeration * *aSpacing) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetSpacing(aSpacing); } 
