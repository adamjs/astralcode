/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/dom/public/idl/xul/nsIDOMXULDescriptionElement.idl
 */
...
class NS_NO_VTABLE nsIDOMXULDescriptionElement : public nsIDOMXULElement {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IDOMXULDESCRIPTIONELEMENT_IID)
  ...
  NS_IMETHOD GetCrop(PRBool *aCrop) = 0;
  NS_IMETHOD SetCrop(PRBool aCrop) = 0;
...
#define NS_DECL_NSIDOMXULDESCRIPTIONELEMENT \
  ...
  NS_IMETHOD GetCrop(PRBool *aCrop); \
  NS_IMETHOD SetCrop(PRBool aCrop); \
...
#define NS_FORWARD_NSIDOMXULDESCRIPTIONELEMENT(_to) \
  ...
  NS_IMETHOD GetCrop(PRBool *aCrop) { return _to GetCrop(aCrop); } \
  NS_IMETHOD SetCrop(PRBool aCrop) { return _to SetCrop(aCrop); } \
...
#define NS_FORWARD_SAFE_NSIDOMXULDESCRIPTIONELEMENT(_to) \
  ...
  NS_IMETHOD GetCrop(PRBool *aCrop) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetCrop(aCrop); } \
  NS_IMETHOD SetCrop(PRBool aCrop) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetCrop(aCrop); } \
