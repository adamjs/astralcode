/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/dom/public/idl/svg/nsIDOMSVGAnimatedNumber.idl
 */
...
class NS_NO_VTABLE nsIDOMSVGAnimatedNumber : public nsISupports {
 public: 

  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IDOMSVGANIMATEDNUMBER_IID)

  /* attribute float baseVal; */
  NS_IMETHOD GetBaseVal(float *aBaseVal) = 0;
  NS_IMETHOD SetBaseVal(float aBaseVal) = 0;

  /* readonly attribute float animVal; */
  NS_IMETHOD GetAnimVal(float *aAnimVal) = 0;

};

/* Use this macro when declaring classes that implement this interface. */
#define NS_DECL_NSIDOMSVGANIMATEDNUMBER \
  NS_IMETHOD GetBaseVal(float *aBaseVal); \
  NS_IMETHOD SetBaseVal(float aBaseVal); \
  NS_IMETHOD GetAnimVal(float *aAnimVal); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDOMSVGANIMATEDNUMBER(_to) \
  NS_IMETHOD GetBaseVal(float *aBaseVal) { return _to GetBaseVal(aBaseVal); } \
  NS_IMETHOD SetBaseVal(float aBaseVal) { return _to SetBaseVal(aBaseVal); } \
  NS_IMETHOD GetAnimVal(float *aAnimVal) { return _to GetAnimVal(aAnimVal); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDOMSVGANIMATEDNUMBER(_to) \
  NS_IMETHOD GetBaseVal(float *aBaseVal) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetBaseVal(aBaseVal); } \
  NS_IMETHOD SetBaseVal(float aBaseVal) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetBaseVal(aBaseVal); } \
  NS_IMETHOD GetAnimVal(float *aAnimVal) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetAnimVal(aAnimVal); } 
