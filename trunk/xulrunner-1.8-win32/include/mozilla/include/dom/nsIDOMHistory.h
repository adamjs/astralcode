/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/dom/public/idl/base/nsIDOMHistory.idl
 */
...
class NS_NO_VTABLE nsIDOMHistory : public nsISupports {
 public: 
  ...
  NS_IMETHOD Go(PRInt32 aDelta) = 0;
...
#define NS_FORWARD_NSIDOMHISTORY(_to) \
  ...
  NS_IMETHOD Go(PRInt32 aDelta) { return _to Go(aDelta); } \
...
#define NS_FORWARD_SAFE_NSIDOMHISTORY(_to) \
  ...
  NS_IMETHOD Go(PRInt32 aDelta) { return !_to ? NS_ERROR_NULL_POINTER : _to->Go(aDelta); } \
...
/* DOMString item (in unsigned long index); */
NS_IMETHODIMP nsDOMHistory::Item(PRUint32 index, nsAString & _retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
