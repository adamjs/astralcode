/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/dom/public/idl/svg/nsIDOMSVGDocument.idl
 */
...
class NS_NO_VTABLE nsIDOMSVGDocument : public nsIDOMDocument {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IDOMSVGDOCUMENT_IID)
  ...
  NS_IMETHOD GetRootElement(nsIDOMSVGSVGElement * *aRootElement) = 0;
...
#define NS_DECL_NSIDOMSVGDOCUMENT \
  ...
  NS_IMETHOD GetRootElement(nsIDOMSVGSVGElement * *aRootElement); 
...
#define NS_FORWARD_NSIDOMSVGDOCUMENT(_to) \
  ...
  NS_IMETHOD GetRootElement(nsIDOMSVGSVGElement * *aRootElement) { return _to GetRootElement(aRootElement); } 
...
#define NS_FORWARD_SAFE_NSIDOMSVGDOCUMENT(_to) \
  ...
  NS_IMETHOD GetRootElement(nsIDOMSVGSVGElement * *aRootElement) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetRootElement(aRootElement); } 
