/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/netwerk/base/public/nsIMultiPartChannel.idl
 */
...
class NS_NO_VTABLE nsIMultiPartChannel : public nsISupports {
 public: 
  ...
  NS_IMETHOD GetPartID(PRUint32 *aPartID) = 0;
  ...
  NS_IMETHOD GetIsLastPart(PRBool *aIsLastPart) = 0;
...
#define NS_DECL_NSIMULTIPARTCHANNEL \
  ...
  NS_IMETHOD GetPartID(PRUint32 *aPartID); \
  NS_IMETHOD GetIsLastPart(PRBool *aIsLastPart); 
...
#define NS_FORWARD_NSIMULTIPARTCHANNEL(_to) \
  ...
  NS_IMETHOD GetPartID(PRUint32 *aPartID) { return _to GetPartID(aPartID); } \
  NS_IMETHOD GetIsLastPart(PRBool *aIsLastPart) { return _to GetIsLastPart(aIsLastPart); } 
...
#define NS_FORWARD_SAFE_NSIMULTIPARTCHANNEL(_to) \
  ...
  NS_IMETHOD GetPartID(PRUint32 *aPartID) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetPartID(aPartID); } \
  NS_IMETHOD GetIsLastPart(PRBool *aIsLastPart) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetIsLastPart(aIsLastPart); } 
