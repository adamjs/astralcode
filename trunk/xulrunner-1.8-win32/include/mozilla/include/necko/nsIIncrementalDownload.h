/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/netwerk/base/public/nsIIncrementalDownload.idl
 */
...
class NS_NO_VTABLE nsIIncrementalDownload : public nsIRequest {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IINCREMENTALDOWNLOAD_IID)
  ...
  NS_IMETHOD Init(nsIURI *uri, nsIFile *destination, PRInt32 chunkSize, PRInt32 intervalInSeconds) = 0;
  ...
  NS_IMETHOD GetCurrentSize(PRInt64 *aCurrentSize) = 0;
...
#define NS_DECL_NSIINCREMENTALDOWNLOAD \
  NS_IMETHOD Init(nsIURI *uri, nsIFile *destination, PRInt32 chunkSize, PRInt32 intervalInSeconds); \
  ...
  NS_IMETHOD GetCurrentSize(PRInt64 *aCurrentSize); \
...
#define NS_FORWARD_NSIINCREMENTALDOWNLOAD(_to) \
  NS_IMETHOD Init(nsIURI *uri, nsIFile *destination, PRInt32 chunkSize, PRInt32 intervalInSeconds) { return _to Init(uri, destination, chunkSize, intervalInSeconds); } \
  ...
  NS_IMETHOD GetCurrentSize(PRInt64 *aCurrentSize) { return _to GetCurrentSize(aCurrentSize); } \
...
#define NS_FORWARD_SAFE_NSIINCREMENTALDOWNLOAD(_to) \
  NS_IMETHOD Init(nsIURI *uri, nsIFile *destination, PRInt32 chunkSize, PRInt32 intervalInSeconds) { return !_to ? NS_ERROR_NULL_POINTER : _to->Init(uri, destination, chunkSize, intervalInSeconds); } \
  ...
  NS_IMETHOD GetCurrentSize(PRInt64 *aCurrentSize) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetCurrentSize(aCurrentSize); } \
