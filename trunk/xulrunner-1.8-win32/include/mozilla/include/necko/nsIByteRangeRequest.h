/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/netwerk/base/public/nsIByteRangeRequest.idl
 */
...
#define NS_DECL_NSIBYTERANGEREQUEST \
  ...
  NS_IMETHOD GetStartRange(PRInt64 *aStartRange); \
  NS_IMETHOD GetEndRange(PRInt64 *aEndRange); 
...
#define NS_FORWARD_NSIBYTERANGEREQUEST(_to) \
  ...
  NS_IMETHOD GetStartRange(PRInt64 *aStartRange) { return _to GetStartRange(aStartRange); } \
  NS_IMETHOD GetEndRange(PRInt64 *aEndRange) { return _to GetEndRange(aEndRange); } 
...
#define NS_FORWARD_SAFE_NSIBYTERANGEREQUEST(_to) \
  ...
  NS_IMETHOD GetStartRange(PRInt64 *aStartRange) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetStartRange(aStartRange); } \
  NS_IMETHOD GetEndRange(PRInt64 *aEndRange) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetEndRange(aEndRange); } 
