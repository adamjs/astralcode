/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/netwerk/base/public/nsICryptoFIPSInfo.idl
 */
...
class NS_NO_VTABLE nsICryptoFIPSInfo : public nsISupports {
 public: 

  NS_DEFINE_STATIC_IID_ACCESSOR(NS_ICRYPTOFIPSINFO_IID)

  /* readonly attribute boolean isFIPSModeActive; */
  NS_IMETHOD GetIsFIPSModeActive(PRBool *aIsFIPSModeActive) = 0;

};

/* Use this macro when declaring classes that implement this interface. */
#define NS_DECL_NSICRYPTOFIPSINFO \
  NS_IMETHOD GetIsFIPSModeActive(PRBool *aIsFIPSModeActive); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSICRYPTOFIPSINFO(_to) \
  NS_IMETHOD GetIsFIPSModeActive(PRBool *aIsFIPSModeActive) { return _to GetIsFIPSModeActive(aIsFIPSModeActive); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSICRYPTOFIPSINFO(_to) \
  NS_IMETHOD GetIsFIPSModeActive(PRBool *aIsFIPSModeActive) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetIsFIPSModeActive(aIsFIPSModeActive); } 
