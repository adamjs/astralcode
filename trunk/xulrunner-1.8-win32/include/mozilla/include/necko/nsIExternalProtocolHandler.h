/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/netwerk/base/public/nsIExternalProtocolHandler.idl
 */
...
class NS_NO_VTABLE nsIExternalProtocolHandler : public nsIProtocolHandler {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IEXTERNALPROTOCOLHANDLER_IID)
  ...
  NS_IMETHOD ExternalAppExistsForScheme(const nsACString & scheme, PRBool *_retval) = 0;

};

/* Use this macro when declaring classes that implement this interface. */
#define NS_DECL_NSIEXTERNALPROTOCOLHANDLER \
  NS_IMETHOD ExternalAppExistsForScheme(const nsACString & scheme, PRBool *_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIEXTERNALPROTOCOLHANDLER(_to) \
  NS_IMETHOD ExternalAppExistsForScheme(const nsACString & scheme, PRBool *_retval) { return _to ExternalAppExistsForScheme(scheme, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIEXTERNALPROTOCOLHANDLER(_to) \
  NS_IMETHOD ExternalAppExistsForScheme(const nsACString & scheme, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->ExternalAppExistsForScheme(scheme, _retval); } 
...
/* boolean externalAppExistsForScheme (in ACString scheme); */
NS_IMETHODIMP nsExternalProtocolHandler::ExternalAppExistsForScheme(const nsACString & scheme, PRBool *_retval)
{
