/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/netwerk/base/public/nsIProxiedProtocolHandler.idl
 */
...
class NS_NO_VTABLE nsIProxiedProtocolHandler : public nsIProtocolHandler {
 public: 
  ...
  NS_IMETHOD NewProxiedChannel(nsIURI *uri, nsIProxyInfo *proxyInfo, nsIChannel **_retval) = 0;
...
#define NS_FORWARD_NSIPROXIEDPROTOCOLHANDLER(_to) \
  NS_IMETHOD NewProxiedChannel(nsIURI *uri, nsIProxyInfo *proxyInfo, nsIChannel **_retval) { return _to NewProxiedChannel(uri, proxyInfo, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIPROXIEDPROTOCOLHANDLER(_to) \
  NS_IMETHOD NewProxiedChannel(nsIURI *uri, nsIProxyInfo *proxyInfo, nsIChannel **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->NewProxiedChannel(uri, proxyInfo, _retval); } 
...
/* nsIChannel newProxiedChannel (in nsIURI uri, in nsIProxyInfo proxyInfo); */
NS_IMETHODIMP nsProxiedProtocolHandler::NewProxiedChannel(nsIURI *uri, nsIProxyInfo *proxyInfo, nsIChannel **_retval)
{
