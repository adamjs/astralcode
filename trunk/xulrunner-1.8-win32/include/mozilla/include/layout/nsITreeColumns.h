/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/layout/xul/base/src/tree/public/nsITreeColumns.idl
 */
...
#define NS_ITREECOLUMN_IID_STR "58a8574d-15a8-4678-99a5-e1be56104093"
...
class NS_NO_VTABLE nsITreeColumn : public nsISupports {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_ITREECOLUMN_IID)
  ...
  NS_IMETHOD GetCycler(PRBool *aCycler) = 0;

  /* readonly attribute boolean editable; */
  NS_IMETHOD GetEditable(PRBool *aEditable) = 0;
  ...
  NS_IMETHOD GetType(PRInt16 *aType) = 0;
...
#define NS_DECL_NSITREECOLUMN \
  ...
  NS_IMETHOD GetCycler(PRBool *aCycler); \
  NS_IMETHOD GetEditable(PRBool *aEditable); \
  NS_IMETHOD GetType(PRInt16 *aType); \
...
#define NS_FORWARD_NSITREECOLUMN(_to) \
  ...
  NS_IMETHOD GetCycler(PRBool *aCycler) { return _to GetCycler(aCycler); } \
  NS_IMETHOD GetEditable(PRBool *aEditable) { return _to GetEditable(aEditable); } \
  NS_IMETHOD GetType(PRInt16 *aType) { return _to GetType(aType); } \
...
#define NS_FORWARD_SAFE_NSITREECOLUMN(_to) \
  ...
  NS_IMETHOD GetCycler(PRBool *aCycler) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetCycler(aCycler); } \
  NS_IMETHOD GetEditable(PRBool *aEditable) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetEditable(aEditable); } \
  NS_IMETHOD GetType(PRInt16 *aType) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetType(aType); } \
...
#define NS_ITREECOLUMNS_IID_STR "fcc7b6b5-f7d7-4e57-abd1-080602deb21d"
...
class NS_NO_VTABLE nsITreeColumns : public nsISupports {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_ITREECOLUMNS_IID)
  ...
  NS_IMETHOD GetColumnAt(PRInt32 index, nsITreeColumn **_retval) = 0;
...
#define NS_DECL_NSITREECOLUMNS \
  ...
  NS_IMETHOD GetColumnAt(PRInt32 index, nsITreeColumn **_retval); \
...
#define NS_FORWARD_NSITREECOLUMNS(_to) \
  ...
  NS_IMETHOD GetColumnAt(PRInt32 index, nsITreeColumn **_retval) { return _to GetColumnAt(index, _retval); } \
...
#define NS_FORWARD_SAFE_NSITREECOLUMNS(_to) \
  ...
  NS_IMETHOD GetColumnAt(PRInt32 index, nsITreeColumn **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetColumnAt(index, _retval); } \
...
/* nsITreeColumn getColumnAt (in long index); */
NS_IMETHODIMP nsTreeColumns::GetColumnAt(PRInt32 index, nsITreeColumn **_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
