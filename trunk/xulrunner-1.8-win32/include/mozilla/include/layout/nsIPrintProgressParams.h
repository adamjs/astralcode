/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/layout/printing/nsIPrintProgressParams.idl
 */
...
class NS_NO_VTABLE nsIPrintProgressParams : public nsISupports {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IPRINTPROGRESSPARAMS_IID)

  /* attribute wstring docTitle; */
  NS_IMETHOD GetDocTitle(PRUnichar * *aDocTitle) = 0;
  NS_IMETHOD SetDocTitle(const PRUnichar * aDocTitle) = 0;
...
#define NS_DECL_NSIPRINTPROGRESSPARAMS \
  NS_IMETHOD GetDocTitle(PRUnichar * *aDocTitle); \
  NS_IMETHOD SetDocTitle(const PRUnichar * aDocTitle); \
...
#define NS_FORWARD_NSIPRINTPROGRESSPARAMS(_to) \
  NS_IMETHOD GetDocTitle(PRUnichar * *aDocTitle) { return _to GetDocTitle(aDocTitle); } \
  NS_IMETHOD SetDocTitle(const PRUnichar * aDocTitle) { return _to SetDocTitle(aDocTitle); } \
...
#define NS_FORWARD_SAFE_NSIPRINTPROGRESSPARAMS(_to) \
  NS_IMETHOD GetDocTitle(PRUnichar * *aDocTitle) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetDocTitle(aDocTitle); } \
  NS_IMETHOD SetDocTitle(const PRUnichar * aDocTitle) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetDocTitle(aDocTitle); } \
