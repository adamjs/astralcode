/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/layout/xul/base/public/nsIMenuBoxObject.idl
 */
...
class NS_NO_VTABLE nsIMenuBoxObject : public nsISupports {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IMENUBOXOBJECT_IID)

  /* void openMenu (in boolean openFlag); */
  NS_IMETHOD OpenMenu(PRBool openFlag) = 0;
  ...
  NS_IMETHOD HandleKeyPress(nsIDOMKeyEvent *keyEvent, PRBool *_retval) = 0;

};

/* Use this macro when declaring classes that implement this interface. */
#define NS_DECL_NSIMENUBOXOBJECT \
  NS_IMETHOD OpenMenu(PRBool openFlag); \
  NS_IMETHOD GetActiveChild(nsIDOMElement * *aActiveChild); \
  NS_IMETHOD SetActiveChild(nsIDOMElement * aActiveChild); \
  NS_IMETHOD HandleKeyPress(nsIDOMKeyEvent *keyEvent, PRBool *_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIMENUBOXOBJECT(_to) \
  NS_IMETHOD OpenMenu(PRBool openFlag) { return _to OpenMenu(openFlag); } \
  ...
  NS_IMETHOD HandleKeyPress(nsIDOMKeyEvent *keyEvent, PRBool *_retval) { return _to HandleKeyPress(keyEvent, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIMENUBOXOBJECT(_to) \
  NS_IMETHOD OpenMenu(PRBool openFlag) { return !_to ? NS_ERROR_NULL_POINTER : _to->OpenMenu(openFlag); } \
  ...
  NS_IMETHOD HandleKeyPress(nsIDOMKeyEvent *keyEvent, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->HandleKeyPress(keyEvent, _retval); } 
...
/* boolean handleKeyPress (in nsIDOMKeyEvent keyEvent); */
NS_IMETHODIMP nsMenuBoxObject::HandleKeyPress(nsIDOMKeyEvent *keyEvent, PRBool *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
