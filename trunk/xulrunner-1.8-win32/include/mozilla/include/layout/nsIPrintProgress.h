/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/layout/printing/nsIPrintProgress.idl
 */
...
class NS_NO_VTABLE nsIPrintProgress : public nsIWebProgressListener {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IPRINTPROGRESS_IID)
  ...
  NS_IMETHOD OpenProgressDialog(nsIDOMWindowInternal *parent, const char *dialogURL, nsISupports *parameters, nsIObserver *openDialogObserver, PRBool *notifyOnOpen) = 0;
...
#define NS_DECL_NSIPRINTPROGRESS \
  NS_IMETHOD OpenProgressDialog(nsIDOMWindowInternal *parent, const char *dialogURL, nsISupports *parameters, nsIObserver *openDialogObserver, PRBool *notifyOnOpen); \
...
#define NS_FORWARD_NSIPRINTPROGRESS(_to) \
  NS_IMETHOD OpenProgressDialog(nsIDOMWindowInternal *parent, const char *dialogURL, nsISupports *parameters, nsIObserver *openDialogObserver, PRBool *notifyOnOpen) { return _to OpenProgressDialog(parent, dialogURL, parameters, openDialogObserver, notifyOnOpen); } \
...
#define NS_FORWARD_SAFE_NSIPRINTPROGRESS(_to) \
  NS_IMETHOD OpenProgressDialog(nsIDOMWindowInternal *parent, const char *dialogURL, nsISupports *parameters, nsIObserver *openDialogObserver, PRBool *notifyOnOpen) { return !_to ? NS_ERROR_NULL_POINTER : _to->OpenProgressDialog(parent, dialogURL, parameters, openDialogObserver, notifyOnOpen); } \
