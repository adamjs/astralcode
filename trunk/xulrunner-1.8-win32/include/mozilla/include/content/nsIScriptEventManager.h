/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/content/base/public/nsIScriptEventManager.idl
 */
...
class NS_NO_VTABLE nsIScriptEventManager : public nsISupports {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_ISCRIPTEVENTMANAGER_IID)

  /* nsISupports FindEventHandler (in AString aObjectName, in AString aEventName, in unsigned long aArgCount); */
  NS_IMETHOD FindEventHandler(const nsAString & aObjectName, const nsAString & aEventName, PRUint32 aArgCount, nsISupports **_retval) = 0;
...
#define NS_DECL_NSISCRIPTEVENTMANAGER \
  NS_IMETHOD FindEventHandler(const nsAString & aObjectName, const nsAString & aEventName, PRUint32 aArgCount, nsISupports **_retval); \
...
#define NS_FORWARD_NSISCRIPTEVENTMANAGER(_to) \
  NS_IMETHOD FindEventHandler(const nsAString & aObjectName, const nsAString & aEventName, PRUint32 aArgCount, nsISupports **_retval) { return _to FindEventHandler(aObjectName, aEventName, aArgCount, _retval); } \
...
#define NS_FORWARD_SAFE_NSISCRIPTEVENTMANAGER(_to) \
  NS_IMETHOD FindEventHandler(const nsAString & aObjectName, const nsAString & aEventName, PRUint32 aArgCount, nsISupports **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->FindEventHandler(aObjectName, aEventName, aArgCount, _retval); } \
...
/* nsISupports FindEventHandler (in AString aObjectName, in AString aEventName, in unsigned long aArgCount); */
NS_IMETHODIMP nsScriptEventManager::FindEventHandler(const nsAString & aObjectName, const nsAString & aEventName, PRUint32 aArgCount, nsISupports **_retval)
{
