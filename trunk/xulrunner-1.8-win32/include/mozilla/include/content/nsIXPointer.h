/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/content/xml/document/public/nsIXPointer.idl
 */
 ...
 */
class NS_NO_VTABLE nsIXPointerResult : public nsISupports {
 public: 

  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IXPOINTERRESULT_IID)

  /* nsIDOMRange item (in unsigned long index); */
  NS_IMETHOD Item(PRUint32 index, nsIDOMRange **_retval) = 0;
...
#define NS_DECL_NSIXPOINTERRESULT \
  NS_IMETHOD Item(PRUint32 index, nsIDOMRange **_retval); \
  NS_IMETHOD GetLength(PRUint32 *aLength); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIXPOINTERRESULT(_to) \
  NS_IMETHOD Item(PRUint32 index, nsIDOMRange **_retval) { return _to Item(index, _retval); } \
  NS_IMETHOD GetLength(PRUint32 *aLength) { return _to GetLength(aLength); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIXPOINTERRESULT(_to) \
  NS_IMETHOD Item(PRUint32 index, nsIDOMRange **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Item(index, _retval); } \
...
/* nsIDOMRange item (in unsigned long index); */
NS_IMETHODIMP nsXPointerResult::Item(PRUint32 index, nsIDOMRange **_retval)
{
...
class NS_NO_VTABLE nsIXPointerSchemeContext : public nsISupports {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IXPOINTERSCHEMECONTEXT_IID)
  ...
  NS_IMETHOD GetSchemeData(PRUint32 index, nsAString & scheme, nsAString & data) = 0;
...
#define NS_DECL_NSIXPOINTERSCHEMECONTEXT \
  ...
  NS_IMETHOD GetSchemeData(PRUint32 index, nsAString & scheme, nsAString & data); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIXPOINTERSCHEMECONTEXT(_to) \
  NS_IMETHOD GetCount(PRUint32 *aCount) { return _to GetCount(aCount); } \
  NS_IMETHOD GetSchemeData(PRUint32 index, nsAString & scheme, nsAString & data) { return _to GetSchemeData(index, scheme, data); } 
...
#define NS_FORWARD_SAFE_NSIXPOINTERSCHEMECONTEXT(_to) \
  ...
  NS_IMETHOD GetSchemeData(PRUint32 index, nsAString & scheme, nsAString & data) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetSchemeData(index, scheme, data); } 
...
/* void getSchemeData (in unsigned long index, out DOMString scheme, out DOMString data); */
NS_IMETHODIMP nsXPointerSchemeContext::GetSchemeData(PRUint32 index, nsAString & scheme, nsAString & data)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
class NS_NO_VTABLE nsIXPointerSchemeProcessor : public nsISupports {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IXPOINTERSCHEMEPROCESSOR_IID)
  ...
  NS_IMETHOD Evaluate(nsIDOMDocument *aDocument, nsIXPointerSchemeContext *aContext, const nsAString & aData, nsIXPointerResult **_retval) = 0;

};

/* Use this macro when declaring classes that implement this interface. */
#define NS_DECL_NSIXPOINTERSCHEMEPROCESSOR \
  NS_IMETHOD Evaluate(nsIDOMDocument *aDocument, nsIXPointerSchemeContext *aContext, const nsAString & aData, nsIXPointerResult **_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIXPOINTERSCHEMEPROCESSOR(_to) \
  NS_IMETHOD Evaluate(nsIDOMDocument *aDocument, nsIXPointerSchemeContext *aContext, const nsAString & aData, nsIXPointerResult **_retval) { return _to Evaluate(aDocument, aContext, aData, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIXPOINTERSCHEMEPROCESSOR(_to) \
  NS_IMETHOD Evaluate(nsIDOMDocument *aDocument, nsIXPointerSchemeContext *aContext, const nsAString & aData, nsIXPointerResult **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Evaluate(aDocument, aContext, aData, _retval); } 
...
/* nsIXPointerResult evaluate (in nsIDOMDocument aDocument, in nsIXPointerSchemeContext aContext, in DOMString aData); */
NS_IMETHODIMP nsXPointerSchemeProcessor::Evaluate(nsIDOMDocument *aDocument, nsIXPointerSchemeContext *aContext, const nsAString & aData, nsIXPointerResult **_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
class NS_NO_VTABLE nsIXPointerEvaluator : public nsISupports {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IXPOINTEREVALUATOR_IID)
  ...
  NS_IMETHOD Evaluate(nsIDOMDocument *aDocument, const nsAString & aExpression, nsIXPointerResult **_retval) = 0;

};

/* Use this macro when declaring classes that implement this interface. */
#define NS_DECL_NSIXPOINTEREVALUATOR \
  NS_IMETHOD Evaluate(nsIDOMDocument *aDocument, const nsAString & aExpression, nsIXPointerResult **_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIXPOINTEREVALUATOR(_to) \
  NS_IMETHOD Evaluate(nsIDOMDocument *aDocument, const nsAString & aExpression, nsIXPointerResult **_retval) { return _to Evaluate(aDocument, aExpression, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIXPOINTEREVALUATOR(_to) \
  NS_IMETHOD Evaluate(nsIDOMDocument *aDocument, const nsAString & aExpression, nsIXPointerResult **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Evaluate(aDocument, aExpression, _retval); } 
...
/* nsIXPointerResult evaluate (in nsIDOMDocument aDocument, in DOMString aExpression); */
NS_IMETHODIMP nsXPointerEvaluator::Evaluate(nsIDOMDocument *aDocument, const nsAString & aExpression, nsIXPointerResult **_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
