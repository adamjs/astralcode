/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/content/base/public/nsIDragDropHandler.idl
 */
 ...
 */
class NS_NO_VTABLE nsIDragDropHandler : public nsISupports {
 public: 

  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IDRAGDROPHANDLER_IID)
  ...
  NS_IMETHOD HookupTo(nsIDOMEventTarget *attachPoint, nsIWebNavigation *navigator) = 0;
...
#define NS_DECL_NSIDRAGDROPHANDLER \
  NS_IMETHOD HookupTo(nsIDOMEventTarget *attachPoint, nsIWebNavigation *navigator); \
  NS_IMETHOD Detach(void); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDRAGDROPHANDLER(_to) \
  NS_IMETHOD HookupTo(nsIDOMEventTarget *attachPoint, nsIWebNavigation *navigator) { return _to HookupTo(attachPoint, navigator); } \
  NS_IMETHOD Detach(void) { return _to Detach(); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDRAGDROPHANDLER(_to) \
  NS_IMETHOD HookupTo(nsIDOMEventTarget *attachPoint, nsIWebNavigation *navigator) { return !_to ? NS_ERROR_NULL_POINTER : _to->HookupTo(attachPoint, navigator); } \
