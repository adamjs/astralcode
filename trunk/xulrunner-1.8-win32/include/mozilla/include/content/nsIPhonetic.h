/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/content/html/content/public/nsIPhonetic.idl
 */
...
class NS_NO_VTABLE nsIPhonetic : public nsISupports {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IPHONETIC_IID)
...
#define NS_DECL_NSIPHONETIC \
  NS_IMETHOD GetPhonetic(nsAString & aPhonetic); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIPHONETIC(_to) \
  NS_IMETHOD GetPhonetic(nsAString & aPhonetic) { return _to GetPhonetic(aPhonetic); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIPHONETIC(_to) \
  NS_IMETHOD GetPhonetic(nsAString & aPhonetic) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetPhonetic(aPhonetic); } 
