/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/content/xsl/public/nsIXSLTException.idl
 */
...
class NS_NO_VTABLE nsIXSLTException : public nsIException {
 public: 

  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IXSLTEXCEPTION_IID)

  /**
     * The node in the stylesheet that triggered the exception.
     */
  /* readonly attribute nsIDOMNode styleNode; */
  NS_IMETHOD GetStyleNode(nsIDOMNode * *aStyleNode) = 0;
...
#define NS_DECL_NSIXSLTEXCEPTION \
  NS_IMETHOD GetStyleNode(nsIDOMNode * *aStyleNode); \
  NS_IMETHOD GetSourceNode(nsIDOMNode * *aSourceNode); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIXSLTEXCEPTION(_to) \
  NS_IMETHOD GetStyleNode(nsIDOMNode * *aStyleNode) { return _to GetStyleNode(aStyleNode); } \
...
#define NS_FORWARD_SAFE_NSIXSLTEXCEPTION(_to) \
  NS_IMETHOD GetStyleNode(nsIDOMNode * *aStyleNode) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetStyleNode(aStyleNode); } \
