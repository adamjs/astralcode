/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/content/base/public/nsISelectionListener.idl
 */
...
class NS_NO_VTABLE nsISelectionListener : public nsISupports {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_ISELECTIONLISTENER_IID)
  ...
  NS_IMETHOD NotifySelectionChanged(nsIDOMDocument *doc, nsISelection *sel, PRInt16 reason) = 0;

};

/* Use this macro when declaring classes that implement this interface. */
#define NS_DECL_NSISELECTIONLISTENER \
  NS_IMETHOD NotifySelectionChanged(nsIDOMDocument *doc, nsISelection *sel, PRInt16 reason); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSISELECTIONLISTENER(_to) \
  NS_IMETHOD NotifySelectionChanged(nsIDOMDocument *doc, nsISelection *sel, PRInt16 reason) { return _to NotifySelectionChanged(doc, sel, reason); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSISELECTIONLISTENER(_to) \
  NS_IMETHOD NotifySelectionChanged(nsIDOMDocument *doc, nsISelection *sel, PRInt16 reason) { return !_to ? NS_ERROR_NULL_POINTER : _to->NotifySelectionChanged(doc, sel, reason); } 
