/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/content/xtf/public/nsIXMLContentBuilder.idl
 */
...
class NS_NO_VTABLE nsIXMLContentBuilder : public nsISupports {
 public: 

  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IXMLCONTENTBUILDER_IID)

  /* void clear (in nsIDOMElement root); */
  NS_IMETHOD Clear(nsIDOMElement *root) = 0;

  /* void setDocument (in nsIDOMDocument doc); */
  NS_IMETHOD SetDocument(nsIDOMDocument *doc) = 0;

  /* void setElementNamespace (in AString ns); */
  NS_IMETHOD SetElementNamespace(const nsAString & ns) = 0;

  /* void beginElement (in AString tagname); */
  NS_IMETHOD BeginElement(const nsAString & tagname) = 0;

  /* void endElement (); */
  NS_IMETHOD EndElement(void) = 0;

  /* void attrib (in AString name, in AString value); */
  NS_IMETHOD Attrib(const nsAString & name, const nsAString & value) = 0;

  /* void textNode (in AString text); */
  NS_IMETHOD TextNode(const nsAString & text) = 0;
...
#define NS_DECL_NSIXMLCONTENTBUILDER \
  NS_IMETHOD Clear(nsIDOMElement *root); \
  NS_IMETHOD SetDocument(nsIDOMDocument *doc); \
  NS_IMETHOD SetElementNamespace(const nsAString & ns); \
  NS_IMETHOD BeginElement(const nsAString & tagname); \
  NS_IMETHOD EndElement(void); \
  NS_IMETHOD Attrib(const nsAString & name, const nsAString & value); \
  NS_IMETHOD TextNode(const nsAString & text); \
...
#define NS_FORWARD_NSIXMLCONTENTBUILDER(_to) \
  NS_IMETHOD Clear(nsIDOMElement *root) { return _to Clear(root); } \
  NS_IMETHOD SetDocument(nsIDOMDocument *doc) { return _to SetDocument(doc); } \
  NS_IMETHOD SetElementNamespace(const nsAString & ns) { return _to SetElementNamespace(ns); } \
  NS_IMETHOD BeginElement(const nsAString & tagname) { return _to BeginElement(tagname); } \
  NS_IMETHOD EndElement(void) { return _to EndElement(); } \
  NS_IMETHOD Attrib(const nsAString & name, const nsAString & value) { return _to Attrib(name, value); } \
  NS_IMETHOD TextNode(const nsAString & text) { return _to TextNode(text); } \
...
#define NS_FORWARD_SAFE_NSIXMLCONTENTBUILDER(_to) \
  NS_IMETHOD Clear(nsIDOMElement *root) { return !_to ? NS_ERROR_NULL_POINTER : _to->Clear(root); } \
  NS_IMETHOD SetDocument(nsIDOMDocument *doc) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetDocument(doc); } \
  NS_IMETHOD SetElementNamespace(const nsAString & ns) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetElementNamespace(ns); } \
  NS_IMETHOD BeginElement(const nsAString & tagname) { return !_to ? NS_ERROR_NULL_POINTER : _to->BeginElement(tagname); } \
  NS_IMETHOD EndElement(void) { return !_to ? NS_ERROR_NULL_POINTER : _to->EndElement(); } \
  NS_IMETHOD Attrib(const nsAString & name, const nsAString & value) { return !_to ? NS_ERROR_NULL_POINTER : _to->Attrib(name, value); } \
  NS_IMETHOD TextNode(const nsAString & text) { return !_to ? NS_ERROR_NULL_POINTER : _to->TextNode(text); } \
  NS_IMETHOD GetRoot(nsIDOMElement * *aRoot) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetRoot(aRoot); } \
  NS_IMETHOD GetCurrent(nsIDOMElement * *aCurrent) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetCurrent(aCurrent); } 
