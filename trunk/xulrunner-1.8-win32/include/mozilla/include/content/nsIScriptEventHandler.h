/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/content/base/public/nsIScriptEventHandler.idl
 */
...
class NS_NO_VTABLE nsIScriptEventHandler : public nsISupports {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_ISCRIPTEVENTHANDLER_IID)
  ...
  */
  ...
  NS_IMETHOD IsSameEvent(const nsAString & aObjectName, const nsAString & aEventName, PRUint32 aArgCount, PRBool *_retval) = 0;
...
#define NS_DECL_NSISCRIPTEVENTHANDLER \
  NS_IMETHOD IsSameEvent(const nsAString & aObjectName, const nsAString & aEventName, PRUint32 aArgCount, PRBool *_retval); \
...
#define NS_FORWARD_NSISCRIPTEVENTHANDLER(_to) \
  NS_IMETHOD IsSameEvent(const nsAString & aObjectName, const nsAString & aEventName, PRUint32 aArgCount, PRBool *_retval) { return _to IsSameEvent(aObjectName, aEventName, aArgCount, _retval); } \
...
#define NS_FORWARD_SAFE_NSISCRIPTEVENTHANDLER(_to) \
  NS_IMETHOD IsSameEvent(const nsAString & aObjectName, const nsAString & aEventName, PRUint32 aArgCount, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsSameEvent(aObjectName, aEventName, aArgCount, _retval); } \
...
/* boolean IsSameEvent (in AString aObjectName, in AString aEventName, in unsigned long aArgCount); */
NS_IMETHODIMP nsScriptEventHandler::IsSameEvent(const nsAString & aObjectName, const nsAString & aEventName, PRUint32 aArgCount, PRBool *_retval)
{
