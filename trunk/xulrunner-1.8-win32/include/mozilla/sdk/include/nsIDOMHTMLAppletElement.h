/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/dom/public/idl/html/nsIDOMHTMLAppletElement.idl
 */
...
#define NS_DECL_NSIDOMHTMLAPPLETELEMENT \
  ...
  NS_IMETHOD GetObject(nsAString & aObject); \
  NS_IMETHOD SetObject(const nsAString & aObject); \
...
#define NS_FORWARD_NSIDOMHTMLAPPLETELEMENT(_to) \
  ...
  NS_IMETHOD GetObject(nsAString & aObject) { return _to GetObject(aObject); } \
  NS_IMETHOD SetObject(const nsAString & aObject) { return _to SetObject(aObject); } \
...
#define NS_FORWARD_SAFE_NSIDOMHTMLAPPLETELEMENT(_to) \
  ...
  NS_IMETHOD GetObject(nsAString & aObject) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetObject(aObject); } \
  NS_IMETHOD SetObject(const nsAString & aObject) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetObject(aObject); } \
