/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/security/manager/ssl/public/nsIX509Cert.idl
 */
...
class NS_NO_VTABLE nsIX509Cert : public nsISupports {
 public: 
  ...
  NS_IMETHOD GetEmailAddresses(PRUint32 *length, PRUnichar ***addresses) = 0;
  ...
  NS_IMETHOD ContainsEmailAddress(const nsAString & aEmailAddress, PRBool *_retval) = 0;
