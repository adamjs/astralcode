/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/xpfe/components/shistory/public/nsIHistoryEntry.idl
 */
...
class NS_NO_VTABLE nsIHistoryEntry : public nsISupports {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IHISTORYENTRY_IID)
