/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM g:/mozilla/dom/public/idl/stylesheets/nsIDOMStyleSheetList.idl
 */
 ...
 */
  ...
  NS_IMETHOD Item(PRUint32 index, nsIDOMStyleSheet **_retval) = 0;
...
#define NS_DECL_NSIDOMSTYLESHEETLIST \
  ...
  NS_IMETHOD Item(PRUint32 index, nsIDOMStyleSheet **_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDOMSTYLESHEETLIST(_to) \
  NS_IMETHOD GetLength(PRUint32 *aLength) { return _to GetLength(aLength); } \
  NS_IMETHOD Item(PRUint32 index, nsIDOMStyleSheet **_retval) { return _to Item(index, _retval); } 
...
#define NS_FORWARD_SAFE_NSIDOMSTYLESHEETLIST(_to) \
  ...
  NS_IMETHOD Item(PRUint32 index, nsIDOMStyleSheet **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Item(index, _retval); } 
